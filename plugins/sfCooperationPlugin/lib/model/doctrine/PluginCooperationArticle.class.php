...
abstract class PluginCooperationArticle extends BaseCooperationArticle
{
  ...
  {
    return array('category' => $this->getCooperationCategory()->getName(), 'title' => $this->getTitle(), 'author' => $this->getAuthor(), 'image' => $this->getImage() ? 'http://' . $host . '/uploads/articles/' . $this->getImage() : null, 'body' => $this->getBody(), 'link' => $this->getLink(), 'abstract' => $this->getAbstract(), 'created_at' => $this->getCreatedAt(), 'expires_at' => $this->getExpiresAt());
  }
  ...
  public function updateLuceneIndex()
  {
    ...
    // TODO: when the article is new published, its isActivated 's value is null.
