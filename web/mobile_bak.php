...
<head> 
	...
	<link href="css/fontsIco.min.css" rel="stylesheet" type="text/css" /> 
	<link href="css/base.min.css" rel="stylesheet" type="text/css" /> 
	<link href="css/bannerAnimation.min.css" rel="stylesheet" type="text/css" /> 
	<link href="css/1027_3.min.css" rel="stylesheet" type="text/css" /> 
	<link href="css/cubeNavigation.min.css" rel="stylesheet" type="text/css" /> 
...
#cubeNavigation303_cubeLink1 .cubeLink_bg{background-color:#2c2c2c;background-image:none;filter:(opacity='100');opacity:1.0;}
#cubeNavigation303_cubeLink1 .icon-cube:before{content:'';}
#cubeNavigation303_cubeLink2 .cubeLink_bg{background-color:#2c2c2c;background-image:none;filter:(opacity='100');opacity:1.0;}
#cubeNavigation303_cubeLink2 .icon-cube:before{content:'';}
#cubeNavigation303_cubeLink3 .cubeLink_bg{background-color:#2c2c2c;background-image:none;filter:(opacity='100');opacity:1.0;}
#cubeNavigation303_cubeLink3 .icon-cube:before{content:'';}
#cubeNavigation303_cubeLink4 .cubeLink_bg{background-color:#2c2c2c;background-image:none;filter:(opacity='100');opacity:1.0;}
#cubeNavigation303_cubeLink4 .icon-cube:before{content:'';}
#cubeNavigation303_cubeLink5 .cubeLink_bg{background-color:#2c2c2c;background-image:none;filter:(opacity='100');opacity:1.0;}
#cubeNavigation303_cubeLink5 .icon-cube:before{content:'';}
#cubeNavigation303_cubeLink6 .cubeLink_bg{background-color:#2c2c2c;background-image:none;filter:(opacity='100');opacity:1.0;}
#cubeNavigation303_cubeLink6 .icon-cube:before{content:'';}
#cubeNavigation303_cubeLink7 .cubeLink_bg{background-color:#2c2c2c;background-image:none;filter:(opacity='100');opacity:1.0;}
	...
	<div class="g_web" id="g_web">
		 ...
		 <div class="navbar navBaseIcon" id="navbar"> 
			<div class="navbarList	" id="navbarList"> 
			 ...
			 <div class="navItem navItem_3 itemSelected icon-navItem" id="navItem_3"> 
				<a id="navbar_3" href="http://m.cooperationlive.com" _colid="3"> <span class="fa fa-home before"></span> <span class="navItemName">首页</span> </a> 
			 </div> 
			 <div class="itemSep" id="itemSep_106"></div> 
			 <div class="navItem navItem_106	icon-navItem" id="navItem_106"> 
				<a id="navbar_106" href="http://planning.cooperationlive.com" _colid="106"> <span class="fa fa-pencil before"></span> <span class="navItemName">品牌策划</span> </a> 
			 </div> 
			 <div class="itemSep" id="itemSep_107"></div> 
			 <div class="navItem navItem_107	icon-navItem" id="navItem_107"> 
				<a id="navbar_107" href="http://media.cooperationlive.com" _colid="107"> <span class="fa fa-cloud before"></span> <span class="navItemName">媒体资源</span> </a> 
			 </div> 
			 <div class="itemSep" id="itemSep_108" 1=""></div> 
			 <div class="navItem navItem_108	icon-navItem" id="navItem_108"> 
				<a id="navbar_108" href="http://m.cooperationlive.com/about.php" _colid="108"> <span class="fa fa-user before"></span> <span class="navItemName">关于我们</span> </a> 
			 </div> 
			 <div class="itemSep" id="itemSep_109"></div> 
			 <div class="navItem navItem_109	icon-navItem" id="navItem_109"> 
				<a id="navbar_109" href="http://m.cooperationlive.com/notices" _colid="109"> <span class="fa fa-newspaper-o before"></span> <span class="navItemName">新闻动态</span> </a> 
			 </div> 
			 <div class="itemSep" id="itemSep_110"></div> 
			 <div class="navItem navItem_110	icon-navItem" id="navItem_110"> 
				<a id="navbar_110" href="http://m.cooperationlive.com/contract.php" _colid="110"> <span class="fa fa-phone before"></span> <span class="navItemName">联系我们</span> </a> 
			 </div> 
			 <div class="itemSep" id="itemSep_9"></div> 
			 <div class="navItem navItem_9	icon-navItem" id="navItem_9"> 
				<a id="navbar_9" href="http://m.cooperationlive.com/message.php" _colid="9"> <span class="fa fa-commenting before"></span> <span class="navItemName">留言板</span> </a> 
			 </div> 
			</div> 
	 ...
	 <div class="webHeaderBox mobiTipsStyle" id="webHeaderBox"> 
		<div class="navButton" id="navButton"> 
		 ...
		 <div class="menuNav"> 
			<div class="fa fa-bars before fa-2x"></div> 
		 </div> 
		</div> 
					 ...
					 <a class="cubeLink_a " id="cubeLink_a1_cubeNav303" href="http://m.cooperationlive.com" target="_self"> 
						...
						<div class="cubeLink_text g_link"> 
						 <div class="cubeLink_text_p ">
							<p class="fa fa-home before fa-5x"></p> 
							<p>网站首页</p>
						 </div> 
						</div> </a>
					</div> 
					<div class="cubeLink cubeLink2 " id="cubeNavigation303_cubeLink2" linkid="2">
					 <a class="cubeLink_a " id="cubeLink_a2_cubeNav303" href="http://m.cooperationlive.com" target="_self"> 
						<div class="cubeLink_bg"></div> 
						<div class="cubeLink_curtain"></div> 
						<div class="cubeLink_ico icon-cube"></div> 
						<div class="cubeLink_text g_link"> 
						 <div class="cubeLink_text_p ">
							<p class="fa fa-pencil before fa-3x"></p> 
							<p>品牌策划</p> 
						 </div> 
						</div> </a>
					</div> 
					<div class="cubeLink cubeLink3 " id="cubeNavigation303_cubeLink3" linkid="3">
					 <a class="cubeLink_a " id="cubeLink_a3_cubeNav303" href="http://m.cooperationlive.com" target="_self"> 
						<div class="cubeLink_bg"></div> 
						<div class="cubeLink_curtain"></div> 
						<div class="cubeLink_ico icon-cube"></div> 
						<div class="cubeLink_text g_link"> 
						 <div class="cubeLink_text_p ">
							<p class="fa fa-file-video-o before fa-3x"></p> 
							<p>媒体资源</p> 
						 </div> 
						</div> </a>
					</div> 
					<div class="cubeLink cubeLink4 " id="cubeNavigation303_cubeLink4" linkid="4">
					 <a class="cubeLink_a " id="cubeLink_a4_cubeNav303" href="http://m.cooperationlive.com" target="_self"> 
						<div class="cubeLink_bg"></div> 
						<div class="cubeLink_curtain"></div> 
						<div class="cubeLink_ico icon-cube"></div> 
						<div class="cubeLink_text g_link"> 
						 <div class="cubeLink_text_p ">
							<p class="fa fa-user before fa-3x"></p> 
							<p>关于我们</p> 
						 </div> 
						</div> </a>
					</div> 
					<div class="cubeLink cubeLink5 " id="cubeNavigation303_cubeLink5" linkid="5">
					 <a class="cubeLink_a " id="cubeLink_a5_cubeNav303" href="http://m.cooperationlive.com" target="_self"> 
						<div class="cubeLink_bg"></div> 
						<div class="cubeLink_curtain"></div> 
						<div class="cubeLink_ico icon-cube"></div> 
						<div class="cubeLink_text g_link"> 
						 <div class="cubeLink_text_p ">
							<p class="fa fa-newspaper-o before fa-3x"></p> 
							<p>新闻动态</p> 
						 </div> 
						</div> </a>
					</div> 
					<div class="cubeLink cubeLink6 " id="cubeNavigation303_cubeLink6" linkid="6">
					 <a class="cubeLink_a " id="cubeLink_a6_cubeNav303" href="http://m.cooperationlive.com" target="_self"> 
						<div class="cubeLink_bg"></div> 
						<div class="cubeLink_curtain"></div> 
						<div class="cubeLink_ico icon-cube"></div> 
						<div class="cubeLink_text g_link"> 
						 <div class="cubeLink_text_p ">
							<p class="fa fa-commenting before fa-3x"></p> 
							<p>留言板</p>
						 </div> 
						</div> </a>
					</div> 
					<div class="cubeLink cubeLink7 " id="cubeNavigation303_cubeLink7" linkid="7">
					 <a class="cubeLink_a " id="cubeLink_a7_cubeNav303" href="http://cafe.cooperationlive.com" target="_self"> 
						<div class="cubeLink_bg"></div> 
						<div class="cubeLink_curtain"></div> 
						<div class="cubeLink_ico icon-cube"></div> 
						<div class="cubeLink_text g_link"> 
						 <div class="cubeLink_text_p ">
							<p class="fa fa-coffee before fa-3x"></p> 
							<p>咖啡屋</p>
						 </div> 
						</div> </a>
					</div> 
				...
				<div class="formMiddleContent formMiddleContent314 moduleContent" _innertype="0"> 
				 <div class="J_richContentPanel314 f-contentPanel"> 
					<div class="richContent richContent0 richContent314"> 
					 <p><img style="max-width: 100%;" alt=" " src="images/AD0I0amXBhACGAAg-K3PxQUonfG97wIwgAU4tAE.jpg" data-source="http://12965073.s61i.faiusr.com/2/AD0I0amXBhACGAAg-K3PxQUonfG97wIwgAU4tAE!640x640.jpg" /> </p> 
					</div> 
					<div class="clear"></div> 
				 </div> 
				</div> 
						...
						<div class="photoCrossedSlideSec" photoid="AD0I0amXBhACGAAggq7PxQUorN2lPTDZATjFAQ">
						 <a hidefocus="true"> 
							<div class="imgClass_160" id="CrossedSlideSecImgAD0I0amXBhACGAAggq7PxQUorN2lPTDZATjFAQmodule324"> 
							 ...
							 <img class="style2Img photoListImg " id="AD0I0amXBhACGAAggq7PxQUorN2lPTDZATjFAQ" alt="AD0I0amXBhACGAAggq7PxQUorN2lPTDZATjFAQ" src="images/AD0I0amXBhACGAAggq7PxQUorN2lPTDZATjFAQ.jpg" />
							</div> </a>
						</div> 
						<div class="photoCrossedSlideSec" photoid="AD0I0amXBhACGAAghK7PxQUo-JnT0wIw9wE4xQE">
						 <a hidefocus="true"> 
							<div class="imgClass_160" id="CrossedSlideSecImgAD0I0amXBhACGAAghK7PxQUo-JnT0wIw9wE4xQEmodule324"> 
							 <span class="imageMiddle"></span>
							 <img class="style2Img photoListImg " id="AD0I0amXBhACGAAghK7PxQUo-JnT0wIw9wE4xQE" alt="AD0I0amXBhACGAAghK7PxQUo-JnT0wIw9wE4xQE" src="images/AD0I0amXBhACGAAghK7PxQUo-JnT0wIw9wE4xQE.jpg" />
							</div> </a>
						</div> 
						<div class="photoCrossedSlideSec" style="display: none;" photoid="AD0I0amXBhACGAAgr8-PxQUowt7q6gUw9wE4xQE">
						 <a hidefocus="true"> 
							<div class="imgClass_160" id="CrossedSlideSecImgAD0I0amXBhACGAAgr8-PxQUowt7q6gUw9wE4xQEmodule324"> 
							 <span class="imageMiddle"></span>
							 <img class="style2Img photoListImg " id="AD0I0amXBhACGAAgr8-PxQUowt7q6gUw9wE4xQE" alt="AD0I0amXBhACGAAgr8-PxQUowt7q6gUw9wE4xQE" src="images/AD0I0amXBhACGAAgr8-PxQUowt7q6gUw9wE4xQE.jpg" />
							</div> </a>
						</div> 
					 </div> 
					</div> 
				...
				<div class="formMiddleContent formMiddleContent321 moduleContent" _innertype="0"> 
				 <div class="J_richContentPanel321 f-contentPanel"> 
					<div class="richContent richContent0 richContent321"> 
					 <p><img style="max-width: 100%;" alt=" " src="images/AD0I0amXBhACGAAghq7PxQUo2PzDuQIwgAU4tAE.jpg" data-source="http://12965073.s61i.faiusr.com/2/AD0I0amXBhACGAAghq7PxQUo2PzDuQIwgAU4tAE!640x640.jpg" /> </p> 
					</div> 
					<div class="clear"></div> 
				 </div> 
				</div> 
		 ...
		 <div class="footer mallThemeFooter" id="footer"> 
			...
			<div class="technical"> 
			 ...
			 <div class="technicalSupport">
				<a class="fa fa-laptop before" hidefocus="true" href="http://www.cooperationlive.com/" target="_blank">电脑版</a> 
			 </div> 
			</div> 
		 </div> 
		</div> 
...
#svebar_4 .icon-serItemIcon{background-image:none;} 
		 ...
		 <div class="customerServiceDiv" id="customerServiceDiv"> 
				...
				<a id="numberHref_1" href="tel:"> 
				 <div class="serBaseIcon"> 
					<div class="icon" id="svebar_1">
					 <span class="fa fa-phone before"></span> 
				...
				<a id="numberHref_2" href="sms:"> 
				 <div class="serBaseIcon"> 
					<div class="icon" id="svebar_2">
					 <span class="fa fa-envelope before"></span> 
				...
				<a id="numberHref_5" onclick="alert(&quot;请输入QQ号码&quot;);return false;"> 
				 <div class="serBaseIcon"> 
					<div class="icon" id="svebar_5">
					 <span class="fa fa-qq before"></span> 
				...
				<a id="numberHref_3" onclick="Mobi.showMapService()" href="javascript:;"> 
				 <div class="serBaseIcon"> 
					<div class="icon" id="svebar_3">
					 <span class="fa fa-map before"></span> 
			...
			<div class="service serviceClass_4" id="customerServiceType_4"> 
			 <div class="navItem navItem_4 icon-navItem" id="navItem_4">
				<a id="numberHref_4" href="http://m.cooperationlive.com/meassage"> 
				 <div class="serBaseIcon"> 
					<div class="icon" id="svebar_4">
					 <span class="fa fa-commenting before"></span> 
	...
	<script src="js/jqmobi.min.js" type="text/javascript"></script> 
	<script src="js/jqmobi_ui.min.js" type="text/javascript" ></script> 
	<script src="js/mobi.min.js" type="text/javascript" ></script> 
	<script type="text/javascript">
