...
Mobi.autoFixGWebTop = function (f) {
    ...
    var m = Mobi.webTop(), h = Mobi.getPreviewObject("g_web"), l = Mobi.getPreviewObject("webTop"),
        k = Mobi.getPreviewObject("webBodyBackground"), e = Mobi.getPreviewObject("webHeaderBox");
    e.style.top = "";
    l.style.top = "";
    if (f !== 2 && f !== 7 && f !== 8) {
        ...
        if (d) {
            ...
            d = jm("<div id='fk-gWebPlaceholdPT' style='height:" + m + "px;'></div>");
            jm(h).prepend(d)
        }
        return
    }
    if (f == 7) {
        var c = jm("#webHeader"), b = Mobi.getPreviewObject("navbar");
        if (m > 0) {
            b.style.top = m + "px"
        }
    ...
    if (d) {
        d.style.height = (a.offsetHeight + m) + "px"
    } else {
        d = jm("<div id='fk-gWebPlaceholdPT' style='height:" + (a.offsetHeight + m) + "px;'></div>");
        jm(h).prepend(d)
    }
};
Mobi.webTop = function () {
    var b = 0, a = Mobi.getPreviewObject("mobiTipsMarquee");
    if (!a) {
        return b
    } else {
...
Mobi.topTipMarquee = function () {
    ...
    var f = Mobi.getPreviewObjectClass("J_marquee")[0], k = d.querySelectorAll("li"), b = jm(f).width(),
        h = f.offsetWidth, a = false, c = [], l = 0;
    for (var e = 0; e < k.length; e++) {
        c[e] = parseInt(k[e].offsetWidth);
        if (b > c[e]) {
            l = (e == 0) ? b : parseInt(l) + c[e]
        } else {
            l = (e == 0) ? c[e] : parseInt(l) + c[e]
        }
    }
    if (k.length == 1 && c[0] < b) {
    } else {
        Mobi.copyTipsDom(k, d);
        a = true
    }
    if (a) {
        Mobi.initTipsMarquee(l)
    }
};
Mobi.copyTipsDom = function (h, b) {
    var a = h.length - 1, e = Mobi.getPreviewObjectClass("J_marqueeContainer")[0],
        f = Mobi.createElementByHtml("<ul class='marquee j-marquee J_marquee' id='J_mobiTipsMarqueeCopy'></ul>"), c;
    e.appendChild(f);
    for (var d = 0; d <= a; d++) {
        c = jm(h[d]).clone();
        jm(f).append(c)
...
Mobi.initTipsMarquee = function (f) {
    var e = 0, d = Mobi.getPreviewObjectClass("J_marqueeContainer")[0], a = Mobi.getPreviewObject("mobiTipsMarquee"),
        b = Mobi.getPreviewObject("J_mobiTipsMarqueeCopy"), c;
    jm(a).addClass("j-marquee");
    jm(a).css({width: f + "px", left: "0", top: "0"});
    c = a.offsetWidth;
    jm(b).css({width: f + "px", left: c + "px", top: "0"});
    Mobi.setParentMarquee(a, b)
};
Mobi.setParentMarquee = function (b, c) {
    var a = b.offsetWidth, e = c.offsetWidth, f = a + e, d = Mobi.getPreviewObjectClass("J_marqueeContainer")[0],
        h = 70;
    jm(d).css({width: f + "px", left: "0", top: "0"});
...
Mobi.ingTigs = function (l, k) {
    var e = (l == null || l == "") ? "正在处理..." : l;
...
Mobi.ing = function (q, r, n) {
    ...
    if (l.indexOf("2052") >= 0) {
        ...
        if (k > 15) {
            var h = q.substring(0, 30).lastIndexOf(" ");
            if (q.charAt(30) != "" && k < 50) {
                if (h < 15) {
                    h = 30
                }
                e = q.substring(0, h) + "<br>" + q.substring(h)
            } else {
                if (k > 50) {
                    var f = q.substring(30, 50).lastIndexOf(" ");
                    e = q.substring(0, h) + "<br>" + q.substring(h, f) + "<br>" + q.substring(f)
                }
            }
            k = 15
        }
...
Mobi.initForms = function () {
    var d = document.querySelector("#webModuleContainer"), c = d.querySelectorAll(".form");
...
Mobi.fixFontSizeDeviation = function () {
    var k = document.querySelector("#webModuleContainer"), q = k.querySelectorAll(".form");
    for (var v = 0; v < q.length; v++) {
        var c = q[v], o = c.getAttribute("id"),
            C = jm(c).hasClass("formStyle51") || jm(c).hasClass("formStyle52") || jm(c).hasClass("formStyle53") || jm(c).hasClass("formStyle54");
        if (o) {
            o = o.replace("module", "");
            ...
            var A = c.querySelector(".formBannerTitle"), f = c.querySelector(".formMiddleContent"),
                e = c.querySelector(".photoModule"), t = jm(A).find(".titleCenter"), z = jm(A).find(".titleTextIcon"),
                w = jm(c).css("margin-left"), r = jm(c).css("margin-right"), p = jm(c).css("margin-top"),
                a = jm(c).css("margin-bottom"), h = jm(A).css("height"), s = jm(f).css("margin-left"),
                n = jm(f).css("margin-right"), m = jm(f).css("margin-top"), y = jm(f).css("margin-bottom"),
                B = jm(f).attr("_innerType"), d, x, u, b, l;
            if (B == 0 && !C) {
                if (!Fai.top._manageMode) {
                    f.style.marginBottom = "0.5rem";
                    jm(".formMiddle" + o).css({paddingBottom: "0.25rem"})
                } else {
            ...
            if (A.getAttribute("_bannerAutoHeight") == 0) {
                if (!Fai.top._manageMode) {
                    t.css("height", d + "rem");
                    ...
                    Fai.top.Mobi.setModuleStyleCssList(o, [{
                        ...
                        key: "height",
                        value: d + "rem"
                    }, {cls: ".formBannerTitle" + o + " .titleTextIcon" + o, key: "line-height", value: d + "rem"}])
                }
            }
            if (s != "0px") {
...
Mobi.topContentFixedAutoHidden = function (b) {
    if (b == 0 || b == 2) {
        var e = Mobi.getPreviewObject("webHeaderBox"), c = e.style.top,
            f = document.querySelector("#webTips") ? true : false, h = {}, d = Mobi.getPreviewObject("g_web"),
            a = d.style.top;
        e.setAttribute("showNav", "true");
        d.style[jm.feat.cssPrefix + "Transition"] = "top 350ms";
        d.addEventListener("touchstart", function (k) {
            h.y1 = k.touches[0].pageY
        }, false);
        d.addEventListener("touchmove", function (k) {
            h.y2 = k.touches[0].pageY
        }, false);
        d.addEventListener("touchend", function (l) {
            var k = h.y1 - h.y2;
            if (k > 0) {
...
Mobi.onlineServiceInputWord = function () {
    ...
    var h = document.querySelectorAll("input[type='text']"), f = document.querySelectorAll("textArea"), e = [],
        a = document.getElementById("webCustomerServiceBox"), d = false;
    if (a) {
    ...
    for (var c = 0; c < e.length; c++) {
        e[c].addEventListener("blur", function () {
            a.style.display = "block"
        }, false);
        e[c].addEventListener("focus", function () {
...
Mobi.createFullScreenDiv = function (b, c, a) {
    ...
    // jm.ajax({
    //     type: "post", url: "ajax/other_h.jsp?cmd=" + c, data: a, error: function () {
    //         Mobi.closeLoading();
...
Mobi.createInnerScreenDiv = function (a, e, n, c, l) {
    if (!ajaxDone) {
        return
    }
    if (!c) {
    ...
    var m = document.getElementById("ngGroupDiv").className;
    ...
    setTimeout(function () {
        for (var h = 0; h < n; ++h) {
            jm("#ngName" + h).css({width: "34%"});
            jm("#ngMark" + h).css({"float": "left"});
            if (e == h) {
                jm("#ngMark" + h).css("color", "white")
            } else {
                jm("#line" + h).css({color: "#555555"});
                jm("#ngMark" + h).css({color: "#555555"})
            }
        }
    }, 90);
    setTimeout(function () {
        jm("#line" + e).addClass("ngLine-bg");
        jm("#ngGroupDiv").css({"min-height": f + "px", "margin-top": "-" + f + "px"})
    }, 100);
    // jm.ajax({
    //     type: "post", url: "ajax/other_h.jsp?cmd=" + c, data: l, error: function () {
    //         Mobi.closeLoading();
    //         Mobi.ing(LS.systemError);
    //         ajaxDone = true
    //     }, success: function (h) {
...
Mobi.getCommentDiv = function (c, e, d) {
    ...
    // jm.ajax({
    //     type: "post", url: "ajax/other_h.jsp?cmd=" + c + "&rem=" + b, data: a, error: function () {
    //         Mobi.closeLoading();
    //         Mobi.ing(LS.systemError)
    //     }, success: function (f) {
    ...
    //         setTimeout(function () {
    //             var l = jm(".ct-s-content-m");
    //             if (typeof(l) != "undefined" && l != null) {
    //                 for (var m = 0; m < l.length; m++) {
    //                     var k = l.eq(m)[0].querySelectorAll("img");
    //                     if (typeof(k) != "undefined" && k != null && k.length > 0) {
    //                         Mobi.bindCommImgShow(k)
    //                     }
    //                 }
    //             }
    //         }, 100)
...
Mobi.productGroupCollapse = function (e) {
    var d = jm("#pgBox");
    var m = jm("#pgBox2");
    var k = Mobi.getPreviewObject("group_" + groupId);
    var l = jm("#pgBox2_Item" + groupId);
    var f = jm("#pgSelect");
    ...
    m.addClass("pgBox2Collapse");
    m.css("height", c + "px");
    l.addClass("pgBox2ItemCollapse");
    var b = parseInt(k.offsetTop) + 4;
    if (f.length > 0) {
        f.css("top", b + "px")
    } else {
...
Mobi.disableSafeMode = function () {
    var b = Fai.top.$("#mobiReviewPageFrame").attr("src"), d, f, e = b.indexOf("?"), c = Fai.top.location.href || "";
    if (e != -1) {
        d = b.substring(0, e);
        f = b.substring(e + 1);
    ...
    // function a(s) {
    //     if (s) {
    //         var o = s.indexOf("#"), p = s.indexOf(".jsp"), q = s.indexOf("?"), r = s.substring(o + 2, p), h = {},
    //             m = "", k, l, n;
    //         if (q != -1) {
    //             k = s.substring(q + 1).split("&");
...
Mobi.getTransitionEndEventName = function () {
    var a, d, b = document.createElement("div"), c = {
...
Mobi.prompt = function (m) {
    var f = {content: "", textClass: "", cancelClass: "",};
    var m = jm.extend(f, m);
    var c = Fai.top.document.body.clientWidth;
    var a = Fai.top.document.body.clientHeight;
    var b = parseInt(Math.random() * 10000);
    var k = "<div id='mobiPrompt" + b + "' class='mobiPrompt'></div>",
        h = "<div id='mobiPrompt_Bg" + b + "' class='mobiPrompt_Bg'></div>";
    jm(k).appendTo("body");
    jm(h).appendTo("body");
    var d = jm("#mobiPrompt" + b), l = jm("#mobiPrompt_Bg" + b);
    var e = [];
    e.push("<div class='mobiPrompt_inner'>");
    e.push("<div class=' mobiPrompt_content'>");
    e.push("<div class=''>" + m.content + "</div>");
    e.push("<div class='J-prompt-cancel icon-mobiPromptClose'></div>");
    e.push("</div>");
    e.push("<div class=' mobiPrompt_buttons '>");
    e.push("<div class='J-prompt-cancel mobiPromptCancel " + m.cancelClass + " icon-PromptCancel'></div>");
    e.push("<div class='J-prompt-save mobiPromptSave " + m.textClass + " icon-PromptSave'></div>");
    e.push("</div>");
    e.push("</div>");
    d.append(e.join(""));
    if (m.callback) {
...
Mobi.initWebPage = function (f) {
    var s = f.triggerId, v = f.panelId, p = f.pageHtml, m = f.pageHead, c = f.pageBg || false,
        a = f.returnSeltFun || false, e = f.closeWebPage, l = f.closeCallBack || function () {
        }, q = f.direction || "right", k = f.callback;
    var d = "";
    if (!s) {
        return
    }
    var u, h = jm("#webPagePanel" + s);
    if (h.length !== 0) {
        h.remove();
        h = jm("#webPagePanel" + s)
    }
    var o = "webPagePanelRight";
    var n = false;
    if (q === "left") {
        o = "webPagePanelLeft"
    } else {
        if (q === "top") {
            ...
            if (q === "bottom") {
                o = "webPagePanelBottom"
            }
        }
    }
    var t = "";
    if (c) {
        t = "<div class='webPagePanelBg' style='z-index:999'></div>"
    }
    var d = 0;
    var b = 0;
    jm("#" + s).bind("click", function (w) {
    ...
    var r = function () {
        if (h.length == 0 || u == undefined) {
            jm("#g_web").append("<div id='webPagePanel" + s + "' class='webPagePanel' style='z-index:1000'>" + t + "</div>");
            h = jm("#webPagePanel" + s);
            if (p) {
                h.append(p);
                u = jm(p);
            ...
            u.addClass(o);
            u.addClass("webPagePanel");
            h.show();
            u.show();
            setTimeout(function () {
                u.addClass("webPagePanelShow")
            });
            if (c) {
                Mobi.bindTouchAndClickEvent(jm("#webPagePanel" + s + " .webPagePanelBg"), function (B) {
                    u.removeClass("webPagePanelShow");
                    u.removeClass("webPagePanelShow");
                    jm("#g_body").css({overflow: "", height: "", top: ""});
                    jm("html").css({overflow: "",});
                    jm("#g_web").removeClass("gwNoScroll");
                    jm("#webPagePanel" + s).css("z-index", "-1");
                    window.scrollTo(0, b);
                    return false
                })
            }
            ...
            for (var z = 0; z < y.length; z++) {
                var A = y[z].trim();
                Mobi.bindTouchAndClickEvent(jm(A), function (B) {
                    u.removeClass("webPagePanelShow");
                    jm("#g_body").css({overflow: "", height: "", top: ""});
                    jm("html").css({overflow: "",});
                    jm("#g_web").removeClass("gwNoScroll");
                    jm("#webPagePanel" + s).css("z-index", "-1");
                    window.scrollTo(0, b);
                    if (s == "userCommentId" || s == "postComment") {
                        jm("input,textarea").each(function (D, C) {
                            C.blur()
                        })
                    }
                ...
                jm(A).bind("click", function () {
                    ...
                    window.scrollTo(0, b);
                    if (s == "userCommentId" || s == "postComment") {
                        jm("input,textarea").each(function (C, B) {
                            B.blur()
                        })
                    }
                    if (typeof l == "function") {
            ...
            Mobi.bindTransitionEnd(u, function () {
                if (!u.hasClass("webPagePanelShow")) {
                    h.hide()
                }
            })
        } else {
...
Mobi.initProductGroundNav = function (f, b) {
    var d = jm("#module" + f), c = d.find(".productNewGroup"), e = c.find(".J_navOpenBtn"), a = c.find(".J_navHorizon");
    e.on("click", function () {
...
Mobi.initProductGroup = function (m, t, b) {
    if (t == 1 || m == 0) {
        return false
    }
    var n = window.innerHeight ? window.innerHeight : window.screen.height;
    var d = jm("#module22");
    var l = jm(".productNewGroup");
    var o = d.height(), s = false, e, w, r, h, y, a, x;
    if (Fai.top._templateFrameId >= 2000 && Fai.top._templateFrameId < 3000) {
        s = true
    }
    if (s) {
        ...
        l.height(jm("body").height() - jm("#webHeaderBox").height() + "px")
    }
    var p = jm(l).find(".J_itemImage");
    for (var u = 0; u < p.length; u++) {
        var c = p[u];
        v(c)
    }
    l.css("height", (n - o) + "px");
    w = l.find(".firstGroup .firstGroupItem");
    w.off(".productNewGroup").on("click.productNewGroup", function () {
        if (jm(this).hasClass("checkedItem")) {
            return false
        }
        var B = l.find(".firstGroup .checkedItem"), z = l.find(".unFirstGroup .checkedPanel");
        var C = jm(this), E = jm(C).attr("data-id"), D = jm("#sed_" + E), A, F;
    ...
    if (m != 5 && m != 6) {
        Mobi.SimpleDrag.__create(l.find(".firstGroupList"))
    } else {
        r = 0;
        w.each(function (z, A) {
            y = jm(A);
        ...
        l.find(".firstGroupList").width(r + "px")
    }
    if (!b || (!s && m != 1)) {
        return
    }
    var q = jm(l).find(".J_groupItem");
    var f = {
        key: "productGroup",
        targets: q,
    ...
    function v(C) {
        var B = parseInt(jm(C).attr("data-w")), D = parseInt(jm(C).attr("data-h")), A = s ? "3.0rem" : "2.8rem",
            z = s ? "3.0rem" : "2.9rem";
        if (B >= D) {
...
(function (f, a) {
    ...
    function d(k) {
        var n = a.__html.replace("_$dataId", a.__data.count).replace("_$dataType", k.type);
        for (var l = 0; l < k.targets.length; l++) {
            var m = k.targets[l];
            f(m).append(n)
        }
        a.__data.instances[a.__data.count] = k
    }

    function h() {
        var k = a.__data.instances[a.__data.count];
        var l;
        f(k.targets).find(".quick_in").unbind("click.quickIn").bind("click.quickIn", function (n) {
            l = f(this);
            switch (k.type) {
                case Mobi.QuickIn.TYPE.FU:
                    top.Mobi.fileUpload2("", k.popupWindowOption.settings, m);
                    break;
                default:
            ...
            function m(o) {
                var p = f.parseJSON(o);
                if (p) {
                    k.popupWindowOption.closeFunc(l, p.data[0])
                }
            }
        });
        f(k.targets).off(".quickIn").on("mouseenter.quickIn", function () {
...
(function (f, c, d) {
    ...
    function l(p) {
        ...
        f(p).off(".simpleDrag");
        f(p).on("mousedown.simpleDrag", function (q) {
            b(q, o, this)
        }).on("touchstart.simpleDrag", function (q) {
            b(q, o, this)
        }).on("mouseup.simpleDrag", function (q) {
            e(q, o, this)
        }).on("touchend.simpleDrag", function (q) {
            e(q, o, this)
        }).on("mousemove.simpleDrag", function (q) {
            k(q, o, this);
            q.preventDefault()
        }).on("touchmove.simpleDrag", function (q) {
            k(q, o, this);
            q.preventDefault()
        })
    }
    ...
    function e(r, q, p) {
        ...
        setTimeout(function () {
            f(p).css("transition", "").css("-webkit-transition", "")
        }, 550)
    }
    ...
    function k(r, q, p) {
        var o = {};
        if (q.isClicking) {
            q.moveY = m(r) - q.startY;
            if (q.overflowHeight != 0) {
                q.moveY += q.transformY
            }
            if (q.moveY > q.moveOverflowRange) {
                q.moveY = q.moveOverflowRange
            } else {
                if (q.moveY < (q.overflowHeight * -1 - q.moveOverflowRange)) {
                    q.moveY = (q.overflowHeight * -1 - q.moveOverflowRange)
                }
            }
            f(p).css("transform", "translateY(" + q.moveY + ")").css("-webkit-transform", "translateY(" + q.moveY + "px)")
        }
    ...
    function a(r, q) {
        var p = parseInt(f(q).parent().height()), o = parseInt(f(q).height());
        r.startY = 0;
        r.moveY = 0;
        r.isClicking = false;
    ...
    function h(o) {
        ...
        if (!p) {
            p = f(o).css("-webkit-transform")
        }
        if (p == "none") {
            p = 0
        } else {
            p = p.replace("translateY(", "").replace(")", "");
            p = parseInt(p, 10)
        }
        if (!p) {
            p = 0
...
(function (a, b) {
    ...
    b.fn.Dialog = function (c) {
        ...
        b(this).each(function () {
            var f = new a();
            var e = b.extend({trigger: b(this)}, c);
            f.init(e);
            d.push(f)
        });
        return d
    ...
    b.Dialog = function (c) {
        if (c.type === "confirm") {
            ...
            var e = "";
            if (!c.buttons) {
                c.buttons = [{no: "取消"}, {yes: "完成"}]
            }
            var o = "";
            for (var f = 0, d = c.buttons.length; f < d; f++) {
                var m = c.buttons[f];
                if (m.no) {
                    o += '<td><button class="fkarea-ui-confirm-no" data-type="no">' + m.no + "</button></td>"
                }
                if (m.yes) {
                    o += '<td><button class="fkarea-ui-confirm-submit " data-type="yes">' + m.yes + "</button></td>"
                }
            }
            e = '<table class="fkarea-ui-dialog-action"><tr>' + o + "</tr></table>";
            h = e + h;
            var n = b.extend({
                target: h,
                animate: true,
                ...
                beforeShow: function (l) {
                    k.touch(b(".fkarea-ui-confirm-submit", l), function () {
                        c.callback && c.callback.call(k, "yes", l);
                        b("body").css({overflow: "auto"})
                    });
                    k.touch(b(".fkarea-ui-confirm-no", l), function () {
                        c.callback && c.callback.call(k, "no", l);
                        b("body").css({overflow: "auto"})
                    })
                }
            }, c);
    ...
    b.confirm = function (f, e, k, d) {
        var c = {};
        var h = {zIndex: 1001, type: "confirm"};
        if (typeof f == "object") {
            c = b.extend(h, f)
        } else {
            c = b.extend(h, {content: f, buttons: e, callback: k})
        }
    ...
    a.prototype = {
        init: function (c) {
            var e = this;
            this.settings = b.extend({fixed: false}, this.settings, c);
            ...
            this.dialogContainer.append(this.dailogContent).show().css({height: this.height, width: this.width});
            ...
            if (this.showed) {
                ...
                var m = this.settings.clientWidth || document.documentElement.clientWidth || document.body.clientWidth;
                var e = this.width / 2;
                var c = this.height / 2;
                var d = m / 2 - e;
                var l = h / 2 - c;
...
(function (a, b) {
    ...
    b.prototype = {
        init: function (d) {
            this.settings = c.extend({eventName: "click"}, d);
            ...
            var d = this;
            this.trigger[d.settings.eventName](function (n) {
                var m = "";
                for (var l = 0; l < d.level; l++) {
                    m += "<div></div>"
                }
                if (d.lcid != 2052 && d.lcid != 1028) {
                    d.buttons = [{no: "cancel"}, {yes: "fulfil"}]
                } else {
                    d.buttons = null
                }
                c.confirm('<div class="fkarea-ui-scroller-mask"><div id="' + d.id + '" class="ui-scroller">' + m + "<p></p></div></div>", d.buttons, function (e, q) {
                    if (e == "yes") {
                        d.submit()
                    }
                    if (e == "no") {
                ...
                d.format();
                var p = 0, h = 0;
                d.scroller.children().off("mousedown.area-scroller").on("mousedown.area-scroller", o);

                function o(e) {
                    e = e || window.event;
                    p = e.pageY;
                    c(window).off("mousemove.area-scroller").on("mousemove.area-scroller", f);
                    c(window).off("mouseup.area-scroller").on("mouseup.area-scroller", k);
                    e.preventDefault()
                }
                ...
                function f(q) {
                    ...
                    h = q.pageY;
                    var s = h - p;
                    var e = c(q.target).parent();
                    if (e[0].nodeName != "DL") {
                        return
                    }
                    var r = parseInt(e.css("top") || 0) + s;
                    if (r < -c(e).height() + 60) {
                        r = -c(e).height() + 60
                    }
                    e.css("top", r + "px");
                ...
                function k(e) {
                    ...
                    var x = h - p;
                    var t = c(e.target).parent();
                    if (t[0].nodeName != "DL") {
                        return
                    }
                    var r = c(t.parent()).index();
                    var v = parseInt(t.css("top") || 0) + x - 30;
                    if (v > d.mtop) {
                        v = d.mtop
                    }
                    if (v < -c(t).height() + 60) {
                    ...
                    d.value[r] = c(t.children().get(u)).attr("ref");
                    d.value[r] == 0 ? d.text[r] = "" : d.text[r] = c(t.children().get(u)).html();
                    for (var q = d.level - 1; q > r; q--) {
                        d.value[q] = 0;
                        d.text[q] = ""
                    }
                    if (!c(t.children().get(u)).hasClass("focus")) {
                        d.format()
                    }
                    c(t.children().get(u)).addClass("focus").siblings().removeClass("focus");
                    t.css("top", s * d.mtop + "px");
                    e.preventDefault()
                }

                d.scroller.children().bind("touchstart", function (q) {
                    p = (q.changedTouches || q.originalEvent.changedTouches)[0].pageY
                });
                d.scroller.children().bind("touchmove", function (t) {
                    h = (t.changedTouches || t.originalEvent.changedTouches)[0].pageY;
                    var s = h - p;
                    var q = c(t.target).parent();
                    if (q[0].nodeName != "DL") {
                        return
                    }
                    var r = parseInt(q.css("top") || 0) + s;
                    if (r < -c(q).height() + 60) {
                        r = -c(q).height() + 60
                    }
                    q.css("top", r + "px");
                ...
                d.scroller.children().bind("touchend", function (v) {
                    h = (v.changedTouches || v.originalEvent.changedTouches)[0].pageY;
                    var y = h - p;
                    var t = c(v.target).parent();
                    if (t[0].nodeName != "DL") {
                        return
                    }
                    var r = c(t.parent()).index();
                    var w = parseInt(t.css("top") || 0) + y - 30;
                    if (w > d.mtop) {
                        w = d.mtop
                    }
                    if (w < -c(t).height() + 60) {
...
//     showLoadingAgain = function (m) {
//         closeLoading(m);
//         var e = ['<div class="ajaxLoadingAgain width" style="margin-top:50px;margin-bottom:50px;text-align:center;">', '<div style="color: #1b7ad1; text-decoration: none; text-align:center; width:100%;cursor:pointer;" onclick="reloadingClick(' + m + ');">加载失败，请点击重新加载</div>', "</div>"];
//         jm("#module" + m + " .middleCenter").empty().append(e.join(""))
//     };
...
//             data: "cmd=getAjaxPageModuleInfo&_colId=" + a + "&_extId=" + l + "&moduleId=" + e + "&href=" + jm.encodeUrl(b),
//             error: function (m) {
//                 d = true;
//                 closeLoading(e);
//                 showLoadingAgain(e);
...
//                     var o = jm("#module" + e).find(".middleCenter" + e);
//                     o.html(n);
...
Mobi.fixWXPublicAttentionTip = function (b, e, a) {
    ...
    var c, h = d.find(".close"), f = d.find(".clickContent"),
        k = ['<div id="wxTopTip" class="wxTopTip">', "</div>", '   <div id="wxPage" class="wxPage">', '       <div class="pic">', '           <img src="' + Fai.top._resRoot + '/image/wxPage.png?v=201712151528" >', "       </div>", '       <div class="pic1">', '           <img class="img" src="' + e + '"/>', "       </div>", '       <div class="text">', "           长按识别图中二维码快来关注我吧", "       </div>", "   </div>",];
...
Mobi.allFixWXPA = function (e, d, a) {
    var c = jm("#wxPublicAttentionService"), b = 0;
    if (e == 1) {
...
Mobi.showNavItemContainer = function () {
    ...
    var v = Mobi.getPreviewObject("navbarList"), b = Mobi.getPreviewObject("navbar"), e = v,
        s = parseInt(jm(b).width()), m = 0, l = b.querySelectorAll(".navItem"), u = b.querySelectorAll(".itemSep"),
        h = jm(b), D = h.find(".navItem"), y = jm(v), E = h.offset();
    ...
    if (m > s) {
        ...
        if (jm.os.supportsTouch) {
            ...
            function A(p, F) {
                var G = F.wrapper.querySelector(".navLeft") ? F.wrapper.querySelector(".navLeft") : F.wrapper.querySelector(".navTouchLeft"),
                    H = F.wrapper.querySelector(".navRight") ? F.wrapper.querySelector(".navRight") : F.wrapper.querySelector(".navTouchRight");
            ...
            var q = jm(b).find(".navLeft"), C = jm(b).find(".navRight"), a = jm(b).find(".navbarList"), t = s - m;
            timer = null;
            if (B < 0) {
                q.css("display", "block");
                jm(e).css("left", t + "px")
            ...
            var o = b.offsetLeft;
            var r = [];
            jm(b).find(".navItem").each(function (p) {
                r[p] = this.offsetLeft - o;
                x++
            });
            C.unbind("click");
            q.unbind("click");
            ...
            jm(b).bind("swipeLeft", function (p) {
            }).bind("swipeRight", function (p) {
            });
            ...
            function n(G, F) {
                ...
                var p = (e.offsetLeft + d);
                if (p > 0) {
                    p = 0
                }
                jm(e).css("left", p + "px");
                jm.setCookie("startX", p);
                jm.setCookie("startX_p", w);
                setTimeout(function () {
                    if ((Math.abs(e.offsetLeft) + s) < m) {
                        C.css("display", "block")
                    }
                    if (e.offsetLeft >= -1) {
                        q.css("display", "none")
                    }
                    jm(G).bind(F, function () {
                        n(this, F)
                    })
                }, 600)
            }
        ...
        h.on("click.nav", ".navItem", function () {
            var p = jm(this), H = p.offset(), G = jm.os.supportsTouch ? c.x : parseInt(y.css("left").replace("px", "")),
                F = parseInt(p.width());
            if (E.right < H.right) {
                jm.setCookie("startX", G - F)
            } else {
                if (E.left > H.left) {
                    y += parseInt(p.width());
                    jm.setCookie("startX", G + F)
...
Mobi.fixNavIconPosition = function () {
    var l = Fai.top._templateLayoutId, r = 0, v = 1, h = 2, p = 3, s = 4, n = 5, k = 6, m = 7, e = 8;
    var t = jm("#navbar"), a = jm("#navbarList"), u = a.find(".J_imgIcon"), o = a.find(".J_fontIcon"),
        d = a.find(".icon-navItemIcon"), w, q, f, b, c;
    Mobi.removeNavIconPositionFix();
    if (!(l == h || l == s || l == m || l == n)) {
        return
    }
    if (o.length < 1 || u.length < 1) {
        return
    }
    b = jm(o[0]);
    w = parseFloat(o[0].offsetWidth);
    b.addClass("fk-fixNavIconStyle");
    q = parseFloat(o[0].offsetWidth);
    f = parseFloat(o[0].offsetHeight);
    b.removeClass("fk-fixNavIconStyle");
    if (w > q) {
        return
    }
    d.each(function (x, y) {
        c = jm(y).parent().attr("id");
        Mobi.setCtrlStyleCssList("mobiStyleNav", c, [{
            cls: ".icon-navItemIcon",
            key: "width",
            value: q + "px"
        }, {cls: ".icon-navItemIcon", key: "height", value: f + "px"}])
    })
};
Mobi.removeNavIconPositionFix = function () {
    var b = jm("#navbarList"), a = b.find(".icon-navItemIcon");
    if (Fai.top._manageMode) {
        a.each(function (c, d) {
...
Mobi.setModuleHeight2 = function (a, m) {
    ...
    m *= c;
    m = parseInt(m);
    b.style.height = m / _htmlFontSize + "rem";
    ...
    var f = m - k - Mobi.getFrameHeight(h);
    h.style.height = f / _htmlFontSize + "rem";
    var l = h.querySelector(".middleCenter");
    f = f - Mobi.getFrameHeight(l);
...
Mobi.scrollToModule = function (d) {
    var b = jm("#module" + d), c = Mobi.getPreviewObject("webHeaderBox"), a = 0;
...
Mobi.msgBoardAddMsg = function (q, o, b) {
    var a = jm("#reqName").val();
    var k = jm("#reqPhone").val();
    var l = jm("#reqEmail").val();
    var h = jm("#reqContent").val();
    var p = jm("#msgBoardCaptcha").val();
    var c = jm(".notice").show();
    var m = jm(".J_msgBoardCaptcha");
    var f = 0;
    jm("input.msg_isMust").each(function () {
        var s = jm(this).attr("id");
        var t = jm(this).attr("placeholder");
        var r = jm(this).val();
        if (r == "" || r == null) {
            c.html(jm.format(LS.msgBoardInputIsEmpty, jm.encodeHtml(t)));
            Mobi.getPreviewObject(s).focus();
            f = 1;
            return false
        }
        if (s == "reqPhone" && !jm.isPhone(r)) {
            c.html(jm.format(LS.msgBoardInputCorrect, jm.encodeHtml(t)));
            Mobi.getPreviewObject(s).focus();
            f = 1;
            return false
        }
        if (s == "reqEmail" && !jm.isEmail(r)) {
            c.html(jm.format(LS.msgBoardInputCorrect, jm.encodeHtml(t)));
            Mobi.getPreviewObject(s).focus();
            f = 1;
            return false
    ...
    jm("input.msg_ipt").each(function () {
        var s = jm(this).attr("id");
        var u = jm(this).attr("placeholder");
        var r = jm(this).val();
        var t = jm(this).attr("maxlength");
        if (r.length > t) {
            c.html(jm.format(LS.msgBoardInputMaxLength, jm.encodeHtml(u), t));
            e = 1;
            return false
        }
        if (s == "reqPhone" && r.length && !jm.isPhone(r)) {
            c.html(jm.format(LS.msgBoardInputCorrect, jm.encodeHtml(u)));
            Mobi.getPreviewObject(s).focus();
            e = 1;
            return false
        }
        if (s == "reqEmail" && r.length && !jm.isEmail(r)) {
            c.html(jm.format(LS.msgBoardInputCorrect, jm.encodeHtml(u)));
            Mobi.getPreviewObject(s).focus();
            e = 1;
            return false
    ...
    if (!m.hasClass("msgBoardCaptchaHide")) {
        if (p == null || p == "") {
    ...
    n.reqContent = h;
    n.memberId = (o === undefined) ? 0 : o;
    jm.ajax({
        type: "post",
        url: "ajax/msgBoard_h.jsp",
        data: "cmd=add&msgBdData=" + jm.encodeUrl(jm.toJSON(n)) + "&validateCode=" + jm.encodeUrl(p) + "&moduleId=" + jm.encodeUrl(b),
        error: function () {
        ...
        success: function (r) {
            ...
            if (r.success) {
                ...
                if (r.needCode) {
                    Mobi.msgBoardShowMsg(r.msg);
                    m.removeClass("msgBoardCaptchaHide")
                }
                if (r.hasFW) {
                    Mobi.ing(r.msg);
                    jm(".notice").hide()
...
Mobi.noticeLeftRightMarquee = function (e, B) {
    ...
    jm.extend(A, e);
    if (A.speed == "normal") {
        jm.extend(A, {speed: 70})
    } else {
        if (A.speed == "slow") {
            jm.extend(A, {speed: 40})
        } else {
            jm.extend(A, {speed: 100})
        }
    }
    jm("#noticeMarquee" + A.id).data("options", e);
    var o = A.id, x = Mobi.getPreviewObject("noticeMarquee" + o), h = x.offsetHeight, f = x.offsetWidth, r = 0,
        a = x.querySelectorAll(".noticeMarqueeRow>span");
    for (var t = 0; t < a.length; t++) {
        r += a[t].offsetWidth
    }
    var c = Mobi.getPreviewObject("noticeContainer" + o), d = c.offsetWidth, n = (r > d) ? r : d;
    var F = A.direction, E = 0, m = "left", u = A.speed, D = (A.loop != "infinite" || A.loop <= 0) ? 1 : A.loop,
        p = false, G = A.isScrolling, z = A.noticeType, C = 20,
        w = Mobi.createElementByHtml("<div id='noticeMarqueeCopy" + o + "' class='noticeMarquee' style='overflow:hidden;width:" + n + "px;' ></div>");
    var l = "<div id='noticeMarqueeNewParent" + o + "' style='position:relative;overflow:hidden;width:" + (n + d) + "px;'></div>";
    var k = Mobi.createElementByHtml("<div style='-webkit-text-size-adjust:none;position: relative;width: 100%;height:1.5rem;line-height:1.5rem;overflow: hidden;" + (z == 4 ? "" : "left: 23px;") + "'></div>");
    var q = Mobi.createElementByHtml(l);
    x.style.width = n + "px";
    ...
    function s() {
        ...
        q.appendChild(w);
        if (!G) {
            w.style.height = 20 + "px";
            w.style.width = d + "px"
        } else {
            w.appendChild(x.querySelector(".noticeMarqueeDiv").cloneNode(true))
        }
        if (F == "left") {
            E = h
        } else {
    ...
    function y(I, K, L, J) {
        var H;
        if (K == "left") {
            H = L ? "mobi_notice_right_to_left_50" : "mobi_notice_right_to_left"
        } else {
            if (K == "right") {
                H = L ? "mobi_notice_left_to_right_50" : "mobi_notice_left_to_right"
            }
        }
    ...
    function v() {
        if (F == "left") {
            ...
            H++;
            if (G && !p) {
                q.setAttribute("style", q.getAttribute("style") + y(n + d, F, G, u))
            }
            if (G && p) {
            }
            if (!G && !p) {
            ...
            if (!G && p) {
                q.className += " mobi_notice_right_to_left";
                setTimeout(function () {
                    q.style.left = d + "px"
                }, 15000)
            }
            ...
            if (F == "right") {
                ...
                if (G && p) {
                    q.className += " mobi_notice_left_to_right_50_" + u
                }
                if (!G && !p) {
                    q.setAttribute("style", q.getAttribute("style") + y(n + d, F, G, u))
                }
                if (!G && p) {
                    q.className += " mobi_notice_left_to_right_" + u;
                    setTimeout(function () {
                        q.style.left = -(d + n + 23) + "px"
                    }, 15000)
                }
            }
        }
...
Mobi.noticeMarqueeUpDown1 = function (c) {
    ...
    jm.extend(b, c);
    if ("fast" === b.speed) {
        jm.extend(b, {speed: 500})
    } else {
        if ("slow" === b.speed) {
            jm.extend(b, {speed: 1100})
        } else {
            jm.extend(b, {speed: 850})
        }
    }
...
Mobi.noticeMarqueeUpDown = function (c) {
    var w = {direction: "top", speed: "normal", stopTime: 1000};
    jm.extend(w, c);
    if ("fast" === w.speed) {
        jm.extend(w, {speed: 500})
    } else {
        if ("slow" === w.speed) {
            jm.extend(w, {speed: 1100})
        } else {
            jm.extend(w, {speed: 850})
        }
    }
    ...
    var s = e.style, h = jm(e), v = e.querySelectorAll("li"), a = v.length, u = "";
    if (a == 1) {
        var m = "";
        if (a == 1) {
    ...
    var r = o.length - 1, d = o.length, b = w.speed + "ms", f = 0, l = jm.feat.cssPrefix + "TransitionDuration";
    if (v.length > 1) {
        n()
    }
...
Mobi.noticeUpDownSizeChange = function (d) {
    var b = jm("#noticeMarquee" + d), a = b.height(), c = b.children().children();
    jm.each(c, function (e, f) {
        jm(f).css("top", -(a + 2) + "px")
    });
    jm("#noticeScrollbar" + d).removeData("_innerHeight")
};
Mobi.siteFormAdd = function (a, r, p, e, c) {
    var h = [];
    var q = p;
    var b = true;
    var m = 100;
    var d = 1000;
    var o = e;
    var n = jm("#M" + a + "F" + r + "siteFormValidateCode");
    var k = n.val();
    var l = [];
    if (q.length > 0) {
        jm.each(q, function (H, F) {
            if (F.hide) {
                return true
            }
            var C = F.id;
            ...
            J.type = w;
            if (w == 0) {
                var L = jm("#M" + a + "F" + r + "siteFormInput" + C).val();
                if (D && L == "") {
                    Mobi.ing(jm.format(LS.siteFormSubmitInputIsEmpty, jm.encodeHtml(N)));
                    b = false;
                    return false
                }
                if (L.length > m) {
                    Mobi.ing(jm.format(LS.siteFormSubmitInputMaxLength, jm.encodeHtml(N), m));
                    b = false;
                    return false
                }
                J.val = L
                ...
                if (w == 1) {
                    var s = jm("#M" + a + "F" + r + "siteFormTextArea" + C).val();
                    if (D && s == "") {
                        Mobi.ing(jm.format(LS.siteFormSubmitInputIsEmpty, jm.encodeHtml(N)));
                        b = false;
                        return false
                    ...
                    if (s.length > d) {
                        Mobi.ing(jm.format(LS.siteFormSubmitInputMaxLength, jm.encodeHtml(N), d));
                        b = false;
                        return false
                    }
                    J.val = s
                    ...
                    if (w == 2) {
                        var y = document.querySelectorAll("input[name='M" + a + "F" + r + "siteFormRadioR" + C + "']:checked");
                        if (D && y.length == 0) {
                            Mobi.ing(jm.format(LS.siteFormSubmitCheckIsEmpty, jm.encodeHtml(N)));
                            b = false;
                            return false
                        }
                        if (y.length > 0) {
                        ...
                        if (w == 3) {
                            var z = document.querySelectorAll("input[name='M" + a + "F" + r + "siteFormCheckboxR" + C + "']:checked");
                            if (D && z.length == 0) {
                                Mobi.ing(jm.format(LS.siteFormSubmitCheckIsEmpty, jm.encodeHtml(N)));
                                b = false;
                                return false
                            ...
                            if (w == 4) {
                                var B = document.getElementById("M" + a + "F" + r + "siteFormSelect" + C),
                                    E = B.options[B.selectedIndex].value;
                                if (D && (E.length == 0 || E == "none")) {
                                    Mobi.ing(jm.format(LS.siteFormSubmitCheckIsEmpty, jm.encodeHtml(N)));
                                    b = false;
                                    return false
                                }
                                ...
                                if (w == 5) {
                                    ...
                                    if (w == 6) {
                                        var L = jm("#Mobi" + a + "Calendar" + C + "Pluginsinput").val(),
                                            x = F.dateSetting ? F.dateSetting.type : 0,
                                            A = x == 1 ? jm("#Mobi" + a + "Calendar" + C + "Plugins_endinput").val() : "";
                                        if (D && (L == "" || (x == 1 && A == ""))) {
                                            Mobi.ing(jm.format(LS.siteFormSubmitCheckIsEmpty, jm.encodeHtml(N)));
                                            b = false;
                                            return false
                                        ...
                                        if (w == 7) {
                                            var t = jm("#module" + a).find("#siteForm" + a + "fileName" + C);
                                            var K = {};
                                            if (D && t.attr("_tmpFileId") == "") {
                                                Mobi.ing("请选择文件上传");
                                                b = false;
                                                return false
                                            }
                                            if (t.attr("_tmpFileId") == "") {
                                                ...
                                                J.val = t.attr("_fileId");
                                                K.tmpFileName = t.attr("_tmpFileName");
                                                K.fileId = J.val;
                                                K.tmpFileId = t.attr("_tmpFileId");
                                                l.push(K)
                                            }
                                        } else {
                                            if (w == 8) {
                                                var M = jm("#M" + a + "F" + r + "siteFormPhoneInput" + C).val();
                                                if (D) {
                                                    if (M == "") {
                                                        Mobi.ing(jm.format(LS.siteFormSubmitInputIsEmpty, jm.encodeHtml(N)));
                                                        b = false;
                                                ...
                                                if (w == 9) {
                                                    var I = jm("#M" + a + "F" + r + "siteFormMailInput" + C).val();
                                                    if (D) {
                                                        if (I == "") {
                                                            Mobi.ing(jm.format(LS.siteFormSubmitInputIsEmpty, jm.encodeHtml(N)));
                                                            b = false;
                                                            ...
                                                            if (!jm.isEmail(I)) {
                                                                Mobi.ing(jm.format(LS.memberSignupUserAddItemCorrect, jm.encodeHtml(N)));
                                                                b = false;
                                                                return false
                                                            }
                                                        }
                                                    ...
                                                    if (w == 10) {
                                                        var v = jm("#M" + a + "F" + r + "siteFormIndentityInput" + C).val();
                                                        if (D) {
                                                            if (v == "") {
                                                                Mobi.ing(jm.format(LS.siteFormSubmitInputIsEmpty, jm.encodeHtml(N)));
                                                                b = false;
                                                        ...
                                                        if (w == 11) {
                                                            var u = jm("#M" + a + "F" + r + "siteFormAddressInput" + C).val();
                                                            if (D && u == "") {
                                                                Mobi.ing(jm.format(LS.siteFormSubmitInputIsEmpty, jm.encodeHtml(N)));
                                                                b = false;
                                                                return false
    ...
    jm.ajax({
        ...
        data: "cmd=addSubmit&formId=" + r + "&submitContentList=" + jm.encodeUrl(jm.toJSON(h)) + "&vCodeId=" + a + r + "&validateCode=" + k + "&tmpFileList=" + jm.encodeUrl(jm.toJSON(l)),
        error: function () {
            Mobi.ing(LS.systemError)
        },
        success: function (s) {
            ...
            if (s.success) {
                ...
                jm("#M" + a + "F" + r + "siteFormAddButton").attr("disabled", true);
                setTimeout(function () {
                    if (!c) {
                        c = "index.jsp"
                    }
                    ...
                    if (s.rt == -20) {
                        ...
                        if (s.rt == -28) {
                            ...
                            if (s.rt == -401) {
                                ...
                                jm("#M" + a + "F" + r + "siteFormValidateCode").val("");
                                Mobi.siteFormValidation(r, a)
                            } else {
                                Mobi.ing(LS.systemError)
                            }
                        }
...
Mobi.siteFormFileUpload = function (c, f, p, l, d, a, b, k) {
    var o = jm(".uploadify-button").height();
    var m = jm(".uploadify-button").width();
    var n = jm(".uploadify-button").css("font-size");
    var q = {
        file_post_name: "Filedata",
        upload_url: "/ajax/upsiteimg_h.jsp",
        button_placeholder_id: "siteForm" + d + "fileUpload" + p,
        file_size_limit: f + "MB",
        button_image_type: 5,
        button_height: o,
        button_width: m,
        button_text: "<span class='fk_m_btText'>" + k + "</span>",
        button_text_style: ".fk_m_btText{text-align:center;font-family: 微软雅黑; color: #666666;font-size:" + n + "}",
        button_text_top_padding: 10,
        file_queue_limit: 1,
        requeue_on_error: false,
        post_params: {ctrl: "Filedata", app: 21, type: 0, isSiteForm: true},
        file_types: a.join(""),
        file_dialog_complete_handler: function (r) {
            this._allSuccess = false;
            this.startUpload()
        },
        file_queue_error_handler: function (s, r, t) {
            switch (r) {
        ...
        upload_success_handler: function (s, r) {
        ...
        upload_error_handler: function (s, r, t) {
            if (r == -280) {
                Mobi.ing("文件取消成功", false)
            } else {
                if (r == -270) {
                    Mobi.ing("已经存在名称为" + s.name + "的文件。", true)
                } else {
                    Mobi.ing("服务繁忙，文件" + s.name + "上传失败，请稍候重试。")
                }
            }
        },
        upload_complete_handler: function (r) {
            if (r.filestatus == SWFUpload.FILE_STATUS.COMPLETE) {
                setTimeout(function () {
                    swfObj.startUpload()
                }, swfObj.upload_delay)
            } else {
                if (r.filestatus == SWFUpload.FILE_STATUS.ERROR) {
                    Mobi.ing("服务繁忙，文件" + r.name + "上传失败，请稍候重试。")
                }
            }
        },
        upload_start_handler: function (r) {
            Mobi.ing("读取文件准备上传", false)
        },
        view_progress: function (r, u, t, s) {
            var s = Math.ceil((u / t) * 100);
            if (s == 100) {
                Mobi.ing("正在上传" + s + "%", true)
            } else {
                Mobi.ing("正在上传" + s + "%", false)
            }
        }
    };
    ...
    e.onload = function () {
        ...
        h.appendChild(r);
        r.onload = function () {
            swfObj = SWFUploadCreator.create(q);
...
Mobi.siteFormFileUploadHtml = function (r, d, a, n, q, p, h, b, c, l, o) {
    var m = {
        siteFree: p,
        ...
        buttonText: o,
        getFileSizeUrl: "http://" + l + "/ajax/advanceUpload.jsp?cmd=_getUploadSize",
        uploader: "http://" + l + "/ajax/advanceUpload.jsp?cmd=_mobiupload",
        onUploadSuccess: function (t, v) {
            ...
            if (u.success) {
                ...
                k(s);
                Mobi.ing("文件:" + t.name + "，" + u.msg)
            }
        },
        onUploadError: function (s, t) {
        ...
        view_progress: function (s) {
            var s = Math.ceil(s);
            if (s == 100) {
                Mobi.ing("正在上传" + s + "%", true)
            } else {
                Mobi.ing("正在上传" + s + "%", false, true)
            }
        }
    };
    ...
    function k(s) {
        if (s.status == "start") {
            ...
            if (s.status == "ing") {
                $("#progressTitle" + s.id).text(s.title);
                $("#progress" + s.id).css("width", Math.round(s.percent) + "%");
                $("#progressNum" + s.id).html(Math.round(s.percent) + "%")
            } else {
                if (s.status == "end") {
                    $("#progressTitle" + s.id).text(s.title);
                    $("#progressBody_" + s.id).remove();
                    ...
                    if (s.status == "error") {
                        $("#progress" + s.id).addClass("progressError")
                    }
                }
            }
        }
    ...
    e.onload = function () {
        ...
        f.appendChild(s);
        s.onload = function () {
            upload = jm("#uploadButton" + d + r).uploadify(m)
        }
    };
    var f = document.documentElement || document.body;
    f.appendChild(e)
};
Mobi.onFileUploadEvent = function (q, n, r, k) {
    if (q == "upload") {
        var e = n.id;
        var p = n.name;
        var c = n.type;
        ...
        var o = 100;
        var h = n.fileId;
        $("#module" + r).find("#siteForm" + r + "fileName" + k).html(p);
        $("#module" + r).find("#siteForm" + r + "fileName" + k).attr("_tmpFileId", e).attr("_tmpFileName", p).attr("title", p).attr("_fileId", h)
    }
};
...
Mobi.siteFormPhoneValidate = function (d, a) {
    ...
    e.keyup(function (f) {
        var h = jm(this);
        h.off("mousewheel.disabledScroll").on("mousewheel.disabledScroll", function (k) {
            k.preventDefault()
        });
        h.get(0).addEventListener("DOMMouseScroll", function (k) {
            k.preventDefault()
        }, false);
...
Mobi.initmobiFormTimeBtn = function (f) {
    var e = jm("#webFooterBox"), b = "#Mobi" + f.moduleId + "Calendar" + f.siteFormItemId + "Plugins", a = jm(b),
        w = f.dateSetting, v = JSON.parse(JSON.stringify(w.od.unSelectDay)).sort(),
        u = (w.type == 0 && w.accuracy == 1), q = w.type == 1, d = new Date(),
        x = new Date(d.getFullYear(), d.getMonth(), d.getDate()), o = [{elem: a, isStart: true}], m, k, c, p, n, r, l;
    if (q) {
        p = "#Mobi" + f.moduleId + "Calendar" + f.siteFormItemId + "Plugins_end";
        o.push({elem: jm(p), isStart: false})
    } else {
        for (var s = 0; s < 24; s++) {
            if (jm.inArray(s, w.ot.unSelectTime) == -1) {
                r = s;
                break
            }
        }
    ...
    for (s = 0; s < o.length; s++) {
        (function (D) {
            var y = o[D], B = y.isStart, A = y.elem, z = q ? (B ? "fk-datePickStart" : "fk-datePickEnd") : "",
                C = w.banPassDate == 1 ? x : new Date(1900, 0, 1), E = "";
            if (q) {
                E = B ? "<div class='fk-calendarNav'>请选择开始日期</div>" : "<div class='fk-calendarNav'>请选择结束日期</div>"
            }
            A.Calendar({
                inputExtClass: z,
                minDate: C,
                ...
                minHour: r || 0,
                drawNavHeaderHtml: E,
                onBeforeInitCalendar: function (G) {
                    var F = G._options;
                    if (G._container.hasClass("fk-startDateInput")) {
                        G._option("minDate", C);
                        G._option("maxDate", null)
                    }
                    G._input[0].blur();
                    e.addClass("fk-datepickerContainer")
                },
                onBeforeCancel: function (G) {
                    var F;
                    if (q && B) {
                        F = G.getTargetOption(G._container[0].id + "_end");
                        F._hideDate(F._container, F)
                    }
                },
                beforeShowTime: function (F, G) {
                    if (w.ot.unSelectTime.length > 0 && jm.inArray(F, w.ot.unSelectTime) > -1) {
                        return false
                    }
                    return true
                },
                beforeShowDay: function (F, G) {
                    return h(F)
                },
                onAfterRefresh: function (H) {
                    var G = H._options, F;
                    if (q) {
                        H._container.find(".ui-state-active").addClass("ui-state-active-hide");
                        if (!B) {
                            H._container.find("td").not(".ui-calendar-unSelectable").eq(0).find(".ui-state-default").addClass("ui-calendar-startDate")
                        }
                    }
                },
                onSelectDate: function (K, L) {
                    if (!q) {
                        return
                    }
                    var I = K.replace(/-/g, "/"), N = new Date(I),
                        S = new Date(N.getFullYear(), N.getMonth(), N.getDate()).getTime(),
                        M = {minDate: C, maxDate: null}, G = L._container.hasClass("fk-startDateInput"), J, H, F, P, R,
                        O, Q;
                    if (G) {
                        M.minDate = N;
                        if (w.banAll == 1 || w.banHoliday == 1 || v.length > 0) {
                            for (s = 1; s < 365; s++) {
                                Q = new Date(S + (s * 86400000));
                                if (!h(Q)) {
                                    M.maxDate = Q;
                                    break
                                }
                    ...
                    if (G) {
                        F = L.getTargetOption(L._container[0].id + "_end");
                        R = F._input.val();
                        O = typeof R == "string" ? R.replace(/-/g, "/") : "";
                        P = new Date(O).getTime();
                        if (!!P && ((!!M.minDate && P < M.minDate.getTime()) || (!!M.maxDate && P > M.maxDate.getTime()))) {
                            F._input.val("")
                        }
                    } else {
                        F = L.getTargetOption(L._container[0].id.replace("_end", ""))
                    }
                    if (!!F) {
                        F._option("minDate", new Date(M.minDate));
                        F._option("maxDate", M.maxDate != null ? new Date(M.maxDate) : null);
                        F.switchMonthTo(L._options._selectedMonth, L._options._selectedYear);
                        F.refresh()
                    }
                },
                onAfterSelectDate: function (F, G) {
                    if (B) {
                    }
                },
                onAfterHidePicker: function (F) {
                    if ((q && !B) || !q) {
    ...
    if (q) {
        k = jm(p + "input");
        m = jm(b + "input");
        jm("#Mobi" + f.moduleId + "CalendarInput" + f.siteFormItemId).insertBefore(k);
        t(m, p, b);
        t(k, p, b)
    }
    ...
    function t(D, y, A) {
        var z, B, C;
        B = jm("<div class='fk-dateInputMaskWrap'></div>");
        z = jm("<div class='fk-dateInputMask'></div>");
        B.insertAfter(D);
        B.append(D);
        B.append(z);
        z.on("click", function () {
            jm(y + "input").trigger("click");
            jm(A + "input").trigger("click")
        })
    }

    function h(A) {
        var z = true, y = A.getDay(), B = A.getTime();
        if (w.banAll == 1) {
            z = false
        }
        if (y == 0 || y == 6) {
        ...
        if (w.od.t == 1 && jm.inArray(B, w.od.unSelectDay) > -1) {
            z = false
        }
        if (w.od.t == 1 && jm.inArray(B, w.od.openDay) > -1) {
            z = true
        }
        return z
    }
...
Mobi.fastLogin = function (url, mid, fid) {
    ...
    jm.ajax({
        type: "post", url: "ajax/member_h.jsp?cmd=checkMobileCodeGeneral", data: data, error: function () {
            Mobi.ing(LS.systemError)
                        ...
                        if (result.success) {
                            ...
                            if (url.indexOf("javascript") == -1) {
                                ...
                                for (var i = 0; i < methods.length - 1; i++) {
                                    ...
                                    if (patt1.test(url)) {
                                        var cells = methods[i].split(":"), start = cells[1].indexOf("(") + 1,
...
Mobi.initWBLogin = function (h, e, c, b, d, f, a) {
    jm("#" + f).click(function () {
        jm.cookie("_wbLoginKey", a, {expires: 1});
...
Mobi.wbWinListener = function (m, d, e, l, f, b, a) {
    if (typeof(m) == "string") {
        m = jm.parseJSON(m)
    }
    var c = Mobi.checkHasMobileOption(m);
    var n = false;
    if (m) {
        for (var k = 0; k < m.length; k++) {
            if (m[k]["otherLoginMust"]) {
                n = true;
                break
            }
        }
    }
    var h = "loginType=2&openId=" + encodeURIComponent(l);
    if (!n) {
        h += "&avator=" + encodeURIComponent(b) + "&name=" + f
    }
    jm.ajax({
        type: "post",
        url: "ajax/login_h.jsp?cmd=otherLoginMember&hasMobile=" + c + "&otherLoginMust=" + n,
        data: h,
        error: function () {
        ...
        success: function (o) {
            ...
            if (o.success) {
                ...
                if (o.active) {
                    Mobi.memberActive(o.email, o.memName)
                } else {
                    if (o.rt == -3) {
                        Mobi.memberOtherLoginFill(m, f, l, b, 2, o.mobileCtNameList, o.signNeenMobile, a)
                    } else {
                        if (o.rt == -303) {
...
Mobi.initQQLogin = function (h, e, c, b, d, f, a) {
    jm("#" + f).off("click").on("click", function () {
        jm.cookie("_qqLoginKey", a, {expires: 1});
...
Mobi.wxLogin = function (c, d, k, n, f, m, h, l, a, b, e) {
    jm("#" + c).click(function () {
        ...
        jm.cookie("_wxLoginKey", m, {expires: 1});
        window.location.href = "/mobiWxLoginConfirm.jsp?_key=" + m
    })
};
Mobi.wxOpenIdLogin = function (optionList, noRemark, remarkMaxLen, openId, nickName, headImg, url, faiOpenIdGreen, faiOpenId) {
    ...
    jm.ajax({
        type: "post", url: "ajax/login_h.jsp?cmd=otherLoginMember", data: data, error: function () {
            Mobi.ing(LS.memberLoginError, true)
        }, success: function (result) {
            var result = jm.parseJSON(result);
            if (result.success) {
...
Mobi.memberOtherBindOrLogin = function (h, c, d, f, l, k, e, a, b, n) {
    var m = [];
    m.push("<div style='height:7.38rem;'>");
    m.push("<div class='avator loginAvatorCircle' style='background-image:url(" + k + ");'></div>");
    m.push("<div class='userName' style='margin-top:0.5rem; text-align: center;'>" + l + "</div>");
    m.push("</div>");
    m.push("<div class='remarkCon'>");
    m.push("<div class='remarkLine'></div>");
    m.push("</div>");
    m.push("<div class='signupSubmitCtrl g_globalLine' style='margin-top:0.6rem;'>");
    m.push("<input type='button'  class='g_button sendIcon signupSubmit submitIcon' onclick='Mobi.bindOtherAcctFirst(\"" + e + '","' + f + '","' + b + '","' + n + "\");' value='" + LS.memberOtherLgnBindAcct + "'/>");
    m.push("</div>");
    m.push("<div class='signupSubmitCtrl g_globalLine' style='margin-top:0.78rem;'>");
    if (e == "other_qq") {
        m.push("<input type='button'  class='g_button sendIcon signupSubmit submitIcon g_mainColor' style='background:rgb(240,240,245);border:1px solid;' onclick='Mobi.qqWinListener(" + h + ", " + c + "," + d + ',"' + f + '","' + l + '","' + k + '","' + a + "\");' value='" + LS.memberOtherLgnNow + "'/>")
    } else {
        if (e == "other_wb") {
            m.push("<input type='button'  class='g_button sendIcon signupSubmit submitIcon g_mainColor' style='background:rgb(240,240,245);border:1px solid;' onclick='Mobi.wbWinListener(" + h + ", " + c + "," + d + ',"' + f + '","' + l + '","' + k + '","' + a + "\");' value='" + LS.memberOtherLgnNow + "'/>")
        } else {
            if (e == "other_wx") {
                m.push("<input type='button'  class='g_button sendIcon signupSubmit submitIcon g_mainColor' style='background:rgb(240,240,245);border:1px solid;' onclick='Mobi.wxOpenIdLogin(" + h + ", " + c + "," + d + ',"' + f + '","' + l + '","' + k + '","' + a + '","' + b + '","' + n + "\");' value='" + LS.memberOtherLgnNow + "'/>")
            }
        }
    }
    m.push("</div>");
    ...
    if (!jm("#bindOrLogin .loginContent").children().length) {
        jm("#bindOrLogin .loginContent").append(m.join(""))
    }
    jm("#mLogin").hide();
    jm("#bindOrLogin").show();
...
Mobi.memberOtherLoginFill = function (k, a, c, m, f, e, h, b) {
    var n = [];
    n.push("<div style='height:5rem;'>");
    if (f == 1 || f == 4) {
        n.push("<div class='avator loginTypeAvator' style='background-image:url(" + m + ");'></div>")
    } else {
        n.push("<div class='avator otherLoginTypeAvator' style='background-image:url(" + m + ");'></div>")
    }
    n.push("<div class='userName' style='margin-top:0.5rem; text-align: center;'>" + a + "</div>");
    n.push("</div>");
    n.push("<div class='remarkCon'>");
    n.push("<div class='remarkLine'></div>");
    n.push("<div class='remarkInfo'>" + LS.memberOtherLgnLastStep + "</div>");
    n.push("</div>");
    var d = "";
        ...
        if (t.otherLoginMust) {
            ...
            if ("mobile" == t.fieldKey) {
                ...
                for (var o = 0; o < e.length; o++) {
                    n.push("<option value='" + e[o]["ctName"] + "'>" + e[o]["ctShowName"] + e[o]["ctCode"] + "</option>")
                }
                n.push("</select>");
                n.push("<span class='" + r + "'>" + LS.mobileAreaCode + "</span>");
                n.push("</div>")
            }
            if (t.dropDownType) {
                n.push("<div class='g_globalLine " + d + "'>");
                if (t.must) {
                    n.push("<select id='" + t.fieldKey + "' name='" + t.name + "' class='itemEdit userAddItem isCheckUAI g_select' placeholder='" + s + LS.memberOtherLgnMust + "'>");
                    n.push("<option value=''>" + t.name + LS.memberOtherLgnMust + "</option>")
                } else {
                    n.push("<select id='" + t.fieldKey + "' name='" + t.name + "' class='itemEdit userAddItem g_select' placeholder='" + s + "'>");
                    n.push("<option value=''>" + t.name + "</option>")
                }
                var q = t.dropDownContent.split("&");
                for (var p = 0; p < q.length; p++) {
                    n.push("<option value='" + q[p] + "'>" + q[p] + "</option>")
                }
                n.push("</select><span class='" + l + "'></span>");
                if (r != "") {
                    n.push("<span class='" + r + "'>" + t.name + "</span>")
                }
                n.push("</div>")
            } else {
                n.push("<div class='g_globalLine " + d + "'>");
                if (t.must) {
                    n.push("<input type='text' maxlength='50' id='" + t.fieldKey + "' name='" + t.name + "' class='mustItem isCheckUAI itemEdit userAddItem  g_input' maxlength='50' placeholder='" + s + LS.memberOtherLgnMust + "'><span class='" + l + "'></span>")
                } else {
                    n.push("<input type='text' maxlength='50' id='" + t.fieldKey + "' name='" + t.name + "' class='mustItem itemEdit userAddItem  g_input' maxlength='50' placeholder='" + s + "'><span class='" + l + "'></span>")
                }
                if (r != "") {
                    n.push("<span class='" + r + "'>" + t.name + "</span>")
                }
    ...
    n.push("<div class='signupSubmitCtrl g_globalLine " + d + "' style='margin-top:1rem;'>");
    n.push("<input type='button'  class='g_button sendIcon signupSubmit submitIcon' onclick='Mobi.memberOtherLoginSubmit(\"" + a + '", ' + f + ', "' + c + '", "' + b + '", "' + m + "\")' value='" + LS.login + "'/>");
    n.push("</div>");
    jm("#fillAcctInfo").parents(".g_web, .middleCenter").css("background", "#f0f0f5");
    if (!jm("#fillAcctInfo .loginContent").children().length) {
        jm("#fillAcctInfo .loginContent").append(n.join(""))
    }
    jm("#mLogin").hide();
    jm("#bindOrLogin").hide();
...
Mobi.memberOtherLoginAdd = function (b, c, m, l, d, e, k, f, h, a) {
    var n = [];
    n.push("<div style='height:5rem;'>");
    if (k == 1 || k == 4) {
        n.push("<div class='avator' style='height:2.5rem;width:2.5rem;margin-top:1rem;margin-left:6.2rem;border-radius:50%;background:url(" + m + ");background-size:2.5rem;'></div>")
    } else {
        n.push("<div class='avator' style='height:1.2rem;width:1.2rem;margin-top:1rem;margin-left:6.6rem;border-radius:50%;background:url(" + m + ");background-size:1.2rem;'></div>")
    }
    n.push("<div class='userName' style='margin-top:0.5rem;'>" + b + "</div>");
    n.push("</div>");
    n.push("<div class='desc' style='height:3rem;font-size:0.6rem;color:#666;'>");
    if (k == 1) {
        n.push("<div class='firstLine' style='width:4.5rem;'>" + LS.memberOtherLgnQQUser + ":</div>")
    } else {
        if (k == 2) {
            n.push("<div class='firstLine' style='width:5.8rem;'>" + LS.memberOtherLgnWBUser + ":</div>")
        } else {
            n.push("<div class='firstLine' style='width:5rem;'>" + LS.memberOtherLgnWXUser + ":</div>")
        }
    }
    n.push("<div class='secondLine' style='width:13rem;margin-top:0.5rem;'>" + LS.memberOtherLgnBindAcctMsg + "</div>");
    n.push("</div>");
    n.push("<div class='choose' style='font-size:0.6rem;color:#999;height:7rem;'>");
    n.push("<div class='haveMember' style='width:3rem;'>" + LS.memberOtherLgnHaveAcct + "</div>");
    n.push("<div class='bindNow g_button sendIcon' style='margin-bottom:1rem;' onclick='Mobi.bindNow(" + k + ', "' + c + '", "' + a + "\");'>" + LS.memberOtherLgnBindNow + "</div>");
    n.push("<div class='noMember' style='width:3rem;'>" + LS.memberOtherLgnNotAcct + "</div>");
    n.push("<div class='signUp g_button sendIcon' id='signUp' >" + LS.memberOtherLgnSignUp + "</div>");
    n.push("</div>");
    if (!jm("#bindAcct .loginContent").children().length) {
        jm("#bindAcct .loginContent").append(n.join(""))
    }
    jm("#mLogin").hide();
    jm("#bindAcct").show();
...
Mobi.bindOtherAcct = function (f, e, a, d, c, b) {
    jm("#changeOtherLoginAcct").click(function () {
        ...
        h += "</div>";
        h += "<div class='g_globalLine'>";
        h += "<input type='button'  class=' g_button sendIcon' onclick='Mobi.bindOtherAcctSubmit(" + f + ", true, " + l + ")' value='" + LS.memberOtherLgnBindNow + "'/>";
        h += "</div>";
        ...
        jm("#signUp").click(function () {
            ...
            Mobi.signUp(f, e, a, d, l, c, b)
        })
    })
};
Mobi.signUp = function (f, l, a, c, h, e, k) {
    var d = false;
    var n = [], b = "";
    l = jm.parseJSON(l);
    e = jm.parseJSON(e);
    if (Mobi.checkHasMobileOption(l)) {
        b = "tagWidth8"
    }
    var m = "";
    n.push("<div class='g_globalLine " + b + "'>");
    ...
    n.push("</div>");
    jm.each(l, function (p, s) {
        var q = "";
        if ("email" == s.fieldKey) {
            m = "icon-emailIcon g_mainColor"
        } else {
            if ("phone" == s.fieldKey) {
                m = "icon-phoneIcon g_mainColor"
            } else {
                if ("name" == s.fieldKey) {
                    m = "icon-nameIcon g_mainColor"
                } else {
                    m = "icon-customIcon g_mainColor";
                    q = "customIcon"
                }
            }
        }
        ...
        n.push("<div class='g_globalLine " + b + "'>");
        if (s.must) {
            n.push("<input type='text' maxlength='50' id='" + s.fieldKey + "' name='" + s.name + "' class='mustItem isCheckUAI itemEdit userAddItem  g_input' maxlength='50' placeholder='" + r + LS.memberOtherLgnMust + "'><span class='" + m + "'></span>")
        } else {
            n.push("<input type='text' maxlength='50' id='" + s.fieldKey + "' name='" + s.name + "' class='itemEdit userAddItem  g_input' maxlength='50' placeholder='" + r + "'><span class='" + m + "'></span>")
        }
        if (q != "") {
    ...
    if (h == 1) {
        ...
        if (h == 2) {
            ...
            n.push("<div style='margin-top:0.5rem;font-size:0.6rem;color:#999;width:13.5rem;'>" + LS.signByWXCanLogin + "</div>")
        }
    }
    n.push("<div class='signupSubmitCtrl g_globalLine " + b + "'>");
    n.push("<input type='button'  class='g_button sendIcon signupSubmit submitIcon' onclick='Mobi.bindOtherAcctSubmit(" + f + ", false, " + h + ");' value='" + LS.memberOtherLgnSignUp + "'/>");
    n.push("</div>");
...
Mobi.bindOtherAcctSubmit = function (m, a, h) {
    var s = "";
    var v = {};
    if (a) {
        ...
        var q = jm("#memberSignupRepwd").val();
        if (e != q) {
        ...
        if (jm("#memberSignupRemark").length > 0) {
            r = jm("#memberSignupRemark").val();
            var w = jm("#memberSignupRemark").attr("maxlength");
            if (r.length > w) {
                Mobi.ing(jm.format(LS.memberSignupRegisterRemarkMaxLength, w));
        ...
        jm("#mSignUp .userAddItem").each(function () {
            ...
            f = jm(this).val();
            b = jm(this).attr("name");
            o = jm(this).attr("maxlength");
            v[userAddItemID] = f;
            if (typeof(o) != "undefined" && o != null && f.length > o) {
                Mobi.ing(jm.format(LS.memberSignupUserAddItemMaxLength, b, o));
    ...
    jm.ajax({
        type: "post",
        url: "ajax/member_h.jsp?" + s,
        data: "info=" + jm.encodeUrl(jm.toJSON(v)) + "&mid=" + m + "&loginType=" + h,
        error: function () {
            Mobi.ing(LS.memberSignupRegisterError)
        },
        success: function (x) {
            var y = jm.parseJSON(x);
            if (y.success) {
                if (y.fromBind) {
                    Mobi.memberActive(y.mail, y.memName)
                } else {
                    if (y.active) {
                        Mobi.memberActive(v.email, v.acct)
                    } else {
                        document.location.reload()
                    }
                }
            } else {
                if (y.msg == "该帐号已绑定到其他帐号") {
                                ...
                                if (y.rt == -6) {
                                    ...
                                    if (y.rt == -4) {
                                        ...
                                        if (y.rt == -3) {
                                            ...
                                            if (y.rt == Mobi.otherLoginErrno.acctAlreadyBind) {
                                                Mobi.ing(LS.memberOtherLgnAcctAlreadyBind)
                                            } else {
                                                Mobi.ing(LS.memberSignupRegisterError)
                                            }
...
Mobi.memberSignupSubmit = function (b, m, v) {
    if (!m && !v) {
    ...
    jm(".userAddItem").each(function () {
        ...
        u[userAddItemID] = e;
        if (typeof(n) != "undefined" && n != null && e.length > n && k == "input") {
            Mobi.ing(jm.format(LS.memberSignupUserAddItemMaxLength, a, n));
            Mobi.getPreviewObject(userAddItemID).focus();
            t = 1;
            return false
        }
    ...
    jm.ajax({
        ...
        data: "info=" + jm.encodeUrl(jm.toJSON(u)) + "&validateCode=" + f,
        error: function () {
            Mobi.ing(LS.memberSignupRegisterError)
        },
        success: function (x) {
            ...
            if (y.success) {
                if (y.active) {
                    Mobi.memberActive(u.email, y.acct, b, function () {
                    })
                } else {
                    if (y.rt == 0) {
                        Fai.top.location.href = "login.jsp?errno=-303"
                                ...
                                if (y.rt == -4) {
                                    ...
                                    if (y.rt == -28) {
                                        ...
                                        if (y.rt == -20) {
                                            ...
                                            if (y.rt == -1001) {
                                                Mobi.showPluralPopup("email", y.headImg, y.name, y.acct, d, u, b)
                                            } else {
                                                if (y.rt == -1002) {
                                                    Mobi.showPluralPopup("mobile", y.headImg, y.name, y.acct, d, u, b)
                                                } else {
                                                    Mobi.ing(LS.memberSignupRegisterError)
                                                }
                                            }
...
Mobi.showPluralPopup = function (h, f, a, n, m, d, b) {
    var p = h == "email" ? "邮箱" : "手机号码", o = h == "email" ? d.email : d.mobile,
        e = h == "email" ? "ajax/member_h.jsp?cmd=proceedAfterMail" : "ajax/member_h.jsp?cmd=proceedAfterMobile";
    var l = Mobi.isNull(a) || a == "" || a == "null" ? n : a;
    var k = [];
    k.push("<div style='position: relative; top: -1.094rem; left: -.125rem; display: inline-block; width: 3.875rem; height: 3.875rem;'>");
    k.push("	<img src=" + f + " style='height: 3.875rem; width: 3.875rem; border-radius: 100%; border: .125rem #f2f2f2 solid;' />");
    k.push("</div>");
    k.push("<div style='font-size: .75rem; color: #333; position: relative; top: -.375rem;'>");
    k.push("	<span style='display: block; text-align: center;'>" + l + "</span>");
    k.push("	<span style='display: block; text-align: center; position: relative; top: .4rem'>该" + p + "已绑定帐号！</span>");
    k.push("</div>");
    var q = {
        textClass: "proceed", cancelClass: "loginInstantly", content: k.join(""), callback: function () {
            c()
    ...
    function c() {
        var s = [];
        s.push("<div style='width: 2.5rem; height: 2.5rem; border-radius:50%; border: .125rem solid gray; position: relative; top: -.625rem; left: 4.0625rem; border-color: #F8BB86;'>");
        s.push("<div style='animation: pulseWarningIns 0.75s infinite alternate; -webkit-animation: pulseWarningIns 0.75s infinite alternate;'>");
        s.push("<span style='position: absolute; width: 0.15625rem; height: 1.46875rem; left: 50%; top: .3125rem; webkit-border-radius: .0625rem; border-radius: .0625rem; margin-left: -.0625rem; background-color: #F8BB86;'></span>");
        s.push("<span style='position: absolute; width: .21875rem; height: .21875rem; -webkit-border-radius: 50%; border-radius: 50%; margin-left: .09375rem; left: 42%; bottom: .3125rem; background-color: #F8BB86;'></span>");
        s.push("</div>");
        s.push("</div>");
        s.push("<div style='color: #333; font-size: .75rem; text-align:center;'>确认注册将解除" + o + "与原帐号的绑定，并注册一个与原帐号无关的新帐号！</div>");
        var r = {
            textClass: "confirm", content: s.join(""), callback: function () {
                jm.ajax({
                    type: "post", url: e, data: "info=" + jm.encodeUrl(jm.toJSON(d)), error: function () {
                        Mobi.ing(LS.memberSignupRegisterError)
                    }, success: function (t) {
                        var u = jm.parseJSON(t);
                        if (u.success) {
                            if (u.active) {
                                Mobi.memberActive(d.email, u.acct, b, function () {
                                })
                            } else {
                                if (u.rt == 0) {
                                    Fai.top.location.href = "login.jsp?errno=-303"
                                            ...
                                            if (u.rt == -4) {
                                                ...
                                                if (u.rt == -28) {
                                                    ...
                                                    if (u.rt == -20) {
                                                        ...
                                                        if (u.rt == -1001) {
                                                            Mobi.showPluralPopup("email", u.headImg, u.name, u.acct, m, d, b)
                                                        } else {
                                                            if (u.rt == -1002) {
                                                                Mobi.showPluralPopup("mobile", u.headImg, u.name, u.acct, m, d, b)
                                                            } else {
                                                                if (u.rt == -1500) {
                                                                } else {
                                                                    Mobi.ing(LS.memberSignupRegisterError)
...
Mobi.readBulletin = function () {
    ...
    jm.ajax({
        type: "post", url: "ajax/member_h.jsp", data: "cmd=setBulletinReadTime&id=" + b, error: function () {
            Mobi.ing(LS.systemError)
        }, success: function (c) {
            ...
            if (c.success) {
                ...
                jm("#mBulletinConten img").each(function () {
                    ...
                    if (jm(this).attr("width") >= e) {
                        ...
                        jm(this).css({height: d + "px", width: e + "px"})
                    }
                })
            } else {
                Mobi.ing(LS.systemError)
...
Mobi.memberAddrInfoOpera = function (b, c, x, u) {
    var l = c, A = "", n = "", f = l.length, z = "", t = false;
    var a = {};
    site_cityUtil.initProvinces(x);
    ...
    jm("#addrInfoList .orderAddAddrInfo").click(function () {
        ...
        if (f < 6) {
            ...
            A = "addAddr";
            z = "ajax/member_h.jsp?cmd=set&id=" + b
        } else {
    ...
    jm("#addrInfoList").delegate(".edit, .info_name", "click", function () {
        ...
        if (jm(this).attr("class") == "edit") {
            n = jm(this).attr("_index")
        } else {
            n = jm(this).parent().attr("_item")
        }
        A = "editAddr";
        z = "ajax/member_h.jsp?cmd=set&id=" + b;
        var H = l[n];
        jm("#editAddrInfo").find(".propItemValue").each(function () {
            var P = jm(this).attr("_field");
            jm(this).val(H[P]);
            if ("mobile" == P) {
                if ("mobileCt" in H) {
                    if (H.mobileCt != null && H.mobileCt != "") {
    ...
    jm("#addrInfoList").delegate(".selectedDiv label", "click", function () {
        ...
        n = jm(this).parents(".selectedArea").parent().attr("_item");
        var H = {};
        H.isDefault = 1;
        a.opera = A;
        a._item = n;
        a.addrInfo = H;
        c[n]["isDefault"] = H.isDefault;
        var I = this;
        jm.ajax({
            type: "post",
    ...
    jm("#editAddrInfo").delegate(".orderSaveAddrInfo", "click", function () {
        ...
        var K = "";
        var H = false;
        R.parent().find(".propItemValue").each(function () {
            W = jm(this).attr("_field");
            L = jm(this).val();
            K = jm(this).attr("_prop");
            H = jm(this).attr("_required") == "1" ? true : false;
            if (H && (L == null || L == "")) {
                Mobi.ing(jm.format(LS.memberSignupUserAddItemCorrect, K));
                this.focus();
                S = false
            }
            if (W == "email" && L.length > 0) {
                if (!jm.isEmail(L)) {
                    Mobi.ing(jm.format(LS.memberSignupUserAddItemCorrect, K));
                    this.focus();
                    S = false
            ...
            if (W == "mobile" && L.length > 0) {
                if (!Mobi.isNationMobile(L)) {
                    Mobi.ing(LS.mobileNumRegular);
                    this.focus();
                    L = "";
                    S = false
                }
                I.mobileCt = jm(this).parent().find("#mobileCt").val()
            }
            if (W == "mobile" && L.length <= 0) {
                I.mobileCt = ""
            }
        ...
        var Q = !(jm("#allArea").val() == "os" || jm("#allArea").val() == "zh");
        var N = jm("#areaBoxInput").attr("area4");
        var J = jm("#areaBoxInput").attr("area3");
        var P = jm("#areaBoxInput").attr("area2");
        var O = jm("#areaBoxInput").attr("area1");
        var V = jm("#addrInfo_street");
        H = R.parent().find("#addrInfo_street").attr("_required") == "1" ? true : false;
        if (H) {
        ...
        if (jm("#allArea").length == 1) {
            if (Fai.top._lcid == 2052 || Fai.top.lcid == 1028) {
                U = jm("#areaBoxInput").val().replace(/-/g, "") + jm("#addrInfo_street").val();
                if (T.provinceCode == 990000) {
                    U = U.replace(jm("div[pid='990000']").text() + jm("div[pid='990000']").text(), jm("div[pid='990000']").text())
                }
            } else {
                U = jm("#areaBoxInput").val().replace(/-/g, " ") + " " + jm("#addrInfo_street").val();
                if (T.provinceCode == 990000) {
        ...
        if (S) {
            jm.ajax({
                type: "post", url: z, data: "info=" + jm.encodeUrl(jm.toJSON(a)), error: function () {
                    Mobi.ing(LS.memberProfileError)
                }, success: function (X) {
                    var ab = jm.parseJSON(X);
                    if (ab.success) {
                        var Y = I.phone;
                        var Z = I.mobile;
                        var ad = "";
                        ...
                        if (A == "editAddr") {
                            if (M) {
                                jm("#addrInfoList").find(".addrInfo").each(function () {
                                    ...
                                    if (jm(this).attr("_item") == n) {
                                        jm(this).find(".name").text(I.name);
                                        jm(this).find(".phone").text(ad);
                                        jm(this).find("#addr").text(I.addr);
                                        addrInfo = jm(this)
                                    }
                                })
                            } else {
                            ...
                            if (A == "addAddr") {
                                ...
                                var ac = l.length;
                                var aa = [];
                                aa.push("<div class='addrInfo' _item=" + ac + ">");
                                aa.push("<div class='" + (M ? "" : "middle") + " info_name' style='width:100%;'>");
                                aa.push("<div class='nameAndPhone'><span class='name'>" + I.name + "</span><span class='phone'>" + ad + "</span></div><div class='address'><span id='addr'>" + I.addr + "</span></div>");
                                aa.push("</div>");
                                aa.push("<div class='selectedArea' style='width: 100%;float:left;'>");
                                aa.push("<div class='left'>");
                                aa.push("<div class='selectedDiv'><label for='input" + ac + "'><input type='radio' class='checkbox-comp' id='input" + ac + "' name='defaultLogo'><span class='text'>设为默认</span></label></div>");
                                aa.push("</div>");
                                aa.push("<div class='right'>");
                                aa.push("<div class='edit' _index=" + ac + "><span>编辑</span></div><div class='cutOut'><span>删除</span></div>");
                                aa.push("</div>");
                                aa.push("</div>");
                                aa.push("</div>");
                                jm("#addrInfo").append(aa.join(""));
                                l.push(I);
                                jm("#editAddrInfo").hide();
                                jm("#addrInfoList").show()
                            }
    ...
    jm("#addrInfo").delegate(".cutOut", "click", function () {
        var J = jm(this);
        n = J.parents(".selectedArea").parent().attr("_item");
        a.opera = "delAddr";
        a._item = n;
        var H = function (L, K) {
            jm.ajax({
        ...
        var I = {
            textClass: "confirm", content: "确定要删除该收货人信息吗？", callback: function () {
                H(b, n)
            }
        };
        Mobi.prompt(I)
    });
    var w = LS.mallPleaseChoose, E = [], o, F, s, C, G, r, D;
    ...
    jm.each(site_cityUtil.getAreaGroupsPinYin(), function (H, I) {
        q += "<div class='pv_group' style='" + (I[0] == "OS" ? "display:none;" : "") + "'>";
        q += "<div class='group_head'>" + I[0] + "</div>";
        q += "<div class='group_content'>";
        jm.each(I[1], function (K, J) {
            if (x == 2052 || x == 1028) {
                q += "<div class='group_item' pid='" + J + "' pname='" + site_cityUtil.getInfo(J).name + "'>" + site_cityUtil.simpleProvinceNameStr(site_cityUtil.getInfo(J).name) + "</div>"
            } else {
                q += "<div class='group_item' pid='" + J + "' pname='" + site_cityUtil.getInfoEn(J).name + "'>" + site_cityUtil.simpleProvinceNameStrEn(site_cityUtil.getInfoEn(J).name) + "</div>"
            }
        });
        q += "</div>";
        q += "</div>"
    });
    jm("#areaBox1 .pv_content").html("").append(q);
    jm("#allArea").change(function () {
        ...
        if (jm("#allArea").val() == "zh" || jm("#allArea").val() == "os") {
            jm(".J_ssq").show();
    ...
    jm("#areaBoxInput").unbind("click").bind("click", function () {
        if (jm("#allArea").val() == "zh") {
            ...
            if (jm("#allArea").val() == null || jm("#allArea").val() == "os") {
            } else {
                p();
                jm("#areaBox2").toggle();
                jm("#areaBox1").hide();
    ...
    jm("#province_box .group_item").bind("click", function () {
        ...
        var K = "";
        if (x == 2052 || x == 1028) {
            K = v(site_cityUtil.getCities(I))
        } else {
            K = v(site_cityUtil.getCitiesEn(I))
        }
        var J = jm(K).html();
    ...
    jm("#city_box").delegate(".group_item", "click", function () {
        ...
        var L = "";
        if (x == 2052 || x == 1028) {
            L = m(site_cityUtil.getCounty(J))
        } else {
            L = m(site_cityUtil.getCountyEn(J))
        }
        var K = jm(L).html();
    ...
    jm("#county_box").delegate(".group_item", "click", function () {
        ...
        var H = "";
        if (x == 2052 || x == 1028) {
            H = y(site_cityUtil.getStreet(K))
        } else {
            H = y(site_cityUtil.getStreetEn(K))
        }
        var L = jm(H).html();
...
Mobi.profileLogout = function (a) {
    ...
    var c = {
        textClass: "confirm", content: LS.onLogout, callback: function () {
...
(function (s, n, c) {
    var h = n.prototype, t, d, k, m = [], u = 10, a, b = [];
    h.init = function () {
        d = this.pIdList, k = this.panel;
        t = this.mid;
        if (d.length == 0) {
            f();
            return
    ...
    function f() {
        if (d.length == 0) {
            k.find(".profileContent").html("<div class='noCollIcon'></div><div class='noCollTip'>" + LS.notCollect + "</div>")
        }
    }

    function q() {
        s.post("ajax/product_h.jsp", {mid: t, cmd: "updateCollections", ids: s.toJSON(d)}, function (x) {
            if (x.success) {
                d = x.list
            }
        }, "json")
    ...
    function p(x) {
        s.ajax({
            ...
            data: {cmd: "batchGetPd", ids: s.toJSON(x)},
            async: false,
            type: "POST",
            dataType: "json",
            success: function (y) {
    ...
    function l(x) {
        ...
        s.ajax({
            ...
            success: function (z) {
                if (z.success) {
                    var A = false;
                    s.each(z.list, function (B, C) {
                        if (C.fieldKey == "mallPrice") {
                            A = true
                        }
                    });
                    y.showPrice = A;
    ...
    function w() {
        var y = {}, x = false;
        y.productCollections = d.reverse() + "";
        s.ajax({
            url: "ajax/member_h.jsp",
            data: {cmd: "set", id: t, info: s.toJSON(y)},
            async: false,
            type: "POST",
            dataType: "json",
            success: function (z) {
    ...
    function o(x, y) {
        var z = [];
        s.each(y, function (A, C) {
            var B = v(C.lid);
            z.push("<li>");
            z.push('  <div class="pdImg">');
            z.push('      <a href="javascript:;" _href="pd.jsp?pid=' + C.id + '&returnUrl=profile.jsp">');
            z.push('          <img src="' + C.picPath + '" />');
            z.push("      </a>");
            z.push("  </div>  ");
            z.push('  <div class="pdName">' + C.name + "</div>");
            if (C.mallPrice != -1 && B.showPrice) {
                z.push('  <div class="pdPrice"><div class="mallPrice">￥ ' + C.mallPrice + "</div></div>")
            }
            z.push('  <div class="cancelCollection" data-id="' + C.id + '">' + LS.cancelCollect + "</div>");
            z.push("</li>")
        });
    ...
    function r() {
        k.find(".collectionList li img[_src]").each(function () {
            var y = s(this).attr("_src");
            var x = new Image();
            x.src = y;
            s(this).attr("_src", "");
            s(this).attr("src", y)
    ...
    function e() {
        Mobi.onTouchAndClickEvent(".cancelCollection", function (A) {
            var y = $(this);
            var z = {
                textClass: "confirm", content: LS.sureCancelCollect, callback: function () {
                    var C = y.attr("data-id");
                    var D = d.indexOf(Number(C));
                    if (D > -1) {
                        d.splice(D, 1)
                    }
                    if (w()) {
                    ...
                    if (k.find(".collectionList li").length < 6 && d.length > a) {
                        var B = d.slice(a, a + u);
                        a = a + B.length;
                        if (B.length > 0) {
                            p(B)
                    ...
                    f();
                    s("#mobiPrompt").remove();
                    s("#mobiPrompt_Bg").remove()
                }
            };
            Mobi.prompt(z)
        });
        Mobi.onTouchAndClickEvent(".pdName,.pdPrice,.pdImg", function (z) {
            var y = s(this).parent().find("a").attr("_href");
            location.href = y;
            s.setCookie("_fromCollect", true)
        });
        s(window).on("scroll", function () {
            if (d.length > a) {
                var z = Math.max(document.body.scrollHeight, document.documentElement.scrollHeight);
                if (s(window)[0].scrollY + s(window).height() + 100 >= z) {
                    var y = d.slice(a, a + u);
                    a = a + y.length;
                    if (y.length > 0) {
                        p(y)
        ...
        if (s.getCookie("_openCollect")) {
            var x = s("#collection").find(".itemName").html();
            s("#modifyCollection").find(".title").html(x);
            s("#profile").hide();
            s("#modifyCollection").show();
            s.setCookie("_openCollect", "", -1)
        }
    }
})(jm, Mobi.loadPdCollectionList);
Mobi.loadCouponList = (function (k) {
    function l(u, t) {
        this.mid = u;
        this.flag = t
    }

    var m = l.prototype, r, d = 0, p = [1, 1, 1], o = 10, q = [[], [], []],
    ...
    function a() {
        var w = r;
        var u = k(".couponListPanel");
        var t = [];
        t.push('<div class="tabList">');
        t.push('<div class="coupon-tab"><span><span class="">' + LS.notUse + '(</span><span class="coupon-amount">' + q[0].length + "</span><span>)</span></span><em></em></div>");
        t.push('<div class="coupon-tab"><span><span>' + LS.used + '(</span><span class="coupon-amount">' + q[1].length + "</span><span>)</span></span><em></em></div>");
        t.push('<div class="coupon-tab"><span><span>' + LS.expired + '(</span><span class="coupon-amount">' + q[2].length + "</span><span>)</span></span><em></em></div>");
        t.push("</div>");
        t.push("<div id='showCouponList'>");
        t.push(n());
        t.push("</div>");
        u.append(t.join(""));
        if (w.flag) {
        ...
        var v = jm("body").height()
    }

    function h(u) {
        var x = "fk-coupon-tab-active", t = jm(".coupon-tab");
        t.attr("style", "");
        t.find("em").attr("style", "");
        t.removeClass(x);
        var v = jm(".coupon-tab").eq(u), w = jm(".g_button").css("background-color");
        v.css({background: w, color: "#fff", borderColor: w});
        v.find("em").css({borderColor: w + "transparent transparent transparent"});
        v.addClass(x)
    }

    function f(t) {
        var u = jm(".coupon-tab").eq(t);
        u.addClass("coupon-tab-selected").siblings(".coupon-tab").removeClass("coupon-tab-selected")
    }

    function b() {
        if (jm(".webHeaderBg").height() <= jm("body")[0].scrollTop && (Fai.top._templateFrameId < 2000 || Fai.top._templateFrameId >= 3000)) {
            jm(".tabList").css({position: "fixed", width: jm(".couponListPanel").width() + "px"});
            jm("#showCouponList").css("margin-top", "1.7rem")
        } else {
            jm(".tabList").css({position: "", width: ""});
    ...
    function s() {
        ...
        Mobi.onTouchAndClickEvent(".coupon-tab", function () {
            if (jm(this).index() != d) {
                ...
                k(".show-coupon-list").remove();
                k(".coupon-empty").remove();
                k("#showCouponList").append(n())
            }
        });
        ...
        document.addEventListener("touchend", function (u) {
            b()
        }, false);
        ...
        Mobi.onTouchAndClickEvent(".icon-delIcon", function () {
            var w = k(this).parents(".coupon-warp");
            var x = w.attr("data_id");
            var v = LS.delCouponWillUnavail;
            if (d != 0) {
                v = LS.confirmDelCoupon
            }
            var u = {
                textClass: "confirm", content: v, callback: function () {
                    q[d].splice((p[d] - 1) * o, 1);
                    k.ajax({
                        url: "ajax/member_h.jsp?cmd=delCoupon",
                        data: "mid=" + t.mid + "&cdid=" + x,
                        dataType: "json",
                        success: function (y) {
                            if (y.success) {
                                w.remove();
                                k(".coupon-tab").eq(d).find(".coupon-amount").text(q[d].length)
                            }
                        },
                        error: function () {
                        }
    ...
    function n() {
        ...
        var v = [];
        if (u.length == 0) {
            v.push("<div class='coupon-empty'>");
            v.push("<div class='icon-coupons1'></div>");
            var w = "";
            if (d == 0) {
                w = jm.format(LS.notHasCoupon, LS.notUse)
            } else {
                if (d == 1) {
                    w = jm.format(LS.notHasCoupon, LS.used)
                } else {
                    if (d == 2) {
                        w = jm.format(LS.notHasCoupon, LS.expired)
                    }
                }
            }
            v.push("<div class='showMsg'>" + w + "</div>");
            v.push("</div>")
        } else {
            v.push("<div class='show-coupon-list'>");
            k.each(u, function (A, z) {
                var y = "g_bgColor";
                var C = "g_mainColor";
                if (d != 0) {
                    y = "";
                    C = "coupon-words-invalid"
                }
                var B = "";
                if (A == 0) {
                    B = "padding-top:0.75rem;"
                }
                v.push("<div class ='couponItem' data_id='" + z.cdId + "' style='" + B + "'>");
                v.push("<div class='couponItem-left " + y + "'>");
                v.push("<div class='couponItemLeftBackground'></div>");
                v.push("<div class='couponItemLeftData'>" + Fai.top.choiceCurrencyVal + "</span><span style='font-size: 1.625rem;'>" + z.savePrice + "</span></div>");
                v.push("<div class='couponItemLeftCondit'>" + jm.format(LS.fullMinCanUse, z.orderMinPrice) + "</div>");
                v.push("</div>");
                v.push("<div class='couponItem-right'>");
                if (Fai.top._lcid == 2052 || Fai.top._lcid == 1028) {
                    if (d == 1) {
                        v.push("<div class='couponState couponStateUsed'></div>")
                    } else {
                        if (d == 2) {
                            v.push("<div class='couponState couponStateExpired'></div>")
                        }
                    }
                } else {
                    if (d == 1) {
                        v.push("<div class='couponState couponStateUsedEn'></div>")
                    } else {
                        if (d == 2) {
                            v.push("<div class='couponState couponStateExpiredEn'></div>")
                        }
                    }
                }
                v.push("<div class='couponItemRightName " + C + "'>" + jm.encodeHtml(z.couponName) + "</div>");
                v.push("<div class='couponItemRightValidity'>" + z.validity + "</div>");
                v.push("</div>");
                v.push("</div>")
            });
            v.push("</div>")
...
(function (p, l, f) {
    var k = l.prototype;
    var u = p(".picArea .coverImg"), r = p(".picArea"), o = p("#headPic"), c, t, d, m, e, h, b, q;
    k.init = function () {
        this.initBind()
    };
    k.initBind = function () {
        var F = this;
        u = p(".picArea .coverImg"), r = p(".picArea"), o = p("#headPic");
        o.on({
            load: function () {
                h = p(this)[0].offsetTop;
                b = p(this)[0].offsetLeft;
                q = Math.min(p(this)[0].height, p(this)[0].width);
                m = h + p(this)[0].height / 2 - q / 2;
                e = b + p(this)[0].width / 2 - q / 2;
                o.css({top: h + "px", left: b + "px"});
                s()
            }
        });
        p("#memberHeadPic").click(function () {
            var G = setInterval(function () {
                if (p("#headPic")[0].complete) {
                    p("#profile").hide();
                    p(".middleCenter").css("padding-bottom", "0");
                    var H = p("#editMemberHeadPic");
                    H.css("height", p(window).height() + "px");
                    p("#editMemberHeadPic").show();
                    if (Mobi.deviceTypeIsMobi()) {
                        p("#coverBox").remove()
                    }
                    r.css("height", p(window).height() - Math.floor(p(".loginHeader").height()) - Math.floor(p(".editHeadPicFooter").height()) + "px");
                    c = Number(r.height());
                    t = Number(r.width());
                    h = (c - o.height()) / 2;
                    b = (t - o.width()) / 2;
                    if (p.toJSON(F.headPicJson) == "{}" || F.headPicJson.thumbId == "") {
                        m = h;
                        e = b;
                        q = Number(o.width())
                    } else {
                        var I = F.headPicJson.imgW / o.width();
                        m = h + F.headPicJson.top / I;
                        e = b + F.headPicJson.left / I;
                        q = F.headPicJson.width / I
                    }
                    o.css({top: h + "px", left: b + "px"});
                    d = Math.min(o.width(), o.height());
                    n();
                    s();
                    clearInterval(G)
                }
        ...
        p(".editHeadPicFooter .saveBtn").click(function () {
            var G = p(this).attr("mid");
            var H = p(this).attr("newimg");
            var J = p(this).attr("oldimgid");
            var I = {};
            if (!H && !J) {
                p("#editMemberHeadPic").hide();
                p("#profile").show();
                return
            }
            F.headPicJson.width = Math.round(q);
            F.headPicJson.top = Math.round(m - h);
            F.headPicJson.left = Math.round(e - b);
            F.headPicJson.imgH = Math.round(o[0].height);
            F.headPicJson.imgW = Math.round(o[0].width);
            if (H != null) {
                $.ajax({
                    type: "post",
                    url: "ajax/member_h.jsp?cmd=cimg",
                    data: "oldImgId=" + J + "&mid=" + G + "&newImg=" + p.encodeUrl(H),
                    async: false,
                    error: function () {
                        Mobi.ing(LS.memberProfileError)
                    },
                    success: function (K) {
                        K = JSON.parse(K);
                        if (K.success) {
                            F.headPicJson.thumbId = K.fileId
                        }
                    }
                })
            } else {
                F.headPicJson.thumbId = J
            }
            I.headPic = F.headPicJson;
            $.ajax({
                type: "post",
                async: false,
                url: "ajax/member_h.jsp?cmd=set",
                data: "id=" + G + "&info=" + p.encodeUrl(p.toJSON(I)),
                error: function () {
                    Mobi.ing(LS.memberProfileError)
                },
                success: function (K) {
                    var L = p.parseJSON(K);
                    if (L.success) {
                        F.headPicJson.path = o.attr("src");
                        Mobi.initMemberHeadPic(F.headPicJson);
                        p("#editMemberHeadPic").hide();
                        p("#profile").show();
        ...
        var v, B, z, C, z, A, w, y, x;
        p(".picArea").on({
            touchstart: function (G) {
                var I = G.touches.length;
                v = u[0].offsetTop;
                B = u[0].offsetLeft;
                q = u[0].width;
                if (I == 1) {
                    G.preventDefault();
                    var H = G.touches[0];
                    A = {x: H.pageX, y: H.pageY}
                } else {
                    C = a(G).dist;
                    z = q
                }
            }, touchmove: function (H) {
                var K = H.touches.length;
                d = Math.min(o.width(), o.height());
                if (K == 1) {
                    H.preventDefault();
                    var J = H.touches[0];
                    w = {x: J.pageX, y: J.pageY};
                    y = w.x - A.x;
                    x = w.y - A.y;
                    m = v + x;
                    e = B + y;
        ...
        p(".picArea").on({
            mousedown: function (H) {
                ...
                D = true;
                var G = H.target.id;
                if (G == "coverBox" || G == "coverImg") {
                    E(0)
                } else {
                    if (G == "dragBotCenter" || G == "dragRightCenter" || G == "dragRightBot") {
                        E(1)
                    } else {
                        if (G == "dragLeftCenter" || G == "dragLeftBot") {
                            E(2)
                        } else {
                            if (G == "dragTopCenter" || G == "dragRightTop") {
                                E(3)
                            } else {
                                if (G == "dragLeftTop") {
                                    E(4)
    ...
    function n() {
        p(".coverImg").css({width: q + "px", height: q + "px", top: h + "px", left: b + "px"});
        p(".picArea .coverRing").css({width: q - 2 + "px", height: q - 2 + "px", top: h + "px", left: b + "px"});
        p(".picArea .coverBox").css({width: q + "px", height: q + "px", top: h - 1 + "px", left: b - 1 + "px"});
        p(".picArea .cover1").css({width: "100%", height: m + "px", top: 0, left: 0});
        p(".picArea .cover2").css({width: b + "px", height: q + "px", top: h + "px", left: 0});
        p(".picArea .cover4").css({width: t - q - b + "px", height: q + "px", top: h + "px", left: q + b + "px"});
        p(".picArea .cover5").css({width: "100%", height: c - q - h + "px", top: q + h + "px", left: 0})
    }
    ...
    function s() {
        if (q < 100) {
            ...
            if (q > Math.min(o[0].height, o[0].width)) {
                q = Math.min(o[0].height, o[0].width)
            }
        }
        if (m < h) {
            m = h
        ...
        if (m >= h && m <= h + o[0].height - q && e >= b && e <= b + o[0].width - q) {
            u.css({width: q + "px", height: q + "px", top: m + "px", left: e + "px"});
            p(".picArea .coverRing").css({width: q - 2 + "px", height: q - 2 + "px", top: m + "px", left: e + "px"});
            p(".picArea .coverBox").css({width: q + "px", height: q + "px", top: m - 1 + "px", left: e - 1 + "px"});
            p(".picArea .cover1").css({width: "100%", height: m + "px", top: 0, left: 0});
            p(".picArea .cover2").css({width: e + "px", height: q + "px", top: m + "px", left: 0});
            p(".picArea .cover4").css({width: t - q - e + "px", height: q + "px", top: m + "px", left: q + e + "px"});
            p(".picArea .cover5").css({width: "100%", height: c - q - m + "px", top: q + m + "px", left: 0})
        }
    }

    function a(C) {
        var z = 0, B = 0, x = 0, A = 0, w = 0, y = 0, v = {};
        z = C.touches[0].pageX;
        x = C.touches[1].pageX;
        B = C.touches[0].pageY - document.body.scrollTop;
        A = C.touches[1].pageY - document.body.scrollTop;
        if (!z || !x) {
            return
        }
        if (z <= x) {
        ...
        v = {dist: Math.round(Math.sqrt(Math.pow(z - x, 2) + Math.pow(B - A, 2))), x: Math.round(w), y: Math.round(y)};
        return v
    }
...
Mobi.deviceTypeIsMobi = function () {
    ...
    var k = c.match(/iphone os/i) == "iphone os";
    ...
    var l = c.match(/windows mobile/i) == "windows mobile";
    if (h || k || f || d || e || a || b || l) {
        return true
    } else {
        return false
...
Mobi.reloadMemberImg = function (b, f) {
    var d = jm("#headPic"), e = jm(".picArea"), a = Number(e.height()), h = Number(e.width());
    if (b == "new") {
        var c = new Image();
        c.src = f.smallPath;
        c.onload = function () {
...
Mobi.initMemberUploadImg = function (c, d, l, m, h, k, o, b) {
    ...
    n.onload = function () {
        ...
        p.onload = function () {
            if (b == "true") {
                Mobi.mobiMemberUploadImgSWF("file_upload", c, d, 1, k)
            } else {
                Mobi.mobiMemberUploadImgHtml("file_upload", c, d, k)
            }
        }
    };
    var f = document.documentElement || document.body;
...
Mobi.mobiMemberUploadImgSWF = function (e, c, h, b, a) {
    ...
    var d = {
        ...
        requeue_on_error: false,
        post_params: {ctrl: "Filedata", app: 21, type: 0, fileUploadLimit: c},
        file_types: f.join(";"),
        file_dialog_complete_handler: function (k) {
            this._allSuccess = false;
            this.startUpload()
        },
        file_queue_error_handler: function (l, k, m) {
            switch (k) {
                case SWFUpload.QUEUE_ERROR.FILE_EXCEEDS_SIZE_LIMIT:
        ...
        upload_success_handler: function (l, k) {
            var m = jm.parseJSON(k);
            this._allSuccess = m.success;
            this._sysResult = m.msg;
            if (m.success) {
                setTimeout(function () {
        ...
        upload_error_handler: function (l, k, m) {
            if (k == -280) {
                Mobi.ing(LS.mobiFormSubmitFileUploadFileCancle, false)
            } else {
                if (k == -270) {
                    Mobi.ing(jm.format(LS.mobiFormSubmitFileUploadFileExist, jm.encodeHtml(l.name)), true)
                } else {
                    Mobi.ing(jm.format(LS.mobiFormSubmitFileUploadSvrBusy, jm.encodeHtml(l.name)))
                }
            }
        },
        upload_complete_handler: function (k) {
            if (k.filestatus == SWFUpload.FILE_STATUS.COMPLETE) {
                setTimeout(function () {
                    swfObj.startUpload()
                }, swfObj.upload_delay)
            } else {
                if (k.filestatus == SWFUpload.FILE_STATUS.ERROR) {
                    Mobi.ing(jm.format(LS.mobiFormSubmitFileUploadSvrBusy, jm.encodeHtml(k.name)))
                }
            }
        },
        upload_start_handler: function (k) {
            Mobi.ing(LS.mobiFormSubmitFileUploadPrepare, false)
        },
        view_progress: function (k, n, m, l) {
            var l = Math.ceil((n / m) * 100);
            if (isNaN(l)) {
                return
            }
            if (l == 100) {
...
Mobi.initMemberHeadPic = function (b) {
    var a = jm("#memberHeadPic"), c = jm(".icon-pnameIcon");
    if (typeof b.path != undefined) {
        a.attr("src", b.path)
    }
    if (b.width != 0) {
        var f = b.width / c.width(), e = -(b.top / f) + "px", d = -b.left / f + "px";
        a.css({width: b.imgW / f + "px", height: b.imgH / f + "px", marginTop: e, marginLeft: d})
    }
};
Mobi.memberProfileSubmit = function (l, a, h) {
    var c = {};
    if (a) {
        if (h) {
            var d = jm("#oldPsw").val();
        ...
        var m = jm("#profileValue").attr("maxlength");
        var f = jm("#profileValue").attr("name");
        var b = jm("#profileValue").val();
        c[f] = b;
        if (b.length > m) {
            Mobi.ing(jm.format(LS.memberProfileUserEditItemMaxLength, f, m));
    ...
    jm.ajax({
        type: "post",
        url: "ajax/member_h.jsp?cmd=set",
        data: "id=" + l + "&info=" + jm.encodeUrl(jm.toJSON(c)),
        error: function () {
            Mobi.ing(LS.memberProfileError)
        },
        success: function (n) {
            var o = jm.parseJSON(n);
            if (o.success) {
...
Mobi.getMProtocol = function (a, b) {
    ...
    jm.ajax({
        type: "post", url: "ajax/member_h.jsp?cmd=getProContent", error: function () {
            Mobi.ing(LS.memberProfileError)
        }, success: function (c) {
...
Mobi.memberNewFdPwdStepTwo = function () {
    ...
    jm.ajax({
        type: "post", url: "ajax/member_h.jsp?cmd=checkMobileCodeGeneral", data: b, error: function () {
            Mobi.ing(LS.systemError)
        }, success: function (f) {
...
Mobi.memberNewFdPwdLastStep = function (b) {
    ...
    jm.ajax({
        type: "post", url: "ajax/member_h.jsp?cmd=setMemberPwdGeneral", data: c, error: function () {
            Mobi.ing(LS.systemError)
        }, success: function (e) {
...
Mobi.memberFdPwd = function (a, d) {
    ...
    function b(l, k, f) {
        var h = Fai.top.jm, e;
        if (h.type(k) !== "array" || h.type(l) !== "string") {
            return ""
        }
        e = k.length;
        while (e) {
            e--;
            if (h.type(k[e]) === "string") {
                k[e] = [f, k[e], f].join("")
            }
        }
        return l + "(" + k.join(",") + ")"
...
Mobi.memberFdPwdByMobileStepThree = function (b, a, f) {
    ...
    jm.ajax({
        type: "post", url: "ajax/member_h.jsp?cmd=checkFindPwdByMobileCode", data: e, error: function () {
            Mobi.ing(LS.systemError, false)
        }, success: function (h) {
...
Mobi.memberFdPwdStepThree = function (d, c, f) {
    ...
    jm.ajax({
        type: "post", url: "ajax/mail_h.jsp?cmd=checkPwdEmailCode", data: e, error: function () {
            Mobi.ing(LS.systemError, false)
        }, success: function (h) {
            var h = jm.parseJSON(h);
            if (h.success) {
...
Mobi.memberFdPwdStepLast = function (b, e) {
    ...
    jm.ajax({
        type: "post", url: "ajax/mail_h.jsp?cmd=setMemberPwd", data: c, error: function () {
            Mobi.ing(LS.systemError, false)
        }, success: function (f) {
            var f = jm.parseJSON(f);
            if (f.success) {
...
Mobi.initModulePhotoList = function (v, e, c) {
    ...
    module = "module" + v;
    var l = document.getElementById(module), d = document.getElementById("webFooterBox"),
        w = document.createElement("div"), p = document.createElement("div"), h = document.createElement("div"),
    ...
    for (var s = 0; s < c.length; s++) {
        ...
        m.className = "imageSpan";
        k.setAttribute("vwidth", c[s].width);
        k.setAttribute("vheight", c[s].height);
        a.appendChild(m);
        a.appendChild(k);
        p.appendChild(a)
    }
    ...
    jm(p).bind("click", function (A) {
        ...
        var y = this.querySelector(".prevPhoto"), x = this.querySelector(".nextPhoto");
    ...
    jm(h).bind("click", function (A) {
        ...
        if (this.className.indexOf("descriptionOpen") === -1) {
            var z = f.offsetHeight, x = Mobi.getPreviewWindow().innerHeight;
            if (jm.os.android) {
                x = Mobi.getPreviewWindow().screen.height / Mobi.getPreviewWindow().devicePixelRatio - Mobi.getPreviewWindow().screenTop
            }
            if (x > z) {
                if (f.innerHTML) {
                ...
                this.style.bottom = x * 0.8 - z + "px";
                p.className = "webPhotoListDetail photoFilter"
            }
            this.className = "photoDetailDescription descriptionOpen";
            if (f.innerHTML) {
                y.className = "handleIcon handleDown"
            }
        } else {
            if (f.innerHTML) {
            ...
            p.className = "webPhotoListDetail";
            if (f.innerHTML) {
                y.className = "handleIcon handleUp"
            }
        }
    });
...
Mobi.initPhotoSwipe = function (a, d, h, e, c) {
    var l = Mobi.getPreviewObject("imgName" + a);
    jm(l).html(d[0]);
    ...
    k("#photoSwipe" + a).swipehandle(f, {
        ...
        callback: function (n) {
            ...
            if (!b[n]) {
                b[n - b.length].className = "on";
                jm(l).html(d[n - b.length])
            } else {
                b[n].className = "on";
                jm(l).html(d[n])
            }
    ...
    k("#photoSwipe" + a).find(".imageDiv").show();
...
Mobi.initScaleImage = function (c) {
    if (c) {
        var h = c.querySelectorAll("img"), e = c.clientWidth, f = 0;
        if (h) {
            for (var k = 0; k < h.length; k++) {
                var a = parseInt(h[k].getAttribute("vwidth") ? h[k].getAttribute("vwidth") : 1),
                    l = parseInt(h[k].getAttribute("vheight") ? h[k].getAttribute("vheight") : 1), d = l / a;
                if (d === NaN) {
                    continue
                }
                h[k].style.width = e + "px";
                h[k].style.height = "100%";
                if (d > f) {
                    f = d
                }
            }
    ...
    if (c) {
        ...
        if (h) {
            for (var k = 0; k < h.length; k++) {
                ...
                h[k].style.width = e + "px";
                h[k].style.height = Math.floor(e * d) + "px";
                if (d > f) {
                    f = d
                }
            }
...
Mobi.initDefScaleImage = function (c) {
    if (c) {
        var l = c.querySelectorAll("img"), h = c.clientWidth, k = 0;
        var a = c.querySelectorAll(".photoImageItem");
        var m = c.querySelectorAll(".imageMiddleSpan");
        if (l) {
            for (var n = 0; n < l.length; n++) {
                var b = parseInt(l[n].getAttribute("vwidth") ? l[n].getAttribute("vwidth") : 1),
                    o = parseInt(l[n].getAttribute("vheight") ? l[n].getAttribute("vheight") : 1), e = o / b;
                if (e === NaN) {
                    continue
                }
                var f = b / o, d = h / 417;
                if (d <= f) {
                    ...
                    jm(m[n]).css("display", "none")
                } else {
                    jm(l[n]).css({height: h / f + "px", width: h + "px", marginTop: ((417 - h / f) / 2) + "px"});
                    jm(m[n]).css("display", "none")
                }
            }
            if (h * k != 0) {
                c.style.height = Math.floor(h * k) + "px"
            }
        }
    }
};
Mobi.initPhotoImageSwipe = function (a, e) {
    ...
    b("#" + a).swipehandle(d, {
        isOpenNextAndPrevious: true, callback: function (l, f) {
            var k = f.querySelector("img"), h = k.getAttribute("lazysrc");
            if (!!h && !k.src) {
                k.src = h;
                k.onload = function () {
                }
...
Mobi.initModulePhotoSwipe = function (f, c) {
    ...
    var e = {
        imageScaleMethod: "fitNoUpscale", getImageCaption: function (h, k) {
            var m, l;
            m = h + "/" + k;
    ...
    }, d = window.Code.PhotoSwipe, a = d.attach(b, e)
};
...
Mobi.deletePhotoGroupManage = function (f, c, a, b) {
    ...
    e.push("确定删除图册“" + c + "”?");
    e.push("</div>");
    var d = top.Fai.popupBodyWindow({title: "删除图册", content: e.join(""), width: 370, height: 130});
    top.Fai.addPopupBodyWindowCheckBox(d, {
        id: "checkbox", text: "同时删除图册图片", init: "checked", click: function () {
        }
    });
    top.Fai.addPopupBodyWindowBtn(d, {
        id: "save", text: "确 定", extClass: "saveButton", click: function () {
            ...
            $.ajax({
                ...
                success: function (k) {
                    top.Fai.successHandle(k, "删除成功", "", a, b, 1);
    ...
    top.Fai.addPopupBodyWindowBtn(d, {id: "cancel", text: "取 消", click: "close"})
};
Mobi.initModulePhotoDetailSwipe = function (x, v, l, t) {
    ...
    var e = {
        ...
        uiDetailCallBack: function (z, D, y) {
            var A = this;
            jm(z).html("");
            var F = v[w.currentIndex], C = F.groupId, E = F.id, B = F.name;
            jm(y).html(B);
            jm(D).addClass(f.Carousel.CssClasses.itemLoading);
            jm.ajax({
                type: "post",
                url: "ajax/photo_h.jsp",
                data: "cmd=getInfo&id=" + jm.encodeUrl(E) + "&groupId=" + jm.encodeUrl(C),
                error: function () {
                    Mobi.ing(LS.systemError)
                },
                success: function (G) {
                    jm(z).html(G);
                    var J = z.querySelectorAll("img");
                    if (J.length === 0) {
                        A.detailScroll && A.detailScroll.destroy();
                        A.detailScroll = null;
                        A.destroyScroll = new iScroll(D);
                        jm(D).removeClass(f.Carousel.CssClasses.itemLoading)
                    } else {
    ...
    }, b = null, q = null, d = null, a = null, f = window.Code.PhotoSwipe, w = f.attach(k, e);
    w && w.addEventHandler(f.EventTypes.onCaptionAndToolbarShow, function (y) {
        if (this.scroll) {
            this.scroll.destroy()
        }
    ...
    if (l || t) {
        w.addEventHandler(f.EventTypes.onDisplayImage, function (B) {
            var y = B.target.currentIndex;
            if (y > 1) {
                var z = v[y + 1], A = B.target.cache.images[B.target.currentIndex + 1], C;
                if (A) {
                    C = A.imageEl;
                    C.src = z.picPath;
                    p(true, C)
    ...
    if (navigator.userAgent.indexOf("baidubrowser")) {
        jm("body").off("touchstart.photoSwipe").on("touchstart.photoSwipe", function (y) {
        })
    }
    ...
    function p(z, y) {
        ...
        Mobi.recoverPhotoSwipeImgSize(y)
    }
};
Mobi.recoverPhotoSwipeImgSize = function (b) {
    var d = jm(b), a = false, e = b.complete;
    ...
    function c(h) {
        var l = document.body.clientWidth, f = document.body.clientHeight, k = h.width(), m = h.height();
        h.css({height: m + "px", width: k + "px", left: (l - k) / 2 + "px", top: (f - m) / 2 + "px"})
    }
};
...
Mobi.PhotoDetailSwipeForJumpCtrl = function (a) {
    var b = [];
    jm.ajax({
        type: "get", url: "ajax/getPhotoData_h.jsp?groupId=" + a + "&cmd=getPhotoData", success: function (q) {
            ...
            var p = {
                ...
                uiDetailCallBack: function (s, w, r) {
                    var t = this;
                    jm(s).html("");
                    var y = b[o.currentIndex], v = y.groupId, x = y.id, u = y.name;
                    jm(r).html(u);
                    jm(w).addClass(c.Carousel.CssClasses.itemLoading);
                    jm.ajax({
                        type: "post",
                        url: "ajax/photo_h.jsp",
                        data: "cmd=getInfo&id=" + jm.encodeUrl(x) + "&groupId=" + jm.encodeUrl(v),
                        error: function () {
                            Mobi.ing(LS.systemError)
                        },
                        success: function (z) {
                            ...
                            if (C.length === 0) {
                                t.detailScroll && t.detailScroll.destroy();
                                t.detailScroll = null;
            ...
            }, n = null, f = null, k = null, h = null, c = window.Code.PhotoSwipe, o = c.attach(m, p);
            ...
            jm(m[0]).trigger("click");
            o.addEventHandler(c.EventTypes.onDisplayImage, function (v) {
                var r = v.target.currentIndex, u, t, s;
                if (r > 1) {
                    t = b[r + 1];
                    u = v.target.cache.images[v.target.currentIndex + 1];
                    if (u) {
                        s = u.imageEl;
                        s.src = t.picPath;
                        Mobi.recoverPhotoSwipeImgSize(s)
                    }
                }
            })
        }
...
Mobi.photoCrossedSlideSecSwipe = function (a, e, b) {
    var c = Mobi.getPreviewObject(e), h = Mobi.getPreviewObject(b), f = c, l = parseInt(jm(h).width()), n = 0,
        k = jm(".photoCrossedSlideSec", h);

    function d(p) {
        var o = 0;
        o += parseFloat(p.width());
        o += (parseFloat(p.css("padding-left")) + parseFloat(p.css("padding-right")));
        o += (parseFloat(p.css("border-left-width")) + parseFloat(p.css("border-right-width")));
        o += (parseFloat(p.css("margin-left")) + parseFloat(p.css("margin-right")));
        return o
    }
...
Mobi.initModuleMultiPhotoListItemManage = function (a) {
    ...
    c.data("options", a);
    var b = a.content;
    $.each(b.picList, function (f, k) {
        var m = k.id, h = k.desc, e = k.ide, d = k.openLink;
        var l = $("#module" + a.moduleId).find(".style2Img.photoListImg.stretchImg").parent();
        l.mouseover(function () {
            ...
            if (a.type === 1) {
                layer = Mobi.addEditLayer($(this), n, 106)
            } else {
                layer = Mobi.addEditLayer($(this), n, 6)
            }
        }).mouseleave(function () {
            if (a.type === 1) {
...
Mobi.initModuleMultiPhotoCarouselItemManage = function (a) {
    ...
    var c = $("#module" + a.moduleId);
    c.data("options", a);
    var b = a.content, d = b.picList;
    $.each(d, function (h, m) {
        var n = m.id, k = m.desc, f = m.ide, e = m.openLink;
        var l = $("#module" + a.moduleId).find("img[id=" + n + "]");
        l.each(function (o, p) {
            $(p).mouseover(function () {
                var q = [{
                    operationText: "编辑图片",
                    className: "edit",
                    evalScript: "top.Mobi.popupWindow({title:'编辑图片', frameSrcUrl:'mobiPhotoEdit.jsp?moduleId=" + a.moduleId + "&id=" + n + "&linkType=" + a.linkType + "', width:580, height:420, closeFunc: closeMobiPhotoEdit, saveBeforePopup: true});"
                }, {
                    operationText: "删除图片",
                    className: "close",
                    evalScript: "Mobi.deleteMultiPhotoItem('" + n + "', " + a.moduleId + ");"
                }];
                Mobi.addEditLayer($(p), q, 1)
            }).mouseleave(function () {
                Mobi.removeEditLayer($(p), null, 1)
            })
        })
    })
};

function closeMobiPhotoEdit(l) {
    if (l != null && l != undefined) {
        var d = jm.parseJSON(l);
        var h = d.photoList, a = d.moduleId, f = $("#module" + a), k = f.data("options"), e = k.content;
        if (!!h) {
            e.picList = h;
            var c = new Array();
            var b = "ajax/mobimodule_h.jsp?cmd=setBack&id=" + k.moduleId + "&colId=" + Fai.top._colId + "&style=" + k.style + "&extId=" + Fai.top._extId;
            c.push("&content=" + jm.encodeUrl(jm.toJSON(e)));
            Mobi.ing("正在保存...", false);
            jm.ajax({
                type: "post", url: b, data: c.join(""), error: function () {
...
Mobi.deleteMultiPhotoItem = function (f, b) {
    ...
    if (confirm("确定删除图片？")) {
        if (typeof a != "undefined") {
            ...
            $.ajax({
                type: "post", url: c, data: e.join(""), error: function () {
                    Mobi.ing("服务繁忙，请稍后重试。", true)
                }, success: function (h) {
                    var k = jm.parseJSON(h);
                    if (k.success) {
...
Mobi.photoGroupContentInit = function (c) {
    var f = jm("#photoGroupDetailPanel" + c), b = f.find(".photoGroupDetail").width(), a = f.find(".photoGroupPic"),
...
Mobi.initPhotoGroupSwipe = function (b) {
    ...
    var c = Mobi.getPreviewObject(b), e = jm(c);
    if (!c) {
        return
    }
    ...
    var a = c.querySelector(".bullets").getElementsByTagName("li"), k, e, h, d;
    h = parseInt(e.find(".J_maxNum").text());
    k = f("#" + b).swipehandle(c, {
        continuous: true, bulletsClick: true, callback: function (n) {
            var m = a.length, l;
            while (m--) {
                a[m].className = " "
            }
            if (!a[n]) {
                a[n - a.length].className = "on"
            } else {
                a[n].className = "on"
            }
            l = (n + 1) % h;
            ...
            e.find(".J_curPhotoNumber").text(l)
        }
    });
...
Mobi.getPhotoListInfo = function (c) {
    ...
    if (d.data("options")) {
        ...
        for (index in e) {
            a = {id: e[index].id, desc: e[index].desc, openLink: e[index].openLink, ide: e[index].ide};
            b.push(a)
        }
    }
    return b
};
Mobi.photoCardInit = function (u) {
    var b = jm("#module" + u), a = b.find(".J_photoListCard"), c = a.find(".J_cardContainer"), k = a.find("li"),
        q = k.length, o = 0, h = 0, s, m, t, x, n, e, v, d, l, w;
    if (q > 1 && q <= 3) {
        c.append(k.clone(true, true));
        k = a.find("li");
        q = k.length;
        for (var r = q / 2; r < q; r++) {
            jm(a.find("img").get(r)).addClass("garbage")
        }
    }
    e = jm(k.get(0)).find(".J_imgContainer");
    d = e.width();
    l = e.height();
    k.each(function (y, z) {
        h = jm(z).height();
    ...
    k.each(function (y, z) {
        t = jm(z);
        x = t.find("img");
        n = parseInt(x.attr("faiWidth"));
        v = parseInt(x.attr("faiHeight"));
        w = f(n, v, d, l);
        x.css({
            height: w.height + "px",
            width: w.width + "px",
            marginTop: -(parseFloat(w.height / 2)) + "px",
            marginLeft: -(parseFloat(w.width / 2)) + "px",
            position: "absolute"
        });
        t.height(o + "px");
        if (q <= 1) {
        ...
        t.on("webkitAnimationStart mozAnimationStart MSAnimationStart oanimationstart animationstart", function (A) {
            b.data("animated", "running")
        }).on("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", function (A) {
        ...
        switch (y) {
            case 0:
                jm(z).addClass("f-showPic_1");
                break;
            case 1:
                jm(z).removeClass("f-showPic_1 f-showPic_2 f-showPic_3").addClass("f-showPic_2");
                break;
            case 2:
                jm(z).removeClass("f-showPic_1 f-showPic_2 f-showPic_3").addClass("f-showPic_3");
                break;
            default:
                jm(z).removeClass("f-showPic_1 f-showPic_2 f-showPic_3").addClass("f-showPic_0")
        }
    });
    Mobi.bindTouchEvent(k, null, {callBack: p, args: [k, b], stopPropagation: true});
    ...
    function p(C, B, H) {
        ...
        var A = jm(this), F = C.length, y = 3, G = [], E, z, D;
        if (!H.touchMove) {
            A.find("img").trigger("click");
            return
        }
        if (!(H.toRight || H.toLeft || B.data("animated") == "running")) {
            return
        }
        z = A.find("a").attr("href");
        if (!!z) {
            A.find("a").data("href", z).attr("href", "javascript:void(0);")
        }
        D = H.toRight ? "f-cardAnimation_right" : "f-cardAnimation_left";
        A.addClass(D);
        C.each(function (I, J) {
            jm(J).removeClass("f-showPic_0 f-showPic_1 f-showPic_2 f-showPic_3")
        });
        G[0] = A.index();
        for (E = 1; E <= y; E++) {
            G[E] = E <= F ? ((G[0] + E) % F) : -1
        ...
        C.each(function (I, J) {
            switch (I) {
                case G[1]:
                    jm(J).addClass("f-showPic_1");
                    break;
                case G[2]:
                    jm(J).addClass("f-showPic_2");
                    break;
                case G[3]:
                    jm(J).addClass("f-showPic_3");
                    break;
                case G[0]:
                    break;
                default:
                    jm(J).addClass("f-showPic_0")
            }
        })
    }

    function f(y, F, D, E) {
        var G = {width: y, height: F}, z = D / E, A = y / F;
        if (A < z) {
            var C = y / D;
            G.width = D;
            G.height = F / C
...
(function (e, k, f) {
    e.photoGroup = k.extend({}, e.photoGroup, {bindInteractive: c, unBindInteractive: h});
    k(r);

    function r() {
        k(".formStyle34").each(function (s, t) {
            var u = k(t);
            c(u)
        })
    }
    ...
    function h(t) {
        ...
        u = t.find(".J_photoGroupAll");
        if (u.hasClass("J_photoGroupAll4")) {
            s = 4
        }
        if (u.hasClass("J_photoGroupAll5")) {
            s = 5
        }
        d(s).destory(t);
        m(t)
    ...
    function o(u, t) {
        ...
        var s = u.find(".J_photoGroupAll");
        s.off("mousedown.photoGroup").off("mouseup.photoGroup");
        if (t === false) {
            return
        }
        s.on("mousedown.photoGroup", function () {
            $("#webModuleContainer").sortable("disable")
        }).on("mouseup.photoGroup", function (v) {
            $("#webModuleContainer").sortable("enable")
        })
    }

    function l(x, u) {
        var t = x.find(".J_photoGroupAll"), s, y;
        if (!t.hasClass("J_photoGroupAll4") && !t.hasClass("J_photoGroupAll5")) {
            return
        }
        s = t.find(".J_photoGroup-img-mask");
        s.off("mousedown.photoGroupScan mouseup.photoGroupScan");
        s.remove();
        if (u === false) {
            return
        }
        ...
        y = {startX: 0, startY: 0, endX: 0, endY: 0, time: 0};
        t.find(".f-photoGroup-a").each(function (B, A) {
            var D = k(A), C = D.find(".f-photoGroup-img"), z = (C.height() / window._htmlFontSize + "rem"), E;
            if (D.find(".J_photoGroup-img-mask").length === 0) {
                E = k("<div class='f-photoGroup-img-mask J_photoGroup-img-mask'></div>");
                E.height(z);
                D.append(E)
            }
        });
        t.find(".J_photoGroup-img-mask").off("mousedown.photoGroupScan mouseup.photoGroupScan").on("mousedown.photoGroupScan", v).on("mouseup.photoGroupScan", w);
        ...
        function w(z) {
            var B = k(z.target), A = new Date() - y.time;
            y.endX = z.pageX;
            y.endY = z.pageY;
            if (A > 200) {
                return
            }
            if (y.startX !== y.endX || y.startY !== y.endY) {
                return
            }
            B.parent().find(".f-photoGroup-img").click()
        }
    }

    function b(u, t) {
        var x = a(), w;
        u.off(x.downLink).off(x.clickLink);
        if (t === false) {
            return
        }
        w = {startX: 0, startY: 0, endX: 0, endY: 0, time: null};
        u.on(x.downLink, ".J_photoGroup-a", v).on(x.clickLink, ".J_photoGroup-a", s);

        function v(y) {
            var z = e.photoGroup.utils.getPosByEvent(y);
            w.startX = parseInt(z.pageX);
            w.startY = parseInt(z.pageY);
            w.time = new Date()
        }

        function s(y) {
            var B = e.photoGroup.utils.getPosByEvent(y), z = new Date(), A = false;
            w.endX = parseInt(B.pageX);
            w.endY = parseInt(B.pageY);
            if (w.startX !== w.endX) {
                A = true
            }
            if (w.startY !== w.endY) {
    ...
    function q(u, s) {
        ...
        if (k.isFunction(t.bindWithEditLayer)) {
            t.bindWithEditLayer(u, s)
        }
    }

    function d(s) {
        var u = {4: e.photoGroup.zoomSlider, 5: e.photoGroup.pokerSlider}, t = function () {
        };
        if (!s) {
            return {create: t, destory: t}
        }
        return u[s]
    }
    ...
    function a() {
        var s, t;
        s = {downLink: "touchstart.ctrlLink", clickLink: "click.ctrlLink"};
        t = {downLink: "mousedown.ctrlLink", clickLink: "click.ctrlLink"};
        return (Mobi.isPC() ? t : s)
    }
}(Mobi, jm));
(function (a, d, b) {
    var m = {getImgByCard: k, getSliderDir: c, getPosByEvent: l, getStyleType: f, isInDom: h};
    a.photoGroup = d.extend({}, a.photoGroup, {utils: m});
    ...
    function e(n) {
        ...
        return (n.touches[0] || n.changedTouches[0])
    }

    function l(p) {
        var o = p.pageX || e(p).pageX, n = p.pageY || e(p).pageY;
        return {pageX: o, pageY: n}
    }

    function k(n) {
        var p = d(n), o = d(n).find(".J_photoGroup-img-mask");
        if (o.length > 0) {
            return o
        }
        return p.find(".J_photoGroup-img")
    }

    function f(p) {
        var o = p.find(".J_photoGroupAll"), n;
        if (o.hasClass("J_photoGroupAll1")) {
            n = 1
        } else {
            if (o.hasClass("J_photoGroupAll2")) {
                n = 2
            } else {
                if (o.hasClass("J_photoGroupAll3")) {
                    n = 3
                } else {
                    if (o.hasClass("J_photoGroupAll4")) {
                        n = 4
                    } else {
                        if (o.hasClass("J_photoGroupAll5")) {
                            n = 5
                        }
                    }
                }
    ...
    function h(r, n, s) {
        var q = d(r)[0].getBoundingClientRect(), p = false, o = false;
        if (n >= q.left && n <= q.right) {
            p = true
        }
...
(function (d, k, n, h) {
    var q = n(k), e = {moveX: 0, moveY: 0,};
    k(window).load(r);
    d.photoGroup = k.extend({}, d.photoGroup, {bindWithEditLayer: b});

    function r(t) {
        if (!Fai.top._manageMode) {
            return
        }
        k(".formStyle34").forEach(function (v, u) {
            b(k(v))
        })
    }

    function b(x, u) {
        var y = o(), w = x.find(".J_photoGroupAll5"), t = d.photoGroup.utils, v = t.getStyleType(x);
        x.off(y.moduleMouseLeave).off(y.moduleMouseEnter);
        if (u === false) {
            return
        }
        x.on(y.moduleMouseEnter, function (z) {
            c(x)
        }).on(y.moduleMouseLeave, function (z) {
            c(x, false)
        });
        if ([4, 5].indexOf(v) > -1) {
            s(x, u)
    ...
    function c(x, t) {
        var w = x.find(".J_photoGroupAll-wrap"), v = x.find(".J_photoGroupStyle"), y = o(), u = d.photoGroup.utils;
        v.off(y.imgMouseLeave).off(y.imgMouseEnter);
        if (t === false) {
            return
        }
        v.on(y.imgMouseEnter, function (E) {
            var B = k(this), A = d.photoGroup.utils, C = A.getImgByCard(B), D = A.getStyleType(x),
                z = B.data("fk-is-enter");
            if (D === 4 && !B.hasClass("f-active")) {
                return
            }
            if (D === 5 && B.index() !== 0) {
                return
            ...
            q.add(C, x);
            B.data("fk-is-enter", "true")
        }).on(y.imgMouseLeave, function (A) {
            var z = k(this);
            $img = d.photoGroup.utils.getImgByCard(z), flag = z.data("fk-is-enter");
            if (flag !== "true") {
                return
            }
            q.remove($img, x);
            z.data("fk-is-enter", "false")
        })
    }

    function s(v, t) {
        var u = v.find(".J_photoGroupAll-wrap"), w = o();
        v.off(w.transBefore).off(w.transAfter);
        if (t === false) {
            return
        }
        v.on(w.transBefore, function (x) {
            l(v)
        }).on(w.transAfter, function (x) {
            f(v)
        })
    }

    function l(w) {
        var t = a(w), v = t.active, u = t.all;
        p(w, e);
        u.each(function (y, x) {
            var z = d.photoGroup.utils.getImgByCard(x);
            q.remove(z, w)
        });
        q.ctrl(w, false)
    }
    ...
    function f(w) {
        var t = d.photoGroup.utils, v = a(w).active, u = t.getImgByCard(v);
        p(w, e, false);
        if (!t.isInDom(v, e.moveX, e.moveY)) {
            return
        }
        q.ctrl(w);
        q.add(u, w)
    ...
    function a(x) {
        var u = d.photoGroup.utils, v = u.getStyleType(x), w = x.find(".J_photoGroupStyle"), t;
        if (v === 4) {
            t = x.find(".f-active")
        }
        if (v === 5) {
        ...
        return {all: w, active: t}
    }

    function p(v, w, t) {
        var u = v.find(".J_photoGroupAll-wrap"), x = o();
        u.off(x.wrapMousemove);
        if (t === false) {
            return
        }
        u.on(x.wrapMousemove, function (y) {
            w.moveX = y.clientX;
            w.moveY = y.clientY
        })
    }
    ...
    function m(u) {
        var t = u.find(".J_photoGroup-img-mask");
        if (t.length > 0) {
            return t
        }
        return u.find(".J_photoGroup-img")
    }
    ...
    var k = {}, h = {add: m, remove: d, ctrl: a};
    return h;

    function m(o, t) {
        var q = b(o), p = q.attr("id"), r, s;
        if (!Fai.top._manageMode) {
            return
        }
        ...
        s = l(q);
        r = Mobi.addEditLayer(p, s, 6, {extCls: "editLayer_2"});
        f(r, q)
    }
    ...
    function d(o, r) {
        ...
        var q = b(o), p = q.attr("id");
        if (p) {
            Mobi.removeEditLayer(p)
        }
    }

    function a(q, p) {
        var r = q.attr("id"), o = k[r];
        if (p === false) {
            k[r] = false;
            return
        }
    ...
    function f(p, o) {
        var q = o.offset(), r = p[0].getBoundingClientRect();
        p.css({left: q.right - r.width, top: q.bottom - r.height})
    }
    ...
    function l(s) {
        var o = c(s).parent().find(".J_photoGroup-img"), r = o.attr("_groupid"), x = $("#photoGroup" + r),
            w = x.find(".J_photoGroup-title"), y = w.text(), q = "", v, t, u, p;
        v = "Fai.top.Mobi.popupWindow({title:'编辑图册', frameSrcUrl:'" + n(r) + "', width:860, height:682, version:2});";
        t = {operationText: "编辑图册", className: "edit_2", evalScript: v};
        u = "Mobi.deletePhotoGroupManage('" + r + "', '" + Fai.top.Fai.encodeHtmlJs(y) + "', '', 0)";
        p = {operationText: "删除图册", className: "close_2", evalScript: u};
        return [t, p]
    }

    function n(q) {
        var o = Fai.top.location, p = o.origin, t = o.pathname, s = t.split("/"), r;
        s.pop();
        s.pop();
        s.push("manage_v2");
        s.push("photoGroupEdit.jsp");
        r = Fai.top._siteDomain + s.join("/") + "?fromManage=true&mobiSettingState=3&id=" + q;
        return r
    }

    function b(o) {
        var p = c(o);
        if (!p.hasClass("J_photoGroup-img")) {
            p = p.parent().find(".J_photoGroup-img")
        }
        return p
    }
});
(function (b, e, c) {
    var h = {create: f, destory: a}, m = {small: "f-small", active: "f-active"}, p = b.photoGroup.utils;
    b.photoGroup = e.extend({}, b.photoGroup, {zoomSlider: h});
    ...
    function a(s) {
        var r = s.find(".J_photoGroupAll-wrap"), t = k();
        r.off(t.dragStart).off(t.selectStart).off(t.dragOriginStart)
    }

    function q(v) {
        var u = v.find(".J_photoGroupAll-wrap"), r = v.find(".J_photoGroupStyle"), s = 0, t = r.eq(0);
        r.addClass(m.small);
        if (t.length > 0) {
            t.addClass(m.active)
        }
        r.each(function (y, x) {
            var w = e(x);
            s += parseFloat(w.width());
            s += parseFloat(w.css("margin-left"));
            s += parseFloat(w.css("margin-right"))
        });
        u.width(s + "px")
    }

    function o(t) {
        var s = e("#g_web"), r = s.offset(), w = t.offset(), v = r.left + r.width / 2, u = w.left + w.width / 2,
            x = u - v;
        return x
    }

    function n(w) {
        var u = w.find(".J_photoGroupAll-wrap"), y = k(), x = l();
        u.off(y.dragStart).off(y.selectStart).off(y.dragOriginStart).on(y.dragStart, s).on(y.selectStart, v).on(y.dragOriginStart, v);
        ...
        function s(z) {
            var B = p.getPosByEvent(z), A = k();
            x.isStart = true;
            x.startX = B.pageX;
            x.startY = B.pageY;
            u.off(A.dragMove).on(A.dragMove, t).off(A.dragEnd).on(A.dragEnd, r)
        }

        function t(A) {
            var z = p.getSliderDir(x.startX, x.startY, x.moveX, x.moveY), B;
            if (!x.isStart) {
                return
            }
            B = p.getPosByEvent(A);
        ...
        function r(B) {
            var D = p.getPosByEvent(B), A = D.pageX - x.startX, C = k(), z = (x.isStart && x.isMove && !x.isTrans);
            Mobi.openDocScroll();
            u.off(C.dragMove).off(C.dragEnd);
            if (z && x.isXMove) {
                if (A < 0) {
                    x.currIndex++
                } else {
            ...
            x.isXMove = x.isStart = x.isMove = void 0
        }
    }

    function d(r, v, B, s) {
        var y = r.find(".J_photoGroupStyle"), A, u = k(), x = true, t = ["-ms-", "", "moz", "-webkit-"], z, w;
        if (v.currIndex < 0) {
            v.currIndex = 0;
            x = false
        } else {
            if (v.currIndex >= y.length) {
                v.currIndex = y.length - 1;
                x = false
            }
        }
        z = y.eq(v.oldIndex).find(".J_photoGroup-img");
        if (v.oldIndex === v.currIndex) {
            return
        }
        w = y.eq(v.currIndex);
        A = y.eq(v.oldIndex);
        ...
        w.addClass(m.active);
        v.isTrans = true;
        w.off(u.transEnd).on(u.transEnd, function (D) {
            var C = e(D.target).find(".J_photoGroup-img-mask");
            v.isTrans = false;
            w.off(u.transEnd);
            v.oldIndex = v.currIndex;
            B.trigger("transitionAfter", [D])
        });
        v.disLeft -= o(w);
        B.trigger("transitionBefore", [s]);
        e(t).each(function (D, F) {
            var C = F + "transform", E = "translate(" + (v.disLeft) + "px,0)";
            r.css(C, E)
        })
    }
...
(function (b, e, d) {
    var h = {create: f, destory: a}, n = b.photoGroup.utils;
    b.photoGroup = e.extend({}, b.photoGroup, {pokerSlider: h});
    ...
    function a(q) {
        var p = q.find(".J_photoGroupAll"), r = k();
        p.off(r.dragStart).off(r.selectStart).off(r.dragOrginStart)
    }

    function o(s) {
        var r = s.find(".J_photoGroupAll-wrap"), q = r.find(".J_photoGroupStyle").find(".J_photoGroup-a"),
            p = q.height() + "px";
        if (q.find(".J_photoGroup-detail").length === 0) {
            r.css({height: p, transform: "translateY(0.725rem)"})
        }
    }

    function m(u) {
        var r = u.find(".J_photoGroupAll"), w = k(), v = c();
        if (r.find(".J_photoGroupStyle").length <= 1) {
            return
        }
        r.off(w.dragStart).off(w.selectStart).off(w.dragOrginStart).on(w.dragStart, q).on(w.dragOrginStart, ".J_photoGroup-a", t).on(w.selectStart, t);
        ...
        function q(x) {
            var y = n.getPosByEvent(x);
            v.startX = y.pageX;
            v.startY = y.pageY;
            v.isStart = true;
            r.off(w.dragMove).off(w.dragEnd).on(w.dragMove, ".J_photoGroupStyle", s).on(w.dragEnd, ".J_photoGroupStyle", p)
        }

        function s(y) {
            var z = n.getPosByEvent(y), x;
            if (!v.isStart) {
                return
            }
            if (!v.isMove) {
                v.isMove = true;
                x = n.getSliderDir(v.startX, v.startY, v.endX, v.endY);
                if (x === void 0) {
                    return
                }
                if (x === true) {
        ...
        function p(A) {
            var B = n.getPosByEvent(A), x = v.isStart, y = v.isMove, z = v.isXMove;
            Mobi.openDocScroll();
            v.endX = B.pageX;
            v.endY = B.pageY;
            r.off(w.dragMove).off(w.dragEnd);
            if (x && y && v.isXMove) {
                l(r, u, v)
            }
            v.isStart = v.isMove = v.isXMove = void 0
        }
    }

    function l(u, y, r) {
        var A = u.find(".J_photoGroupStyle"), v = A.eq(0), z = A.eq(1), w = A.eq(2), x = A.eq(3), t = k(),
            B = (r.endX - r.startX), p = false, q;
        if (r.isAnimate) {
            return
        }
        if (B === 0) {
        ...
        q = {dir: (p ? "f-toLeft" : "f-toRight"), toOne: "f-toOne", toTwo: "f-toTwo", toThree: "f-toThree"};
        if (v.length > 0) {
            r.isAnimate = true;
            v.on(t.transEnd, s);
            y.trigger("transitionBefore");
            v.addClass(q.dir)
        }
        if (z.length > 0) {
            z.addClass(q.toOne)
        ...
        if (x.length > 0) {
            x.addClass(q.toThree)
        }

        function s(D) {
            var E = k(), F = v.parent(), C = v.siblings();
            v.off(E.transEnd);
            v.parent()[0].removeChild(v[0]);
            C.removeClass(q.toOne).removeClass(q.toTwo).removeClass(q.toThree);
            v.removeClass(q.dir);
            F.append(v);
            r.isAnimate = false;
            y.trigger("transitionAfter")
        }
    }
    ...
    function c() {
        return {startX: 0, startY: 0, endX: 0, endY: 0, isStart: false, isMove: false, isXMove: false, isAnimate: false}
    }
}(Mobi, jm));
(function (a, b, f) {
    b(e);
    ...
    function e() {
        ...
        b(".formStyle48").each(function (h, k) {
            b(k).on("mouseenter.bindEditLayer", function () {
                d(b(this))
    ...
    function d(k, h) {
        var l = k.find(".f-photoGroupItem");
        l.off("mouseenter.editLayer mouseleave.editLayer");
        if (h === false) {
            return
        }
        l.on("mouseenter.editLayer", function () {
            var t = b(this), v = t.find(".f-photoGroupR-title").text().trim(), n = t.attr("id"),
                p = n.replace("photoGroupR", ""),
                s = "Fai.top.Mobi.popupWindow({title:'编辑图册', frameSrcUrl:'" + c(p) + "', width:860, height:682, version:2});",
                q = {operationText: "编辑图册", className: "edit_2", evalScript: s},
                r = "Mobi.deletePhotoGroupManage('" + p + "', '" + Fai.top.Fai.encodeHtmlJs(v) + "', '', 0)",
                m = {operationText: "删除图册", className: "close_2", evalScript: r}, u = [q, m], o;
            o = a.addEditLayer(t, u, 6);
            o.css({left: t.offset().right - o.width() - 2, top: t.offset().bottom - o.height() - 2})
    ...
    function c(l) {
        var h = Fai.top.location, k = h.origin, o = h.pathname, n = o.split("/"), m;
        n.pop();
        n.pop();
        n.push("manage_v2");
        n.push("photoGroupEdit.jsp");
        m = Fai.top._siteDomain + n.join("/") + "?fromManage=true&mobiSettingState=3&id=" + l;
        return m
    }
}(Mobi, jm));
...
(function (e, a, b) {
    var f = a.prototype, c, m, h, d;
    f.init = function () {
        c = this.sessionMid, m = this.collectionList, h = this.pid, d = this._manageMode;
        n();
        k();
    ...
    function n() {
        Mobi.bindTouchAndClickEvent(e(".shareBlock"), function (o) {
            if (c == 0) {
                if (d) {
    ...
    function l(o) {
        var p = {};
        p.productCollections = m + "";
        e.post("ajax/member_h.jsp", {cmd: "set", id: c, info: e.toJSON(p)}, function (q) {
            if (q.success) {
                if (o == "suc") {
...
Mobi.initProductRestrict = function (n, k, h, e, l, c) {
    if (!n) {
        return
    }
    var b = l ? "#productMallOptionPanel" + c : "", m = 0;
    if (e.count != null) {
        m = e.count
    }
    var o = h - m;
    ...
    if (k > 1 && h != 0) {
        ...
        jm(b + " #limitAmountDiv").text("( " + LS.minAmount + " : " + k + " ; " + LS.maxAmount + " : " + o + " )");
        d = k;
        f = o
    } else {
        if (k == 1 && h != 0) {
            jm(b + " #limitAmountDiv").parent().attr("style", "line-height:1.5rem;");
            jm(b + " #limitAmountDiv").text("( " + LS.maxAmount + " : " + o + " )");
            f = o
        } else {
            if (k > 1 && h == 0) {
                jm(b + " #limitAmountDiv").parent().attr("style", "line-height:1.5rem;");
                jm(b + " #limitAmountDiv").text("( " + LS.minAmount + " : " + k + " )");
                d = k
            }
        }
    }
...
Mobi.initProductOptions = function (h, u, c, r, m, p, a, s, v, f) {
    var w = false;
    jm.each(h, function (A, B) {
        if (B.t == null) {
            w = true;
            return false
        }
    ...
    var d = jm(".J-op-box"), x = jm(".mallOptionImg"), t = d.find(".J-op"), l = "";
    if (a == 1) {
        d = jm("#productMallOptionPanel" + s + " .J-op-box");
        x = jm("#productMallOptionPanel" + s + " .mallOptionImg"), t = d.find(".J-op");
        l = "#productMallOptionPanel" + s
    }
    var q = [];
    var k = jm("#mallPrice").html();
    var n = jm("#mallAmount").html();
    var b = jm("#mallWeight").html();
    if (n <= 0) {
        y(t.find("label"));
        t.find("label").attr("isEmptyAmount", "1")
    } else {
        jm.each(h, function (A, C) {
            if (C.oAmount <= 0 && t.length <= 1) {
                var B = t.find("label[data='" + C.t2 + "']");
                y(B);
                jm(B).attr("isEmptyAmount", "1")
            } else {
                if (C.oAmount <= 0) {
                    q.push(C.t2)
                }
    ...
    jm(t).each(function (A) {
        ...
        B.find("label").click(function () {
            ...
            var K = jm(this);
            if (!K.hasClass("isSelected")) {
                if (K.parent().find(".optionSelected").length > 0) {
                    K.parent().find(".optionSelected").removeClass("optionSelected isSelected")
                }
                K.addClass("optionSelected isSelected");
                var I = K.attr("data");
                B.attr("option_data", I)
            } else {
                K.parent().find(".optionSelected").removeClass("optionSelected isSelected");
                jm("#" + K.attr("for")).prop("checked", false);
                K.parents(".J-op").removeAttr("option_data");
                jm("#mallPrice").html(k);
                jm("#mallAmount").html(n);
            ...
            if (t.length > 1 && u) {
                var ac = "";
                var af = 0;
                t.each(function (ah, ai) {
                    if (jm(t[ah]).find(".optionSelected").length <= 0) {
                        ac += "x_"
                    } else {
                        ac += jm(t[ah]).find(".optionSelected").attr("data") + "_"
                    }
                });
                ac = ac.substring(0, ac.length - 1);
                jm.each(h, function (ah, ai) {
                    if (z(ac, ai.t2)) {
                        if (ai.flag != 0 && !isNaN(ai.oAmount)) {
                            af += ai.oAmount
                        }
                    }
                });
                jm(l + " #mallAmount").text(af)
            }
            var P = d.find(".optionSelected");
            if (x.length > 0) {
                var ab = K.attr("_indeptPic");
                if (ab != null) {
                    x.attr("src", ab)
                }
            }
            if (t.length == P.length) {
                ...
                if (r) {
                    jm(l + " #limitAmountDiv").text("");
                    var D = 0;
                    var ag = m.optionsCount;
                    if (ag != null && ag.d != null) {
                        for (var Z = 0; Z < ag.d.length; Z++) {
                            if ((ag.d[Z].t + "_") == G) {
                                D = ag.d[Z].c
                            }
                        }
                    ...
                    var Y = -1;
                    if (C > 1 && L != 0) {
                        jm(l + " #limitAmountDiv").parent().attr("style", "line-height:1.5rem;");
                        jm(l + " #limitAmountDiv").text("( " + LS.minAmount + " : " + C + " ; " + LS.maxAmount + " : " + J + " )");
                        U = C;
                        Y = J
                    } else {
                        if (C == 1 && L != 0) {
                            jm(l + " #limitAmountDiv").parent().attr("style", "line-height:1.5rem;");
                            jm(l + " #limitAmountDiv").text("( " + LS.maxAmount + " : " + J + " )");
                            Y = J
                        } else {
                            if (C > 1 && L == 0) {
                                jm(l + " #limitAmountDiv").parent().attr("style", "line-height:1.5rem;");
                                jm(l + " #limitAmountDiv").text("( " + LS.minAmount + " : " + C + " )");
                                U = C
                            }
                        }
                    }
                    jm(l + " #productNum").val(U);
                    jm(l + " #productNum").unbind("change");
                    jm(l + " #productNum").bind("change", function () {
                        var ah = jm(l + " #productNum").val();
                        var ai = 1;
                        if (jm.isInteger(ah)) {
                            ai = parseInt(ah)
                        }
                        if (ai < U || ai == U) {
                            ai = U;
                            jm(l + " #g_decrease , .g_decrease").addClass("g_opacity50");
                            jm(l + " #g_increase , .g_increase").removeClass("g_opacity50")
                        } else {
                            if (Y != -1 && (ai > Y || ai == Y)) {
                                ai = Y;
                                jm(l + " #g_decrease , .g_decrease").removeClass("g_opacity50");
                                jm(l + " #g_increase , .g_increase").addClass("g_opacity50")
                            } else {
                                if (ai > 9999998) {
                                    ai = 9999999;
                                    jm(l + " #g_decrease , .g_decrease").removeClass("g_opacity50");
                        ...
                        jm(l + " #productNum").val(ai)
                    });
                    jm(l + " #productNum").change();
                    jm(l + " #g_decrease , .g_decrease").unbind("click.dc2");
                    jm(l + " #g_increase , .g_increase").unbind("click.ic2");
                    jm(l + " #g_decrease , .g_decrease").bind("click.dc2", function () {
                        var ah = jm(l + " #productNum").val();
                        var ai = 1;
                        if (jm.isInteger(ah)) {
                            ai = parseInt(ah)
                    ...
                    jm(l + " #g_increase , .g_increase").bind("click.ic2", function () {
                        var ah = jm(l + " #productNum").val();
                        var ai = 1;
                        if (jm.isInteger(ah)) {
                            ai = parseInt(ah)
                ...
                if (u) {
                    jm(l + " #mallAmount").text(H)
                }
                if (V == null) {
                    Mobi.onlyChangeSalePrice(c, p, a, s)
                } else {
                    Mobi.onlyChangeSalePrice(V, p, a, s)
                }
                if (N != null) {
                    jm(l + " #mallWeight").text(N + f)
                }
            }
            if (t.length != P.length && t.length != 1) {
                o()
            }
            if ((t.length - 1) <= P.length && t.length != 1) {
                var T = "";
                t.each(function (ah, ai) {
                    if (jm(t[ah]).find(".isSelected").length <= 0) {
                        T += "x_"
                    } else {
                        T += jm(t[ah]).find(".isSelected").attr("data") + "_"
                    }
                });
                if (T != "") {
                ...
                var M = "";
                t.each(function (ah, aj) {
                    var ai = jm(t[ah]).find(".isSelected");
                    if (ai.length <= 0) {
                        M = jm(t[ah])
                    }
                });
                if (M != "") {
                    var ad = M.find("label");
                    ad.each(function (ah, aj) {
                        var ai = T.replace("x", jm(ad[ah]).attr("data"));
                        if (jm.inArray(ai, q) >= 0) {
                            y(ad[ah]);
                            jm(ad[ah]).attr("isEmptyAmount", "1")
                        } else {
                            e(ad[ah])
                        }
                    })
                    ...
                    t.each(function (ah, aj) {
                        var ai = jm(t[ah]).find("label");
                        ai.each(function (am, al) {
                            if (jm(ai[am]).hasClass("isSelected")) {
                                return
                            }
                            var ak = T.split("_");
                            ak[ah] = jm(ai[am]).attr("data");
                            var an = ak.join("_");
                            if (jm.inArray(an, q) >= 0) {
                                y(ai[am]);
                                jm(ai[am]).attr("isEmptyAmount", "1")
                            } else {
                                e(ai[am])
                            }
                        })
            ...
            for (var Z = 0; Z < t.length; Z++) {
                var O = t.eq("" + Z + "");
                if (O.find(".optionSelected").length > 0) {
                    aa.push(O.find(".optionSelected").attr("data"))
                } else {
                    break
                }
            }
            var X = false;
            if (aa.length <= t.length && aa.length > 1) {
                var R = aa.length;
                for (var Z = 0; Z < R; Z++) {
                    jm.each(h, function (ai, ak) {
                        var aj = ak.t2;
                        var ah = aj.split("_");
                        if (ak.flag == undefined) {
                            ak.flag = 1
                        }
                        if (ak.flag == 1 && arrHasSameBegin(ah, aa)) {
                            X = true;
                            return false
                        }
                    });
                    if (!X) {
                        var S = t.eq(aa.length - 1).find("label");
                        t.eq(aa.length - 1).removeAttr("option_data");
                        S.removeClass("optionSelected isSelected");
                        var Q = aa.pop();
                        S.each(function () {
                            if (jm(this).attr("data") == Q) {
                                jm(this).hide()
                            }
                        })
                    } else {
            ...
            var ae = t.index(B);
            for (var W = ae; W < aa.length; W++) {
                var E = aa.slice(0, W + 1);
                X = false;
                for (var Z = E.length; Z < t.length; Z++) {
                    var F = t.eq("" + Z + "");
                    F.find("label").each(function () {
                        var ah = jm(this).attr("data");
                        X = false;
                        jm.each(h, function (aj, al) {
                            var ak = al.t2;
                            var ai = ak.split("_");
                            if (al.flag == undefined) {
                                al.flag = 1
                            }
                            if (ah == ai[Z] && al.flag == 1 && arrHasSameBegin(ai, E)) {
                                X = true;
                                return false
                            }
                        });
    ...
    function y(A) {
        jm(A).css("border-style", "dashed").css("color", "#CDCDCD");
        jm("#" + jm(A).attr("for")).attr("disabled", true)
    }

    function e(A) {
        jm(A).css("border-style", "").css("color", "");
        jm(A).attr("isEmptyAmount", "");
        jm("#" + jm(A).attr("for")).removeAttr("disabled")
    }
...
Mobi.onlyChangeSalePrice = function (h, f, e, c) {
    ...
    var k = Mobi.salePromotionDetail.salePromotionParam;
    ...
    if (k.saleType == "1") {
        var d = parseFloat(k.other.ruleData.d[0].m);
        var a = 0;
...
Mobi.initProductSwipe = function (b) {
    ...
    Mobi.initScaleImage(c);
    d("#" + b).swipehandle(c, {
        continuous: true, bulletsClick: true, callback: function (f) {
            var e = a.length;
            while (e--) {
                a[e].className = " "
            }
...
Mobi.pdCommentAddCom = function () {
    var k = jm.trim(jm("#productCommentCreator").val());
    ...
    var m = jm(".J_productCommImg").find("img");
    var e = [];
    ...
    var h = {validateCode: d, commentsObjId: p, creator: k, commImgList: JSON.stringify(e), comment: b};
    Mobi.ing(LS.siteFormSubmitIng);
    jm.ajax({
        type: "POST", url: s, data: h, error: function () {
            Mobi.ing(LS.systemError);
...
Mobi.waterFall = function (A, D, B, n, h, m, o, F) {
    var d = parseInt(jm("#" + D + " .productWaterFall .style8Img").width());
    var l = _htmlFontSize;
    var p = (d * m) / (h * l);
    p = parseFloat(p.toFixed(4));
    var x = (d * n) / (B * l);
    x = parseFloat(x.toFixed(4));
    var E = jm("#" + D + " .paramPadding .paramName").css("font-size");
    if (typeof E != "object") {
        var q = E.substring(0, E.indexOf("p")) / l;
        q = parseFloat(q) + 0.2;
        jm("#" + D + " .productWaterFall .paramPadding .paramName").css("line-height", q + "rem");
    ...
    if (o == u) {
        if (Mobi.getBrowserType() == Mobi.BrowserType.FIREFOX) {
            jm("#" + D + " .productWaterFall .paramPadding .paramName").height(q + "rem")
        } else {
            jm("#" + D + " .productWaterFall .paramPadding .paramName").height(q - 0.08 + "rem")
        }
    } else {
        jm("#" + D + " .productWaterFall .paramPadding .paramName").height(q / 2 + "rem")
    }
    if (A.length == 1) {
        jm("#" + D + " .productWaterFall .style8Img").height(p + "rem");
        jm("#" + D + " .productWaterFall").eq(v).css({"vertical-align": "top"})
    } else {
        if (A.length == 2) {
            for (var v = 0; v < A.length; v++) {
                if (v % 2 == 0) {
                    jm("#" + D + " .productWaterFall .style8Img").eq(v).height(p + "rem");
                    jm("#" + D + " .productWaterFall").eq(v).css({"vertical-align": "top"})
                } else {
                    if (v % 2 == 1) {
                        var C = 0;
                        jm("#" + D + " .productWaterFall .style8Img").eq(v).height(x + "rem");
                        jm("#" + D + " .productWaterFall").eq(v).css({position: "absolute", top: C + "rem"});
                        var c = parseFloat(jm("#" + D + " .productWaterFall .commonProRight").parent().parent().parent().height());
                        var s = parseFloat(jm("#" + D + " .productWaterFall .firstLastPro").parent().parent().parent().height());
                        c = c / l;
                        s = s / l;
                        if (s < c) {
                            c = c + 10 / l;
                            jm("#" + D + " .productWaterFall .firstLastPro").parent().parent().parent().parent().height(c + "rem")
                        }
                    }
                }
            }
                ...
                if (v == 0) {
                    ...
                    if (t + 1 == A.length) {
                        ...
                        if (A.length % 2 == 1) {
                            ...
                            if (A.length % 2 == 0) {
                                var b = parseFloat(jm("#" + D + " .productWaterFall .commonProRight").parent().parent().parent().height());
                                b = (b) / l;
                                var y = (b + 0.5) * ((v + 1) / 2 - 1);
                                jm("#" + D + " .productWaterFall").eq(v).css({position: "absolute", top: y + "rem"})
                            }
                        }
                    } else {
                        jm("#" + D + " .productWaterFall .style8Img").eq(v).height(x + "rem");
                        var b = parseFloat(jm("#" + D + " .productWaterFall .commonProRight").parent().parent().parent().height());
                        var a = parseFloat(jm("#" + D + " .productWaterFall .commonProRight").parent().parent().parent().width());
                        b = (b) / l;
                        if (v % 2 == 0) {
                            jm("#" + D + " .productWaterFall").eq(v).css({"vertical-align": "top"})
                        } else {
                            if (v % 2 == 1) {
                                var w = (b + 0.5) * ((v + 1) / 2 - 1);
                                jm("#" + D + " .productWaterFall").eq(v).css({position: "absolute", top: w + "rem"})
                            }
                        }
                    }
                }
    ...
    if (Fai.top._manageMode) {
        var e = $("#" + D), H = e.find(".productWaterFall"), G = e.attr("_productselect") == "true" ? true : false, z,
            f;
        H.each(function (k, I) {
            z = $(I);
            f = z.attr("topswitch") == "off";
            waterFallImg = z.find(".waterFallImg");
            waterFallImg.wrap("<div class='J_productListImgWrap fk-productListImgWrap'></div>");
            if (f && !G) {
                z.find(".J_productListImgWrap").append("<div class='f-productListTopFlag' >置顶</div>")
            }
        })
    }
    var r = jm("#" + D + " .productWaterFall");
    r.each(function (Q, k) {
        var K = jm(k);
        var M = K.attr("productId");
        var O = F[M];
        if (O.salePromotionOpen) {
            var L = O.saleType;
            var T = O.other.ruleData.d[0].m;
            var P = O.other.ruleData.d;
            if (L == 1) {
                var R = O.other.ruleData.s;
                if (R == 1) {
                    K.find(".waterFallImg").append("<div class='g_bgColor f-productListTopPromotion'>享" + T + "折</div>\n")
                } else {
                    K.find(".waterFallImg").append("<div class='g_bgColor f-productListTopPromotion'>直降" + T + "</div>\n")
                }
            } else {
                if (L == 2) {
                    var S = 0;
                    ...
                    K.find(".waterFallImg").append("<div class='g_bgColor f-productListTopPromotion'>满" + T + "减" + S + "</div>\n")
                }
            }
        }
    })
...
Mobi.initProductSwipe1 = function (d) {
    ...
    c("#" + d).swipehandle(b, {
        auto: false, continuous: false, bulletsClick: true, callback: function (h) {
            var f = a.length;
            while (f--) {
                a[f].className = " "
            }
...
Mobi.productCrossedSlide = function (a, d, f, b) {
    ...
    var k = jm("#" + a + " .paramPadding .paramName").css("font-size");
    if (typeof k != "object") {
        var m = k.substring(0, k.indexOf("p")) / h + 0.2;
        jm("#" + a + " .productCrossedSlide .paramPadding .paramName").css("line-height", m + "rem");
    ...
    if (b == e) {
        if (Mobi.getBrowserType() == Mobi.BrowserType.FIREFOX) {
            jm("#" + a + " .productCrossedSlide .paramPadding .paramName").height(m + "rem")
        } else {
            jm("#" + a + " .productCrossedSlide .paramPadding .paramName").height(m - 0.08 + "rem")
        }
    } else {
        jm("#" + a + " .productWaterFall .paramPadding .paramName").height(m / 2 - 0.1 + "rem")
    }
    jm("#" + a + " .productCrossedSlide .style7Img").height(l + "rem")
};
Mobi.productCrossedSlideSec = function (a, d, f, b) {
    ...
    if (typeof k != "object") {
        var m = k.substring(0, k.indexOf("p")) / h + 0.2;
        jm("#" + a + " .productCrossedSlideSec .paramPadding .paramName").css("line-height", m + "rem");
        m = parseFloat(m.toFixed(4)) * 2
    } else {
        m = 0
    }
    ...
    if (b == e) {
        if (Mobi.getBrowserType() == Mobi.BrowserType.FIREFOX) {
            jm("#" + a + " .productCrossedSlideSec .paramPadding .paramName").height(m + "rem")
        } else {
            jm("#" + a + " .productCrossedSlideSec .paramPadding .paramName").height(m - 0.08 + "rem")
        }
    } else {
        jm("#" + a + " .productWaterFall .paramPadding .paramName").height(m / 2 - 0.1 + "rem")
    }
    jm("#" + a + " .productCrossedSlideSec .style9Img").height(l + "rem")
};
Mobi.productCrossedSlideSecSwipe = function (b, J) {
    var m = Mobi.getPreviewObject(b), q = Mobi.getPreviewObject(J), L = m, O = parseInt(jm(q).width()), l = 0,
        E = q.querySelectorAll(".productCrossedSlideSec"), k = _htmlFontSize, z = E.length * 0.5 * k, H = jm(q),
        F = jm("#" + b), N = false, d = true, I = null, a = jm("#webModuleContainer"), f = null, p = undefined, e = 0,
        c = 0, n = null, o, x = 0, G = jm("<div></div>"), t, s, w, v;
    H.css("margin-top", "30px");

    function M(P) {
        H.off("mouseup.prod");
        H.off("mousemove.prod");
        H.off("mouseout.prod")
    }

    function B(P) {
        F.find("div.style9Img").trigger("horizonScroll");
        F.append(G);
        t = w = P.pageX;
        s = v = P.pageY;
        H.off("mousemove.prod").on("mousemove.prod", K);
        H.off("mouseup.prod").on("mouseup.prod", D);
        H.off("mouseout.prod").on("mouseout.prod", M);
        P.preventDefault();
        P.stopPropagation()
    }

    function K(Q) {
        var P = 0, S = H.width() - F.width(), R = parseInt(F.css("left"));
        N = true;
        w = Q.pageX;
        v = Q.pageY;
        R += (w - t);
    ...
    function A(S, U, R, T) {
        var Q = Math.abs(S - R), P = Math.abs(U - T);
        if (Q === 0 && P === 0) {
            return
        }
        if (Q === 0 && P > 0) {
    ...
    function u(P) {
        var Q = P.touches.length > 0 ? P.touches[0] : P.chengedTouches[0];
        return {pageX: Q.pageX, pageY: Q.pageY}
    }
    ...
    function h(P) {
        ...
        t = w = Q.pageX;
        s = v = Q.pageY;
        H.off("touchmove.prod").on("touchmove.prod", C);
        H.off("touchend.prod").on("touchend.prod", y);
        F.append(G)
    }
    ...
    function y(P) {
        G.remove();
        p = t = s = w = v = undefined;
        H.off("touchmove.prod", C);
        H.off("touchend.prod", y)
    }

    if (E.length > 0) {
        l = E[0].offsetWidth * E.length
    }
    l += z;
    if (l > O) {
        if (navigator.appVersion.match(/MSIE [\d.]+/)) {
        ...
        l = l + 10;
        jm(L).css("width", l + "px");
        var r = jm.getCookie("startX") ? parseInt(jm.getCookie("startX")) : 0;
        if (Mobi.isPC()) {
            H.css({position: "relative", height: parseInt(F.height()) + "px"});
            F.css({position: "absolute", left: 0, top: 0});
            H.off("mousedown.prod").on("mousedown.prod", B);
            H.off("mousedown.prodItem").on("mousedown.prodItem", ".J_prodItem", function () {
                n = jm(".editLayer");
                o = F.offset().left
            });
            H.off("click.checkMove").on("click.checkMove", function () {
                if (N) {
                    d = false
                } else {
                    d = true
            ...
            H.off("click.prodLink").on("click.prodLink", ".J_prodItem-a", function (P) {
                return d
            })
        } else {
            f = new iScroll(q, {
            ...
            H.off("touchstart.prod").on("touchstart.prod", h);
            jm("body").off("touchmove.prod").on("touchmove.prod", function (P) {
                if (p === false) {
                    P.preventDefault()
                }
            });
            G.css({width: "100%", height: "100%", position: "absolute", opacity: 0, left: 0, top: 0, zIndex: -1});
            F.children().off("touchmove.banIScroll").on("touchmove.banIScroll", function (P) {
                if (p === true) {
                    P.stopPropagation()
                }
            })
    ...
    F.find(".productCrossedSlideSec").show()
};
...
Mobi.productNewDetailEventInit = function (f) {
    ...
    var C = f.moduleId, x = f.productId, B = f.mallOptionsOpen;
    pageStyle = f.pageStyle, returnUrl = f.returnUrl || "";
    Mobi.scrollFadeIn("productDetailHeader" + C, "productNewDetailSwipe" + C, pageStyle);
    Mobi.initAjaxTab({pid: x, moduleId: C});
    var D = document.getElementById("productDetailHeader" + C),
        m = document.getElementById("productNewDetailPanel" + C),
        s = m.querySelector(".productNewDetail .productInfoSize"), u = D.querySelector(".icon-gClose.proBack"),
        n = D.querySelector(".icon-noProduct.proShopping"), o = D.querySelector(".tabBody .userCommentInfo"),
        h = D.querySelector(".icon-gOther.proOther"), z = D.querySelector(".icon-share.proShare"),
        F = D.querySelector(".proOtherPanel"), a = m.querySelector(".J_productImmediatelyBug"),
        w = m.querySelector(".productMallBuy"), y = m.querySelector(".productMallShop"),
        r = m.querySelector("#productTabUl");
    var p = false;
    if (window.sessionStorage) {
        p = Mobi.checkWindowSeStgValue(window.sessionStorage._isJumpFromMlist);
        try {
    ...
    jm(m).bind("click", function () {
        if (jm(F).hasClass("proOtherPanelOpen")) {
            jm(F).removeClass("proOtherPanelOpen")
        }
    });
    jm(h).bind("click", function (G) {
        if (jm(F).hasClass("proOtherPanelOpen")) {
            jm(F).removeClass("proOtherPanelOpen")
        } else {
            jm(F).addClass("proOtherPanelOpen")
        }
        G.stopPropagation()
    });
    var E = jm(".productMallShop").html(), v = jm(".productMallBuyPanel").html(), t = Mobi.initWebPage({
    ...
    jm("#productInfoSize").bind("click", function () {
        ...
        var J = jm(".productMallBuyPanel");
        J.html(E);
        var G = Fai.top._templateFrameId;
        var H = jm(".productMallBuyPanel .productAddMall");
        var I = (G >= 1015 && G < 2000);
        if (G < 2000 || G >= 3000) {
            H.css("margin-left", "0.45rem");
            if (G == 1014) {
                H.css("margin-left", "0.85rem")
            }
        }
        if (I) {
            H.css({"margin-left": "", "margin-top": ""});
            J.find(".mallThemeAddCartBtn").css("margin-left", "")
        }
    ...
    function A() {
        var H = document.getElementById("productMallOptionPanel"), I = document.getElementById("g_body").clientHeight,
            M = H.querySelector(".productMallOptionContentPanel"), G = H.querySelector(".productMallOptionContent"),
            J = H.querySelector(".productMallOptionMargin"), L = H.querySelectorAll(".productMallOptionContent>div"),
            K = true
    }

    var e;
    jm("#productNewDetailPanel" + C + " .J_productAddMall").bind("click", function () {
        jm(".productMallBuyPanel").html(v);
        e = 0;
        t()
    });
    ...
    var k = {
        ...
        callback: function () {
            jm("#couponListBottomPanel").bind("click", function (G) {
                G.stopPropagation()
            });
            jm("#couponListBottomPanel").bind("mousedown", function (G) {
                G.stopPropagation()
            });
            jm("#couponListBottomPanel").bind("touchstart", function (G) {
                G.stopPropagation()
            });
...
Mobi.initCommentUserTab = function (c) {
    ...
    var a = {
        triggerId: "userCommentId", panelId: "userCommentPanel", callback: function () {
...
Mobi.setStarSelect = function () {
    Mobi.onTouchAndClickEvent(".J-star-list li", function () {
        ...
        e.find("li.score-tip").css({"border-color": b, color: b, display: "inline-block", "max-width": "6.6rem"});
...
Mobi.couponPage = function (c) {
    ...
    for (i = 0; i < c.length; i++) {
        b.push("<div class ='couponItem' couponid = " + c[i].id + " bgid= " + 0 + " onclick='Mobi.clickCoupon(this);' >");
        if (!c[i].isRecieve) {
            b.push("<div class='couponItem-left g_bgColor'>");
            b.push("<div class='couponItemLeftBackground'></div>");
            b.push("<div class='couponItemLeftData'><span>" + Fai.top.choiceCurrencyVal + "</span><span style='font-size: 1.625rem;'>" + c[i].savePrice + "</span></div>");
            b.push("<div class='couponItemLeftCondit'>满" + c[i].orderMinPrice + "可用</div>");
            b.push("</div>");
            b.push("<div style= 'display:inline-block;width:9.85rem;height:4.05rem;;background-color:white; position:relative;vertical-align:top;'>");
            b.push("<div class='couponItemRightName g_mainColor'>" + c[i].couponName + "</div>");
            b.push("<div class='couponItemRightValidity'>" + c[i].validity + "</div>");
            b.push("</div>")
        } else {
            b.push("<div class='couponItem-left coupon-color-invalid'>");
            b.push("<div class='couponItemLeftBackground'></div>");
            b.push("<div class='couponItemLeftData'><span style='font-size: 0.75rem;'>" + Fai.top.choiceCurrencyVal + "</span><span style='font-size: 1.625rem;'>" + c[i].savePrice + "</span></div>");
            b.push("<div class='couponItemLeftCondit'>满" + c[i].orderMinPrice + "可用</div>");
            b.push("</div>");
            b.push("<div style= 'display:inline-block;width:9.85rem;height:4.05rem;;background-color:white; position:relative;vertical-align:top;'>");
            b.push("<div class='couponState'></div>");
            b.push("<div class='couponItemRightName coupon-words-invalid'>" + c[i].couponName + "</div>");
            b.push("<div class='couponItemRightValidity coupon-words-invalid'>" + c[i].validity + "</div>");
            b.push("</div>")
        }
        b.push("</div>")
    }
    a = "<div style='display:none; width:100%;' id ='contentBottomPanel'><div class='couponListBottomPanel' id ='couponListBottomPanel'><div class='couponListTitle'>优惠券</div><div id='slideCouponPanel' style='max-height: 10rem;overflow: auto;'><div class='couponListContainer'>" + b.join("") + "</div></div></div></div>";
    return a
};
Mobi.sharePage = function (n) {
    if (!n) {
        return
    }
    var l = jm.parseJSON(n.shareLinkList), b = n.shareUrl, d = n.browserTitle;
    var m = "", f = [];
    for (var c in l) {
        var a = l[c].url, e = l[c].icon;
        if (e == "baidu_tieba" && Fai.top._isFaiHost) {
            m += "<a hidefocus='true' class='shareLink' href='javascript:;' onclick='Mobi.ing(\"" + LS.shareNot + "\");'><div class='shareNewIcon g_iconMiddle icon-" + e + "'></div><div class='shareText icon-" + e + "-text'></div></a>"
        } else {
            if (e == "Weixin") {
                shareIcon = true;
                m += "<a hidefocus='true' class='shareLink' id='shareLinkWeixin' href='javascript:;'><div class='shareNewIcon g_iconMiddle icon-" + e + "'></div><div class='shareText icon-" + e + "-text'></div></a>"
            } else {
                m += "<a hidefocus='true' class='shareLink' href='javascript:;' onclick='window.open(\"" + a + "\")'><div class='shareNewIcon g_iconMiddle icon-" + e + "'></div><div class='shareText icon-" + e + "-text'></div></a>"
            }
        }
        if ((parseInt(c) + 1) % 8 === 0) {
            f.push("<div class='swipImgBox'>" + m + "</div>");
            m = ""
        }
    }
    m && f.push("<div class='swipImgBox'>" + m + "</div>");
    var k = "";
    if (l.length <= 4) {
        k = "style='height:5rem';"
    }
    var h = "<div class='shareListPanel' id='shareListPanel'><div class='shareListContent'><div class='shareTitle'>" + LS.shareIt + "</div><div class='shareListShow' id='shareListShowSwipe' " + k + "><div class='shareListSwipe'>" + f.join("") + "</div>";
    if (l.length > 8) {
...
Mobi.initPbCommUploadImgParam = function (c, d, l, m, e, f, p, b) {
    ...
    function k() {
        if (b == "true") {
            Mobi.mobiPbCommUploadImgSWF("comm-img-swfu-placeholder", c, d, l)
        } else {
    ...
    function n(v) {
        var s = document.getElementsByTagName("script"), t = false, r = "";
        for (var u = 0, q = s.length; u < q; u++) {
            r = (s[u].getAttribute && s[u].getAttribute("src")) || "";
            if (r == v) {
                t = true;
                break
            }
...
Mobi.mobiPbCommUploadImgSWF = function (d, b, f, a) {
    ...
    var c = {
        ...
        requeue_on_error: false,
        post_params: {ctrl: "Filedata", app: 21, type: 0, fileUploadLimit: a},
        file_types: e.join(";"),
        file_dialog_complete_handler: function (h) {
            this._allSuccess = false;
            this.startUpload()
        },
        file_queue_error_handler: function (k, h, l) {
            switch (h) {
                case SWFUpload.QUEUE_ERROR.FILE_EXCEEDS_SIZE_LIMIT:
                    Mobi.ing(LS.mobiFormSubmitCheckFileSizeErr, true);
                    break;
        ...
        upload_success_handler: function (k, h) {
            var l = jQuery.parseJSON(h);
            ...
            if (l.success) {
                ...
                Mobi.onPbCommFileUploadEvent("upload", l)
            } else {
                Mobi.ing(LS.mobiFormSubmitFileUploadFile + k.name + "   " + l.msg)
            }
        },
        upload_error_handler: function (k, h, l) {
            if (h == -280) {
                Mobi.ing(LS.mobiFormSubmitFileUploadFileCancle, false)
            } else {
                if (h == -270) {
        ...
        view_progress: function (h, m, l, k) {
...
Mobi.mobiPbCommUploadImgHtml = function (h, c, d, f) {
    ...
    var k = {
        ...
        removeTimeout: 9999999,
        getFileSizeUrlFlag: true,
        post_params: {app: 21, type: 0, fileUploadLimit: c, isSiteForm: true},
        buttonText: "",
        ...
        onUploadSuccess: function (n, p) {
            ...
            if (o.success) {
                var m = {status: "end", id: n.id, title: "上传成功。"};
                e(m);
                setTimeout(function () {
                    Mobi.ing(jm.format(LS.mobiFormSubmitFileUploadSucess, jm.encodeHtml(n.name)), true)
                }, 1800);
                Mobi.onPbCommFileUploadEvent("upload", o)
            } else {
                var m = {status: "end", id: n.id, title: o.msg};
                e(m);
    ...
    if (Fai.top._manageMode) {
        ...
        jQuery("#file_upload_pt_1").attr("disabled", "true").off("click").on("click", function (m) {
            Mobi.ing("管理状态下，不能上传图片。");
            return false
        })
    }
};
Mobi.onPbCommFileUploadEvent = function (l, f) {
    if (l == "upload") {
        var c = f.id;
        var k = f.name;
        var e = f.size;
        ...
        var a = f.width;
        var h = f.height;
        Mobi.pbCommImgTableCtrl(d, k, c, e, b)
    }
};
Mobi.pbCommImgTableCtrl = function (m, a, b, h, d) {
    var k = $("#pt_add_img_tb").eq(0);
    ...
    f.push("      <img src='" + m + "' alt='' onclick='Mobi.pbRemoveBodyStyle()'  _name='" + a + "' _id='" + b + "' _file_size='" + h + "' _file_id='" + d + "' class='comm-up-set'>");
    f.push("     </td>");
    f.push(" </tr>");
    f.push("</table>");
...
Mobi.postUserComment = function (f) {
    var c = document.getElementById("userCommentPanel"), e = c.querySelector(".tabUl"), b = c.querySelector(".tabLi"),
        a = c.querySelector(".tabUserPanel"), d = function (n) {
            if (n) {
                var o = n.getAttribute("data"), m = c.querySelector(".tabActive").getAttribute("data"),
                    l = document.getElementById("tabUserPanel" + o);
                jm(c.querySelector(".tabActive")).removeClass("tabActive");
                jm(c.querySelector(".tabPanelAtive")).removeClass("tabPanelAtive");
                jm("#userCommentRemarkPanel" + o).append(jm("#userCommentRemarkPanel" + m + " .g_globalLine"));
                jm(l).append(jm("#userCommentRemarkPanel"));
            ...
            var l = (jm(".loginCaptchaCtrl").css("display") != "none");
            var m = jm("#loginCaptcha").val();
            if (o == null || o == "") {
            ...
            jm.ajax({
                type: "post",
                url: "ajax/login_h.jsp",
                data: "cmd=loginMember&acct=" + jm.encodeUrl(o) + "&pwd=" + jm.encodeUrl(n) + "&captcha=" + jm.encodeUrl(m),
                error: function () {
                    loginBtn.removeAttr("disabled");
                    Mobi.showMemberLoginMsg(-1)
                },
                success: function (p) {
                    ...
                    if (p.success) {
                        Fai.top.sessionMemberId = p.sessionMemberId;
                        jm("#_TOKEN").remove();
                        jm("head").append(p._HEADTOKEN);
                        h(true);
                        return
                    } else {
                        if (p.active) {
                            ...
                            Mobi.showMemberLoginMsg(p.rt, p.captcha)
                        }
                    }
                }
            })
            ...
            var m = jm("#userCommentRemark").val();
            ...
            if (m.length < r) {
                Mobi.ing(jm.format(LS.commentLenTips, jm.encodeHtml(r)));
                return
            }
            var u = (jm(".loginCaptchaCtrl").css("display") != "none");
            if (!q) {
                t = jm.trim(jm("#anonymityCommentUser").val());
                ...
                t = jm.trim(jm("#user").val());
                o = jm("#loginCaptcha").val()
            }
            if (u && (typeof(o) != "string" || "" == o)) {
                Mobi.ing(LS.memberInputCaptcha);
                return
            }
            ...
            var s = {
                ...
                commentsObjId: w,
                creator: t,
                commImgList: JSON.stringify(p),
                comment: m,
                anonymity: !q
            };
            var D;
            if (q) {
                D = jm(".J-star-list").eq(0).attr("_star")
            } else {
                D = jm(".J-star-list").eq(1).attr("_star")
            }
            if (D) {
                s.star = D
            }
            Mobi.ing(LS.siteFormSubmitIng);
            jm.ajax({
                type: "POST", url: f, data: s, error: function () {
                    Mobi.ing(LS.systemError);
                    jm("#captchaChange").click()
                }, success: function (F) {
    ...
    Mobi.bindTouchAndClickEvent(jm(e), function (m) {
        var l = m.target;
        d(l)
    });
    Mobi.bindTouchAndClickEvent(jm("#userCommentLoginAndComform"), function (l) {
        if (Fai.top._manageMode) {
    ...
    Mobi.bindTouchAndClickEvent(jm("#anonymityCommentComform"), function (l) {
        if (Fai.top._manageMode) {
            Mobi.ing("您目前处于网站管理状态，请先退出再登录");
            return
        }
...
Mobi.addTheNewComment = function (x) {
    ...
    if (x.newsId != null) {
        ...
        if (q.thumbId) {
            var p = q.width, e = q.left, n = q.top, b = q.imgW, k = q.imgH;
            var w = p / (o * 1.8);
            d.push('style="top:' + -n / w + "px; left:" + -e / w + "px; width:" + b / w + "px; height:" + k / w + 'px"')
        } else {
            d.push('style="height:' + (o * 1.8) + 'px"')
        }
        d.push(" /></div>");
        ...
        if ("star" in x) {
            ...
            var l = jm(".fk-comm-avgScore"), h = Number(l.attr("_tc")) + t, m = Number(l.attr("_ts")) + 1;
            var v = h / m;
            l.text(v.toFixed(1));
            l.attr("_tc", h);
            l.attr("_ts", m)
...
Mobi.formatDate = function (b) {
    ...
    var k = b.getDate() > 9 ? b.getDate() : ("0" + b.getDate());
...
Mobi.initAjaxTab = function (c) {
    ...
    var b = c.pid, f = c.moduleId, k = document.querySelector("#productDetailTabPanel" + f + " .tabUl"),
        d = document.querySelector("#productDetailTabPanel" + f + " .tabBody"),
        e = document.getElementById("productNewDetailPanel" + f), a = function (p) {
            if (!p) {
                return
            }
            var n = parseInt(p.getAttribute("data")), m = document.getElementById("tabPanel" + n),
                u = document.getElementById("tabLi" + n), q = e.querySelector(".tabLi.tabActive"),
            ...
            if (m.innerHTML == "") {
                ...
                jm(d).append(o);
                var s = "pid=" + b + "&type=" + n + "&moduleId=" + f + "&rem=" + l;
                jm.ajax({
                    type: "post", url: "ajax/product_h.jsp?cmd=getProductDetailInfo", data: s, error: function () {
                        Mobi.ing("error")
                    }, success: function (r) {
                        ...
                        if (n == 3) {
                            ...
                            if (n === 1) {
                                v.html = "<div class='productDetailInfoPanel g_defaultColor'>" + v.html + "</div>";
                                ...
                                m.innerHTML = v.html + Fai.top._productRecommentData;
    ...
    if (!k.querySelector(".tabActive")) {
        return
    }
    jm(k).bind("click", h);
    a(k.querySelector(".tabActive"));
    Mobi.initCommentUserTab(parseInt(k.querySelector(".tabActive").getAttribute("data")))
};
Mobi.getCommentAjaxPagenation = function (b, d) {
    ...
    jm.ajax({
        type: "post", url: "ajax/product_h.jsp?cmd=getProductInfoComment", data: a, error: function () {
            Mobi.ing("error")
        }, success: function (e) {
...
Mobi.bindCommImgShow = function (h, b, c) {
    ...
    }, k = null, d = null, f = null, e = null, a = window.Code.PhotoSwipe;
    if (b == null || !b || b == "false") {
        var l = a.attach(h, m)
    } else {
        ...
        setTimeout(function () {
            g_showCommImgInstance[c] = a.attach(h, m)
        }, 1000)
    }
};
Mobi.scrollFadeIn = function (k, c, o) {
    var c = document.getElementById(c), k = document.getElementById(k), p = document.getElementById("g_body"),
        a = k.clientHeight, d = c.clientHeight, h = false, e = false;
    ...
    if (productTabUl != null && productTabUl != undefined) {
        var l = productTabUl.clientHeight, f = productTabUl.offsetTop;
...
Mobi.oldShowSalePromotionDl = function (l, d, e) {
    if (typeof(l) == "undefined" || l == null || l == "") {
        return
    }
    Mobi.salePromotionDetail.salePromotionParam = l;
    var b = [];
    if (l.saleType == "1") {
        var h = "";
        if (typeof(l.other.ruleData.d.length) == "undefined") {
            return
        }
        var f = parseFloat(l.other.ruleData.d[0].m);
        if (l.other.ruleData.s == "1") {
            if (Fai.top._lcid == 2052 || Fai.top._lcid == 1028) {
        ...
        for (var a = 0; a < c; a++) {
            ...
            b.push("&nbsp;&nbsp;" + jm.format(LS.salePromotionFullReduce, k[a].m, k[a].n));
            b.push("</div>");
            b.push("</td>");
            b.push("</tr>")
        }
...
Mobi.showSalePromotionDl = function (n, l, c) {
    ...
    if (n.saleType == "1") {
        ...
        if (n.other.ruleData.s == "1") {
            if (Fai.top._lcid == 2052 || Fai.top._lcid == 1028) {
                k = jm.format(LS.salePromotionDisCount, b)
            } else {
                k = jm.format(LS.salePromotionDisCount, 10 * (10 - b))
            }
        } else {
            k = jm.format(LS.salePromotionLapse, b)
        }
        ...
        f.push("<td class='g_mainColor'>");
        if (h == 1) {
            k = jm.format(LS.salePromotionFullReduce, m[0].m, m[0].n);
            f.push("&nbsp;&nbsp;" + k)
        }
        f.push("</td>");
        f.push("</tr></table>");
        if (h > 1) {
            ...
            for (var e = 0; e < h; e++) {
                ...
                f.push("</td>");
                f.push("<td class='g_mainColor'>");
                f.push("&nbsp;&nbsp;" + jm.format(LS.salePromotionFullReduce, m[e].m, m[e].n));
                f.push("</td>");
                f.push("</tr></table>");
                f.push("</div>")
            }
...
Mobi.showSaleTimeCountDown = function (l, d, k, m, h, b) {
    var c = "";
    ...
    Mobi.salePromotionDetail.saleCountTimeInterval = setInterval(function () {
        ...
        var n = parseInt(e / 3600) - (r * 24);
        var o = parseInt(e / 60) - (r * 24 * 60) - (n * 60);
        var q = parseInt(e % 60);
        if (Fai.top._lcid != 2052 && Fai.top._lcid != 1028) {
            if (n < 10) {
                n = "0" + n
        ...
        e--;
        if (m == 1) {
            jm(".showSaleTimeClass").html("&nbsp;&nbsp;" + jm.format(c, r, n, o, q))
        }
        if (e < 0) {
            if (k == 1) {
                e = d;
                ...
                if (Mobi.salePromotionDetail.salePromotionParam.saleType == "1") {
                    var p = jm(".J_salePrePrice").html();
                    if (p != null) {
                        jm(".J_saleMallPrice").html(p)
                    }
                }
...
Mobi.addProductScreenFilterModel = function (e, c) {
    ...
    function d() {
        var n = c.sortName, o = c.desc, m = c.groupId, h;
        if (c.keyword) {
            h = c.keyword
        } else {
            h = ""
        ...
        jm.ajax({
            type: "POST", url: urlStr, data: k, success: function (p) {
                var r = jm.parseJSON(p);
                if (r.success) {
                    var q = jm.toJSON(r.list);
                    Mobi.initScreenFilter(q, f, m, o, n, h)
                }
            }
        })
    }
};
Mobi.initScreenFilter = function (h, e, p, l, q, m) {
    var c = jm.parseJSON(h);
    var k = jm.parseJSON(e);
    ...
    var n = [];
    if (c.length > 1) {
        n.push("<div class='productScreenFilterLib' id='libTab'>");
        ...
        if (k) {
            var o = k.lid;
            n.push("<input type='hidden' id='lidValue' value='" + o + "'/>")
        } else {
            n.push("<input type='hidden' id='lidValue' value='-1'/>")
        }
    } else {
        if (c.length == 1) {
            n.push("<input type='hidden' id='lidValue' value='" + c[0].lid + "'/>")
        } else {
            n.push("<input type='hidden' id='lidValue' value='-1'/>")
        }
    }
    ...
    Mobi.initScreenFilterModel(h, k);
    Mobi.screenCommitData(h, p, l, q, m)
};
Mobi.setPrImageMaxHeight = function (f, b, h) {
    var d = jm("#module" + f), b = d.find(b), c = b.find("img"), e = 0, a = 0;
    c.each(function () {
...
Mobi.changeScreenFilterModel = function (e, b) {
    ...
    jm("#screenOption" + e).bind("click", function () {
        jm("#baseScreenFilterContenter").hide();
        var m = jm("#screenOptionContent" + e).html();
        m = jm.decodeHtml(m);
        jm("#screenCommit").hide();
        var l = [];
        l.push("<div class='productScreenFilterOptionContenter' id='optionSelector" + e + "'>");
        l.push("<div class='productScreenFilterTitle'>");
        l.push("<div id='back' class='icon-screenFilterRt screenFilterRtIcon'></div>");
        l.push("<div class='productScreenFilterTi'>" + d + "</div>");
        l.push("</div>");
        l.push("<div class='productScreenFilterContent'>");
        if (m == LS.productScreenAll) {
            l.push("<div class='productScreenFilterLineCheck' id='propOptionLineAll' onclick='Mobi.changePropValue(\"All\"," + e + ")'>")
        } else {
            l.push("<div class='productScreenFilterLine' id='propOptionLineAll' onclick='Mobi.changePropValue(\"All\"," + e + ")'>")
        }
        l.push("<div class='productScreenFilterLineLfLong'>");
        l.push("<span id='optionAll'>" + LS.productScreenAll + "</span>");
        l.push("</div>");
        if (m == LS.productScreenAll) {
            l.push("<div class='entry-trangle'>");
            l.push("</div>");
            l.push("<div class='icon-check checkIcon'>");
            l.push("</div>")
        }
        l.push("</div>");
        l.push("<div class='g_separator'></div>");
        for (var k = 0; k < c.length; k++) {
            ...
            f = a + f;
            if (m == f) {
                l.push("<div class='productScreenFilterLineCheck' id='propOptionLine" + k + "' onclick='Mobi.changePropValue(\"" + k + '",' + e + ")'>")
            } else {
                l.push("<div class='productScreenFilterLine' id='propOptionLine" + k + "' onclick='Mobi.changePropValue(\"" + k + '",' + e + ")'>")
            }
            l.push("<div class='productScreenFilterLineLfLong'>");
            l.push("<span id='option" + k + "'>" + f + "</span>");
            l.push("</div>");
            if (m == f) {
                l.push("<div class='entry-trangle'>");
                l.push("</div>");
...
Mobi.screenCommitData = function (c, b, f, e, a) {
    ...
    jm("#screenCommit").bind("click", function () {
        ...
        if (q) {
            ...
            m.prop = k;
            l += s + "psc=" + jm.encodeUrl(jm.toJSON(m))
        }
        document.location.href = l
    })
};
Mobi.showProductCacheList = [];
Mobi.showMallCartScreen = function (e, d, c, b, k) {
    var a = jm(".productMallOptionPanel");
    jm("#module" + e + " .J_fk-mallCart").bind("click", function () {
        var p = k && k.replace ? (k.replace(/&nbsp;/gi, " ").replace(/&lt;/gi, "<").replace(/&gt;/g, ">").replace(/&#92;/gi, "\\").replace(/&#39;/gi, "'").replace(/&quot;/gi, '"').replace(/\<br\/\>/gi, "\n").replace(/&amp;/gi, "&")) : k;
        jm("#productMallOptionPanel_mcs_" + e + " .productMallOptionContent").append(p);
        ...
        var q = "";
        var o = {};
        jm.each(Mobi.showProductCacheList, function (s, t) {
            if (t.id == n) {
                m = true;
                l = t.pinfo;
                r = t.showOptionHtml;
        ...
        if (m) {
            ...
            jm.ajax({
                ...
                data: {pid: n, moduleId: e, mallShoppingOptions: c},
                error: function () {
                    Mobi.ing(LS.systemError)
                },
                success: function (s) {
                    ...
                    if (v.success) {
                        var x = v.pinfo;
                        var w = v.showOptionHtml;
                        var u = v.script;
                        var t = v.otherHtml;
                        Mobi.showProductCacheList.push({id: n, pinfo: x, showOptionHtml: w, script: u, otherHtml: t});
                        f(x, w, u, t)
                    }
                }
            })
    ...
    function f(C, o, E, t) {
        a = jm(".productMallOptionPanel");
        var v = C.id;
        a.attr("id", "productMallOptionPanel" + v);
        var q = t.mallAmountHtml || "";
        var x = t.mallWeightHtml || "";
        var z = t.mallPriceHtml || "";
        var y = C.mallPrice;
        var p = y.toFixed(2);
        var l = p;
        var B = "";
        ...
        if (c) {
            var w = p;
            var D = p;
            var s = C.optionsAmountList || {};
            var r = s.d || [];
            jm.each(r, function (J, L) {
                var K = L;
                var G = K.oPrice;
                if (G == null || G == "") {
                    return
        ...
        if (u != "" || B != "") {
            var A = parseFloat(B) * b * 0.01;
            var F = parseFloat(u) * b * 0.01;
            l = F + "~" + A
        }
        jm("#choiceCurrency").text(d);
        jm("#mallPrice").text(l);
        a.find(".mallOptionImg").attr("src", C.picPath);
        a.find(".productMallAmount").html(q);
        a.find(".productMallWeight").html(x);
        a.find(".productDetailName").html("<div class='productName g_middleColor'><div class='productNameWrap' style='word-break:break-all;white-space: normal;overflow:hidden;text-overflow:ellipsis;'></div></div>" + z);
        a.find(".productNameWrap").text(C.name);
        a.find(".J-op-box").html(o);
        ...
        var n = document.createElement("script");
        n.type = "text/javascript";
        n.innerHTML = 'jm(window).bind("pageshow", function(){jm("#productNum").change();});';
        n.id = "opScript2_" + e;
        document.getElementById("productMallOptionPanel_mcs_" + e).appendChild(n)
    }
};
...
Mobi.bookingBoxBind = function (b) {
    ...
    var a = {
        triggerId: triggerId, panelId: "productBookingPanel", callback: function () {
            Mobi.showBookingBox()
...
Mobi.showBookingBox = function () {
    ...
    jm.ajax({
        type: "post", cache: false, url: "ajax/booking_h.jsp?" + e.join(""), error: function () {
            Mobi.ing(LS.systemError)
        }, success: function (h) {
...
Mobi.bookingBoxInit = function (b, h) {
    var f = b.bookingOpen, d = b.moduleId;
    jm("#module" + d).remove();
    var c = [];
    c.push("<div id='module" + b.moduleId + "'>");
    if (f) {
        var k = h.content.st;
        c.push("<div class='siteForm fk-siteForm-v " + (k == 1 ? "verticalShowTye" : "") + "'>");
        c.push("<div id='siteFormItems' class='siteFormItemTable'>\n");
        jm.each(b.contentList, function (l, m) {
            if (m.hide) {
                return true
            }
            c.push(Mobi.genBookingInputStr(m, b, h))
        });
        if (b.validation) {
            if (k == 1) {
        ...
        c.push("<div class='siteFormAddButton " + (k == 1 ? "verticalShowTye" : "") + "'>\n");
...
Mobi.mobiBookingSubmitAdd = function (b) {
    ...
    var a = b.moduleId, d = b.moduleInfo, o = b.contentList, h = [], p = o, c = true, m = b.Def_LIMIT_INPUT_MAXLENTH,
        e = b.Def_LIMIT_TEXTAREA_MAXLEN, n = b.validation, k = jm("#M" + a + "siteFormValidateCode").val(), l = [];
    if (p.length < 1) {
        return false
    }
    jm.each(p, function (E, C) {
        var z = C.id, K = C.name, A = C.must, u = C.type, G = {};
        G.id = z, G.type = u;
        G.must = A;
        if (u == 0) {
            var I = jm.trim(jm("#M" + a + "siteFormInput" + z).val());
            if (A && I == "") {
                Mobi.ing(jm.format(LS.siteFormSubmitInputIsEmpty, jm.encodeHtml(K)));
                c = false;
                return false
            }
            if (I.length > m) {
                Mobi.ing(jm.format(LS.siteFormSubmitInputMaxLength, jm.encodeHtml(K), m));
                c = false;
                return false
            }
            G.val = I
            ...
            if (u == 1) {
                var q = jm.trim(jm("#M" + a + "siteFormTextArea" + z).val());
                if (A && q == "") {
                    Mobi.ing(jm.format(LS.siteFormSubmitInputIsEmpty, jm.encodeHtml(K)));
                    c = false;
                    return false
                ...
                if (q.length > e) {
                    Mobi.ing(jm.format(LS.siteFormSubmitInputMaxLength, jm.encodeHtml(K), e));
                    c = false;
                    return false
                }
                G.val = q
                ...
                if (u == 2) {
                    var w = document.querySelectorAll("input[name='M" + a + "siteFormRadioR" + z + "']:checked");
                    if (A && w.length == 0) {
                        Mobi.ing(jm.format(LS.siteFormSubmitCheckIsEmpty, jm.encodeHtml(K)));
                        c = false;
                        return false
                    }
                    if (w.length > 0) {
                    ...
                    if (u == 3) {
                        var x = document.querySelectorAll("input[name='M" + a + "siteFormCheckboxR" + z + "']:checked");
                        if (A && x.length == 0) {
                            Mobi.ing(jm.format(LS.siteFormSubmitCheckIsEmpty, jm.encodeHtml(K)));
                            c = false;
                            return false
                        ...
                        if (u == 4) {
                            var B = jm("#M" + a + "siteFormSelect" + z).val();
                            if (A && (B.length == 0 || B == "none")) {
                                Mobi.ing(jm.format(LS.siteFormSubmitCheckIsEmpty, jm.encodeHtml(K)));
                                c = false;
                                return false
                            }
                            ...
                            if (u == 5) {
                                ...
                                if (u == 6) {
                                    var I = jm("#Mobi" + a + "Calendar" + z + "Pluginsinput").val(),
                                        v = C.dateSetting ? C.dateSetting.type : 0,
                                        y = v == 1 ? jm("#Mobi" + a + "Calendar" + z + "Plugins_endinput").val() : "";
                                    if (A && (I == "" || (v == 1 && y == ""))) {
                                        Mobi.ing(jm.format(LS.siteFormSubmitCheckIsEmpty, jm.encodeHtml(K)));
                                        c = false;
                                        return false
                                    ...
                                    if (u == 7) {
                                        var r = jm("#module" + a).find("#siteForm" + a + "fileName" + z);
                                        var H = {};
                                        if (A && r.attr("_tmpFileId") == "") {
                                            Mobi.ing("请选择文件上传");
                                            c = false;
                                            return false
                                        }
                                        if (r.attr("_tmpFileId") == "") {
                                            ...
                                            G.val = r.attr("_fileId");
                                            H.tmpFileName = r.attr("_tmpFileName");
                                            H.fileId = G.val;
                                            H.tmpFileId = r.attr("_tmpFileId");
                                            l.push(H)
                                        }
                                    } else {
                                        if (u == 8) {
                                            var J = jm.trim(jm("#M" + a + "siteFormPhoneInput" + z).val());
                                            if (A && J == "") {
                                                Mobi.ing(jm.format(LS.siteFormSubmitInputIsEmpty, jm.encodeHtml(K)));
                                                c = false;
                                                return false
                                            }
                                            if (!Mobi.isNationMobile(J) && J != "") {
                                                Mobi.ing(LS.mobileNumRegular);
                                                c = false;
                                                return false
                                            }
                                            ...
                                            if (u == 9) {
                                                var F = jm.trim(jm("#M" + a + "siteFormMailInput" + z).val());
                                                if (A && F == "") {
                                                    Mobi.ing(jm.format(LS.siteFormSubmitInputIsEmpty, jm.encodeHtml(K)));
                                                    c = false;
                                                    return false
                                                ...
                                                if (!jm.isEmail(F) && F != "") {
                                                    Mobi.ing(jm.format(LS.memberSignupUserAddItemCorrect, jm.encodeHtml(K)));
                                                    c = false;
                                                    return false
                                                }
                                                G.val = F
                                                ...
                                                if (u == 10) {
                                                    var t = jm.trim(jm("#M" + a + "siteFormIndentityInput" + z).val());
                                                    if (A && t == "") {
                                                        Mobi.ing(jm.format(LS.siteFormSubmitInputIsEmpty, jm.encodeHtml(K)));
                                                        c = false;
                                                        return false
                                                    ...
                                                    if (u == 11) {
                                                        var s = jm("#M" + a + "siteFormAddressInput" + z).val();
                                                        if (A && s == "") {
                                                            Mobi.ing(jm.format(LS.siteFormSubmitInputIsEmpty, jm.encodeHtml(K)));
                                                            c = false;
                                                            return false
    ...
    var f = "pid=" + jm("#bookingPanelTriggle").data("pid") + "&submitContentList=" + jm.encodeUrl(jm.toJSON(h)) + "&vCodeId=" + a + "&validateCode=" + k + "&tmpFileList=" + jm.encodeUrl(jm.toJSON(l));
    Mobi.ing(LS.siteFormSubmitIng, -1);
    jm.ajax({
        type: "get", url: "ajax/booking_h.jsp?cmd=add", data: f, error: function () {
            Mobi.ing(LS.systemError)
        }, success: function (q) {
            q = jm.parseJSON(q);
            if (q.success) {
                ...
                var r = d[b.Def_BookingSubmit_JUMP_URL];
                setTimeout(function () {
                    r.lt == 1 ? (function () {
...
Mobi.genBookingInputStr = function (u, c, h) {
    var s = c.moduleId, k = u.id, a = u.type, v = u.name, m = u.must, d = u.headline, f = u.input;
    b = (u.placeholder == undefined) ? "" : u.placeholder, dateSettingList = [], isIpad = c.isIpad;
    showType = h.content.st;
    var e = f.split("\n");
    var n = "";
    var t = "";
    var q = (u.openAreaCode == undefined) ? true : u.openAreaCode;
    var b = (u.placeholder == undefined) ? "" : u.placeholder;
    if (a == c.Def_ContentList_Type_SINGLE_LINE) {
        t = "<input type='text' class='g_itext' placeholder='" + jm.encodeHtml(b) + "' maxlength='" + c.Def_LIMIT_INPUT_MAXLENTH + "' name='M" + s + "siteFormInput" + k + "' id='M" + s + "siteFormInput" + k + "' />\n"
    } else {
        if (a == c.Def_ContentList_Type_MULTI_LINE) {
            t = "<textArea class='g_textarea fk_formTextareaStyle' placeholder='" + jm.encodeHtml(b) + "' maxlength='" + c.Def_LIMIT_TEXTAREA_MAXLEN + "' id='M" + s + "siteFormTextArea" + k + "' cols='50' rows='3' /></textArea>\n"
        } else {
            if (a == c.Def_ContentList_Type_RADIO) {
                t += "<div class='fk-siteFormItemCheckWrap'>";
                t += "<div class='fk-siteFormItemCheckList'>";
                for (var p = 0; p < e.length; p++) {
                    t += "<div class='siteFormItemCheckItem " + (isIpad ? "fk-siteFormItemCheckItem-isIpad" : "") + "'><input type='radio' id='M" + s + "siteFormRadio" + k + "I" + p + "' name='M" + s + "siteFormRadioR" + k + "' value='" + jm.encodeHtml(e[p]) + "'/><label for='M" + s + "siteFormRadio" + k + "I" + p + "'>" + jm.encodeHtml(e[p]) + "</label></div>\n"
                }
                t += "</div>";
                t += "</div>"
            } else {
                if (a == c.Def_ContentList_Type_MULTIPLECHOICE) {
                    ...
                    t += "<div class='fk-siteFormItemCheckList'>";
                    for (var p = 0; p < e.length; p++) {
                        t += "<div class='siteFormItemCheckItem " + (isIpad ? "fk-siteFormItemCheckItem-isIpad" : "") + "'><input type='checkbox' id='M" + s + "siteFormCheckbox" + k + "I" + p + "' name='M" + s + "siteFormCheckboxR" + k + "' value='" + jm.encodeHtml(e[p]) + "'/><label for='M" + s + "siteFormCheckbox" + k + "I" + p + "'>" + jm.encodeHtml(e[p]) + "</label></div>\n"
                    }
                    t += "</div>";
                    t += "</div>"
                } else {
                    if (a == c.Def_ContentList_Type_DROPDOWN) {
                        t += "<select class='g_selectTag fk-selectStyle' id='M" + c.moduleId + "siteFormSelect" + k + "' name='M" + s + "siteFormSelect" + k + "'>\n";
                        t += "<option value='none'>" + LS.mallPleaseChoose + "</option>";
                        for (var p = 0; p < e.length; p++) {
                            t += "<option value='" + jm.encodeHtml(e[p]) + "'>" + jm.encodeHtml(e[p]) + "</option>\n"
                        }
                        t += "</select>"
                    } else {
                        if (a == c.Def_ContentList_Type_DESC) {
                            t += "<div class='fk-siteFormTextTip fk-siteFormTextTipMain'>" + jm.encodeHtml(d) + "</div>\n";
                            t += "<div class='fk-siteFormTextTip fk-siteFormTextTipSecond'>" + jm.encodeHtml(f) + "</div>\n"
                        } else {
                            if (a == c.Def_ContentList_Type_DATE) {
                                var r = u.dateSetting;
                                var o = (r.type == undefined ? 0 : r.type) == 1;
                                t += "<div class='" + (o ? "fk-startDateInput" : "") + " mobiCalendarPlugins' id='Mobi" + s + "Calendar" + k + "Plugins' val=''></div>\n";
                                if (o) {
                                    t += "<div class='fk-endDateInput mobiCalendarPlugins' id='Mobi" + s + "Calendar" + k + "Plugins_end' val=''></div>\n"
                                }
                            } else {
                                if (a == c.Def_ContentList_Type_FILE_UPLOAD) {
                                    var l = c.isIE;
                                    t += "<div class='fk-uploadComponent'>\n";
                                    t += "<span id='uploadButton" + c.moduleId + k + "'>\n";
                                    if (l) {
                                        t += "<input readonly='readonly' type='button' id='siteForm" + s + "fileUpload" + k + "'  class='uploadify-button' onclick='" + (Fai.top._manageMode ? 'javascript:alert("当前为管理状态，提交无效。");' : "") + "' value='选择文件'/>\n"
                                    } else {
                                        t += "<input readonly='readonly' type='button' class='uploadify-button' onclick='" + (Fai.top._manageMode ? 'javascript:alert("当前为管理状态，提交无效。");' : "") + "' value='选择文件'/>\n"
                                    }
                                    ...
                                    if (a == c.Def_ContentList_Type_PHONE) {
                                        t = "<input onkeyup='(this.v=function(){this.value=this.value.replace(/[^0-9-]+/,\"\");}).call(this)' oninput='if(value.length>11)value=value.slice(0,11);' type='number' class='g_itext' maxlength='11' id='M" + s + "siteFormPhoneInput" + k + "' />"
                                    } else {
                                        if (a == c.Def_ContentList_Type_MAIL) {
                                            t = "<input type='text' class='g_itext' maxlength='20' name='M" + s + "siteFormMailInput" + k + "' id='M" + s + "siteFormMailInput" + k + "' />\n"
                                        } else {
                                            if (a == c.Def_ContentList_Type_IDENTITY) {
                                                t = "<input type='text' class='g_itext' maxlength='18' name='M" + s + "siteFormIndentityInput" + k + "' id='M" + s + "siteFormIndentityInput" + k + "' />\n"
                                            } else {
                                                if (a == c.Def_ContentList_Type_ADDRESS) {
                                                    t = "<input type='text' class='g_itext' placeholder='" + LS.mallPleaseChoose + "' maxlength='20' name='M" + s + "siteFormAddressInput" + k + "' id='M" + s + "siteFormAddressInput" + k + "' />\n"
                                                }
                                            }
                                        }
                                    }
    ...
    if (showType == 1) {
        if (a != 5) {
            n += "<div class='siteFormItem siteFormItemTr f-siteFormItemTr' >\n";
...
Mobi.bookingSubmitPanleEventInit = function (a) {
    var b = a.moduleId;
    jm.each(a.contentList, function (k, h) {
        if (h.hide) {
            return true
        }
        var q = h.id, m = h.type;
        if (m == a.Def_ContentList_Type_DATE) {
            var l = h.dateSetting;
            var p = (l.type == undefined ? 0 : l.type) == 1;
            ...
            jm("<span class='fk-dateRangeUtil' id='Mobi" + b + "CalendarInput" + q + "'>" + LS.to + "</span>\n").insertAfter("#module" + b + " #siteFormItem" + q + " .fk-dateInputMaskWrap")
        } else {
            if (m == a.Def_ContentList_Type_FILE_UPLOAD) {
                if (Fai.top._manageMode) {
                    return true
                }
                var e = a.isIE;
                ...
                if (e) {
                    Mobi.siteFormFileUpload(srcjQuery, size, id, q, b, fileTypeList, srcUpload, "选择文件")
                } else {
                    if (Fai.top._cid == 11496535) {
                        Mobi.siteFormFileUploadHtml(q, b, fileTypeList, a.isOverLimit, a.updateUrlViewRes, a.mobiVer, fileSize, a.srcjQuery, a.srcUploadjQuery, "www.jihosen.icoc.me", LS.mobiFormSubmitFileUploadReSelect)
                    } else {
                        Mobi.siteFormFileUploadHtml(q, b, fileTypeList, a.isOverLimit, a.updateUrlViewRes, a.mobiVer, fileSize, a.srcjQuery, a.srcUploadjQuery, a.siteMainDomain, LS.mobiFormSubmitFileUploadReSelect)
                    }
                }
            } else {
                if (m == a.Def_ContentList_Type_ADDRESS) {
                    var o, f = a.currentLcid;
                    if (f == 2052 || f == 1028) {
                        o = site_cityUtil.getProvince()
                    } else {
                        o = site_cityUtil.getProvinceEn()
                    }
                    var c = new MobileSelectArea();
                    c.init({
                        level: h.openMunicipalCode ? 3 : 2,
                        lcid: f,
                        trigger: "#M" + a.moduleId + "siteFormAddressInput" + q + "",
                        value: jm("#M" + a.moduleId + "siteFormAddressInput" + q + "").data("value"),
                        data: o,
                        eventName: "click",
                        init: 0
                    })
...
Mobi.fixPorductDetailStyle = function (b) {
    var c = jm("#productNewDetailPanel" + b), a = c.find(".J_pricePlaceHolder"), e = c.find(".mallThemeProductWrap"),
...
Mobi.showMapService = function () {
    var a = Fai.top._onlineServiceJson.map, b = a.city + a.d_address;
    if (b == "") {
        b = "附近"
    }
    if (!b) {
...
Mobi.unloadForATag = function () {
    if (!jm.os.supportsTouch) {
        jm("#g_body").delegate("#customerServiceDiv a", "click", function (k) {
            var h = k.target || k.srcElement;
            var f = h.parentNode.parentNode.parentNode;
            var b = Fai.top._onlineServiceJson, a;
            if (!f) {
                return
            }
...
Mobi.showJumpPhone = function () {
    if (Fai.top._onlineServiceJson.phone.phoneInfo.length >= 1) {
        ...
        for (var H = 0; H < Fai.top._onlineServiceJson.phone.phoneInfo.length; H++) {
            var M = H + 1;
            var e = decodeURIComponent(Fai.top._onlineServiceJson.phone.phoneInfo[H].name);
            ...
            var a = document.getElementById("phoneNumber" + M);
        ...
        if (v > N) {
            c.style.height = (document.documentElement.clientHeight - k.offsetHeight) + "px"
        }
        if (Mobi.deviceTypeIsMobi()) {
...
Mobi.mallServiceList = function () {
    ...
    var n = "<div class='serviceFullBg'></div>", h, d, p, c = "", o = "", a = "", f, m, e;
    ...
    for (h = 0, d = b.length; h < d; h++) {
        ...
        o = p.color ? ("color:" + p.color + ";") : "";
        if (showType) {
            if (p.serviceType == 0) {
                n += "<div class='serviceItem qqServiceLine'>";
                n += "<a id='qqServiceItem" + h + "' target='_blank' href='http://wpa.qq.com/msgrd?v=3&uin=" + p.serviceAccount + "&site=qq&menu=yes'>";
                n += "<div class='serviceIcon'><span style='" + a + o + ";' class=' serviceIconText " + c + "'></span></div>";
                n += "<div class='serviceName'><span class='serviceNameText'>" + p.showFont + "</span></div>";
                n += "<div class='serviceNumber'><span class='serviceNumberText'>" + p.serviceAccount + "</span></div>";
                n += "</a>";
                n += "</div>"
            } else {
                if (p.serviceType == 1) {
                    n += "<div class='serviceItem weChatServiceLine'>";
                    n += "<a id='weChatServiceItem" + h + "' href='javascript:;' onclick='Mobi.showWeChatService(\"" + p.code + "\")'>";
                    n += "<div class='serviceIcon'><span style='" + a + o + "' class=' serviceIconText " + c + "'></span></div>";
                    n += "<div class='serviceName'><span class='serviceNameText'>" + p.showFont + "</span></div>";
                    n += "<div class='serviceNumber'><span class='serviceNumberText'></span></div>";
                    n += "</a>";
                    n += "</div>"
                } else {
                    if (p.serviceType == 2) {
                        ...
                        n += "<a id='phoneServiceItem" + h + "' href='tel:" + p.serviceAccount + "'>";
                        n += "<div class='serviceIcon'><span style='" + a + o + "' class=' serviceIconText " + c + "'></span></div>";
                        n += "<div class='serviceName'><span class='serviceNameText'>" + p.showFont + "</span></div>";
                        n += "<div class='serviceNumber'><span class='serviceNumberText'>" + p.serviceAccount + "</span></div>";
                        n += "</a>";
...
Mobi.notMallServiceList = function () {
    var q = Fai.top._onlineServiceJson.phone, n = Fai.top._onlineServiceJson.qq;
    var p = q && q.phoneInfo && q.phoneInfo.length > 0, m = n && n.qqInfo && n.qqInfo.length > 0;
    if (!p && !m && !q.open && !n.open) {
        return
    }
    var o = "<div class='serviceFullBg'></div>", f, c, s, b = "", r = "", a = "", e, k, d;
    o += "<div id='J_serviceListPanel' class='serviceListPanel'>";
    if (p && q.open) {
        b = q.baseSetting.classname;
        e = q.baseSetting.colIconCusType;
        k = q.baseSetting.colIconType;
        if (k != 2) {
            b = q.baseSetting.classname + " icon-phoneServiceIcon"
        } else {
            d = q.baseSetting.iconFilePath;
            a = "background-image:url(" + d + ");"
        }
        r = q.baseSetting.color ? ("background-color:" + q.baseSetting.color + ";") : "";
        for (f = 0, c = q.phoneInfo.length; f < c; f++) {
            s = q.phoneInfo[f];
            o += "<div class='serviceItem phoneServiceLine'>";
            o += "<a id='phoneServiceItem" + f + "' href='tel:" + s.number + "'>";
            o += "<div class='serviceIcon'><span style='" + a + r + "' class='phoneServiceIcon serviceIconText " + b + "'></span></div>";
            o += "<div class='serviceName'><span class='serviceNameText'>" + s.name + "</span></div>";
            o += "<div class='serviceNumber'><span class='serviceNumberText'>" + s.number + "</span></div>";
            o += "</a>";
            o += "</div>"
        }
    }
    ...
    r = "";
    if (m && n.open) {
        b = n.baseSetting.classname;
        e = n.baseSetting.colIconCusType;
        k = n.baseSetting.colIconType;
        if (k != 2) {
            b = n.baseSetting.classname + " icon-qqServiceIcon"
        } else {
            d = n.baseSetting.iconFilePath;
            a = "background-image:url(" + d + ");"
        }
        r = n.baseSetting.color ? ("background-color:" + q.baseSetting.color + ";") : "";
        for (f = 0, c = n.qqInfo.length; f < c; f++) {
            s = n.qqInfo[f];
            o += "<div class='serviceItem qqServiceLine'>";
            o += "<a id='qqServiceItem" + f + "' target='_blank' href='http://wpa.qq.com/msgrd?v=3&uin=" + s.number + "&site=qq&menu=yes'>";
            o += "<div class='serviceIcon'><span style='" + a + r + ";' class='qqServiceIcon serviceIconText " + b + "'></span></div>";
            o += "<div class='serviceName'><span class='serviceNameText'>" + s.name + "</span></div>";
            o += "<div class='serviceNumber'><span class='serviceNumberText'>" + s.number + "</span></div>";
            o += "</a>";
            o += "</div>"
    ...
    o += "<div id='cancleSer' class='cancleSer'>" + LS.cancel + "</div>";
    o += "</div>";
...
Mobi.unLoadForWechat = function () {
    ...
    var b = e.querySelectorAll("a"), c = false;
    ...
    if (c) {
        e.onclick = function (f) {
            var o = f.target;
            var h = jm(o).parents("a").attr("href");
            var p;
            if (h.indexOf("mailto:") !== -1 && Mobi.getPreviewWindow().Mobi.isWechat()) {
                f.stopPropagation();
                f.preventDefault();
                var n = window, s = document, m = s.querySelector("body"), t = s.querySelector(".fk-unloadForWechatBg"),
                    q = t ? t.querySelector(".fk-unloadForWechat") : null, r = q ? q.querySelector(".f-cross") : null,
                    l = n._htmlFontSize / 40;
                m.ontouchmove = function (u) {
                    u.preventDefault()
                };
                if (t == null) {
                    p = "<div class='fk-unloadForWechatBg'>";
                    p += "  <div class='fk-unloadForWechat'>";
                    p += "      <div class='f-crossWrap'>";
                    p += "          <div class='f-cross'></div>";
                    p += "      </div>";
                    p += "      <div class='f-tipImgWrap'>";
                    p += "          <div class='f-tipImg'></div>";
                    p += "      </div>";
                    p += "      <p>微信暂不支持发送邮件功能</p>";
                    p += "      <p>请到浏览器打开！</p>";
                    p += "  </div>";
                    p += "</div>";
                    jm(p).appendTo(jm("body"));
                    s = document;
                    t = s.querySelector(".fk-unloadForWechatBg");
                    q = t.querySelector(".fk-unloadForWechat");
                    r = q.querySelector(".f-cross");
                    q.querySelector(".f-tipImg").style.transform = "scale(" + l + ", " + l + ") ";
                    r.style.transform = "scale(" + l + ", " + l + ")";
                    q.style.top = (n.screen.availHeight - q.clientWidth) / 2 - 60 + "px";
                    q.style.left = (n.screen.availWidth - q.clientWidth) / 2 + "px";
                    r.onclick = k
                } else {
...
Mobi.showBaiduBridge = function () {
    if (Mobi.isOpenBaiduBridge()) {
        ...
        if (Fai.top._manageMode) {
            ...
            var b = Fai.top.Fai.popupWindow({title: "温馨提示", divContent: a, width: 374, height: 88});
            var c = function () {
                Fai.top.Fai.closePopupWindow(b)
            };
            Fai.top.Fai.addPopupWindowBtn(b, {id: "save", text: "知道了", extClass: "saveButton", click: c})
        } else {
            alert("未接入百度商桥")
        }
    }
...
Mobi.initLocater = function () {
    ...
    if (!b) {
        ...
        jm(document).unbind("click").bind("click", function (l) {
            var k = l.target || l.srcElement;
            if (k.id === "multiLanguageCtrl") {
                return
            }
            var m = jm(k);
            if (m.closest("#lanSelect").length == 0) {
                Mobi.closeLanSelect()
            }
            l.stopPropagation()
        });
...
Mobi.languageCtrl = function () {
    ...
    var a = Mobi.getTransitionEndEventName(), c = "";
    if (Fai.top._manageMode) {
        setTimeout(function () {
...
Mobi.initFooterLanguageEvent = function () {
    ...
    var e = jm("#footer"), d = e.find(".languageVis"), a = e.find(".languageFullBg"), c = e.find(".languageListPanel");
...
Mobi.optionsStr = {};
Mobi.mallBuying = {};
Mobi.mallBuy = function (q, o, b, w, a, f) {
    if (typeof(Mobi.mallBuying[q]) == "undefined") {
        Mobi.mallBuying[q] = false
    }
    var n = false;
    jm.each(Mobi.mallBuying, function (A, z) {
        if (z) {
            n = true;
            return false
        }
    ...
    Mobi.mallBuying[q] = true;
    jm("#productNum").change();
    var p = "id=" + q + "&fromDetail=true", v = [], t = jm(".J-op"), m = true;
    if (b == 1) {
        t = jm("#productMallOptionPanel" + q + "[moduleId='" + w + "'] .J-op")
    }
    var d = false;
    if (!!a) {
        p += "&optionList=" + jm.encodeUrl(jm.toJSON(a))
    } else {
        jm(t).each(function () {
            if (d) {
                return
            }
            var D = jm(this), A = D.attr("option_name"), C = D.attr("data"), B = D.attr("type"),
                z = D.attr("option_data");
            if (z) {
                var E = {};
                E.name = C;
                E.value = parseInt(z);
                if (B != null) {
                    E.name = C.replace(/^opIndept/, "");
                    E.type = parseInt(B)
                }
                v.push(E);
                d = false
            } else {
                Mobi.ing(jm.format(LS.mallCartChoiceItemError, jm.encodeHtml(A)));
                d = true;
                m = false;
                return false
            }
        ...
        if (Mobi.optionsStr[x] != "null" && Mobi.optionsStr[x]) {
            var k = Mobi.optionsStr[x].split("_"), y = [];
            for (var s = 0; s < k.length; s++) {
        ...
        if (v.length > 0) {
            p += "&optionList=" + jm.encodeUrl(jm.toJSON(v))
        }
    }
    var c = jm("#productNum");
    if (jm("#productMallOptionPanel" + q + " #productNum").length != 0) {
        c = jm("#productMallOptionPanel" + q + " #productNum")
    }
    var h = c.val(), l = 1;
    if (jm.isInteger(h)) {
        l = parseInt(h)
    ...
    var e = "addCartItem";
    if (o === 1) {
        var u = {pid: q, amount: l, optList: jm.toJSON(a)};
        if (u.optList == null || u.optList.length == 0 || !u.optList) {
            u.optList = jm.toJSON(v)
        }
        e = "addIme";
        p += "&codata=" + jm.toJSON(u)
    }
    jm.ajax({
        type: "post", url: "ajax/order_h.jsp?cmd=" + e, data: p, error: function () {
            Mobi.ing(LS.systemError);
            Mobi.mallBuying[q] = false
        }, success: function (z) {
            var C = jm.parseJSON(z);
            if (C.success) {
                if (o === 1) {
                    if (window.self != window.top && /(iPhone|iPad|iPod|safari)/i.test(navigator.userAgent.toLowerCase())) {
                        location.href = "mstl.jsp?immeData=" + jm.encodeUrl(jm.toJSON(u))
                    } else {
                ...
                if (C.rt == Mobi.MallAjaxErrno.authMemberNotAllow) {
                    Mobi.ing(C.data + LS.authLevelBuy)
                } else {
                    if (C.rt == Mobi.MallAjaxErrno.login) {
                        var A = {};
                        A.buyType = o;
                        A.productId = q;
                        A.entry = b;
                        A.moduleId = w;
                        A.option = jm.toJSON(v);
                        A.count = l;
                        localStorage.setItem("mallBuyCallBack", jm.toJSON(A));
                        var B = "login.jsp?returnUrl=" + jm.encodeUrl(jm.getUrlRoot(location.href)) + "&errno=11";
                        location.href = B
                    } else {
                        Mobi.returnMallErrorMsg(C.rt)
                    }
                }
                Mobi.mallBuying[q] = false
            }
...
Mobi.mallCartAmountChange = function (a, c, k, h, m, b, l) {
    var n = jm(".itemLine" + a);
    var d = n.find(".buyNumber");
    var f = d.val();
    var e = 1;
    if (jm.isInteger(f)) {
        e = parseInt(f)
    ...
    if (e < h || e == h) {
        e = h;
        n.find(".icon-minisIcon").addClass("g_opacity50");
        n.find(".icon-plusIcon").removeClass("g_opacity50")
    } else {
        if ((e > m || e == m) && m != 0) {
            e = m;
...
Mobi.mallCartAmountPlus = function (a, b, d, l, k, p, c, m) {
    if (jm(a).attr("disabled") != "true") {
        var o = jm(".itemLine" + b);
        var e = o.find(".buyNumber");
        var h = e.val();
        if (jm.isInteger(h)) {
            h = parseInt(h) + 1
        }
        if (h < 2) {
            ...
            if ((h > p || h == p) && p != 0) {
                h = p;
                o.find(".icon-plusIcon").addClass("g_opacity50 ");
                if (k != p) {
                    o.find(".icon-minisIcon").removeClass("g_opacity50")
                }
            } else {
                if (m && (h > c)) {
                    h = c;
        ...
        Mobi.ajaxChangeAmount(h, d, l);
        e.val(h);
        var n = LS.pay;
        var f = Mobi.countSelectNum();
        if (jm(".J_select").length != 0) {
            jm(".cartSettle").val(n + "(" + f + ")")
        }
        if (h > 1) {
            o.find(".icon-minisIcon").removeAttr("disabled")
        } else {
            o.find(".icon-minisIcon").attr("disabled", "true")
        }
    } else {
        return
    }
};
Mobi.mallCartAmountMinis = function (a, b, c, k, h, m) {
    var n = jm(".itemLine" + b);
    var d = n.find(".buyNumber");
    var f = d.val();
    if (jm.isInteger(f)) {
    ...
    if (f == 0) {
        ...
        Mobi.ajaxChangeAmount(f, c, k);
        d.val(f);
        var l = LS.pay;
        var e = Mobi.countSelectNum();
        if (jm(".J_select").length != 0) {
            jm(".cartSettle").val(l + "(" + e + ")")
        }
        if (f > 1) {
            n.find(".icon-minisIcon").removeAttr("disabled")
        } else {
...
Mobi.countItsSaveMoney = function () {
    var b = 0;
    var a = [];
    jm(".J_select").each(function (m, c) {
        var k = jm.parseJSON(jm(this).attr("saleInfo"));
        if (k == null || k == "{}" || k == {}) {
            return
        }
        var u = 0;
        if (typeof(k) != "undefined" && k != null && Mobi.checkSaleProVal(k)) {
            var l = k.other.ruleData.d;
            var f = k.id;
            if (k.saleType == 2 && k.other.ruleData.s == "1") {
                var p = jm(this).find(".buyNumber").val() || 1;
                var r = jm(this).find(".mall_product").attr("price") || 0;
                var o = parseFloat(p) * parseFloat(r);
                var q = 0;
                jm.each(l, function (v, n) {
                    if (o >= n.m) {
                        q = n.n
                    }
                });
                ...
                if (k.saleType == 2 && k.other.ruleData.s == "2") {
                    if (jm.inArray(k.id, a) < 0) {
                        var e = 0;
                        a.push(f);
                        jm(".J_select[promotionid='" + f + "']").each(function (w, z) {
                            var y = jm(this).find(".buyNumber").val() || 1;
                            var v = jm(this).find(".mall_product").attr("price") || 0;
                            var x = parseInt(y) * parseFloat(v);
                            e += x
                        });
                        var t = 0;
                        var h = 0;
                        for (var m = 0; m < l.length; m++) {
                            var s = parseFloat(l[m].m);
                            var d = parseFloat(l[m].n);
                            if (s <= 0) {
                                s = 0;
                                d = 0
                            }
...
Mobi.reCtOrderMoney = function () {
    ...
    var e = 0;
    b.each(function () {
        var l = parseFloat(jm(this).attr("price"), 2);
...
Mobi.initModuleMallAddrInfo = function (z, J, P, t, F) {
    var n = LS.mallPleaseChoose, H = [], O, m, s, f, v, x, I;
    ...
    jm("#areaBox").unbind("click").bind("click", function (S) {
        var R = S.target.className;
        if (!R) {
            return
        }
        if (jm.inArray("areaBox", R.split(" ")) >= 0) {
            jm("#areaBoxClose").click();
            jm("#areaBox1").hide();
            jm("#areaBox2").hide()
        }
    ...
    var h = "";
    jm.each(site_cityUtil.getAreaGroupsPinYin(), function (R, S) {
        h += "<div class='pv_group' style='" + (S[0] == "OS" ? "display:none;" : "") + "'>";
        h += "<div class='group_head'>" + S[0] + "</div>";
        h += "<div class='group_content'>";
        jm.each(S[1], function (U, T) {
            if (t == 2052 || t == 1028) {
                h += "<div class='group_item' pid='" + T + "' pname='" + site_cityUtil.getInfo(T).name + "'>" + site_cityUtil.simpleProvinceNameStr(site_cityUtil.getInfo(T).name) + "</div>"
            } else {
                h += "<div class='group_item' pid='" + T + "' pname='" + site_cityUtil.getInfoEn(T).name + "'>" + site_cityUtil.simpleProvinceNameStrEn(site_cityUtil.getInfoEn(T).name) + "</div>"
            }
        });
        h += "</div>";
        h += "</div>"
    ...
    jm("#allArea").change(function () {
        ...
        if (jm("#allArea").val() == "zh" || jm("#allArea").val() == "os") {
            ...
            var R = u(jm("#allArea").val());
            jm("#sec_box .sec_content").append(R);
            jm("#areaBoxInput").val(jm("#areaBoxInput").val() + jm("#allArea option[value='" + jm("#allArea").val() + "']").text());
            jm(".J_ssq").hide();
            jm(".J_administrativeRegion").show();
    ...
    jm("#province_box .group_item").bind("click", function () {
        jm("#areaBox1 .city_content").remove();
        jm("#areaBox1 .county_content").remove();
        var R = jm(this).attr("pname");
        var S = jm(this).attr("pid");
        jm("#areaBox1 .J_areaHead .city").click();
        jm("#areaBoxInput").val("");
        jm("#areaBoxInput").val(jm("#areaBoxInput").val() + R);
        jm("#areaBoxInput").removeAttr("lastArea");
        jm("#areaBoxInput").removeAttr("lastAreaType");
        jm("#areaBoxInput").attr("area1", S);
        jm("#areaBoxInput").attr("area2", "");
        jm("#areaBoxInput").attr("area3", "");
        jm("#areaBoxInput").attr("area4", "");
        var U = "";
        if (t == 2052 || t == 1028) {
            U = c(site_cityUtil.getCities(S))
        } else {
            U = c(site_cityUtil.getCitiesEn(S))
        }
        var T = jm(U).html();
        ...
        jm("#city_box").append(U);
        jm("#mallShipTemplate_province_box .group_item[pid='" + S + "']").click()
    });
    jm("#city_box").delegate(".group_item", "click", function () {
        jm("#areaBox1 .county_content").remove();
        ...
        jm("#areaBox1 .J_areaHead .county").click();
        var W = jm("#areaBoxInput").attr("lastArea");
        ...
        jm("#areaBoxInput").attr("lastAreaType", "city");
        jm("#areaBoxInput").attr("area2", T);
        jm("#areaBoxInput").attr("area3", "");
        jm("#areaBoxInput").attr("area4", "");
        var V = "";
        if (t == 2052 || t == 1028) {
            V = r(site_cityUtil.getCounty(T))
        } else {
            V = r(site_cityUtil.getCountyEn(T))
        }
        var U = jm(V).html();
        ...
        jm("#county_box").append(V);
        jm("#mallShipTemplate_city_box .group_item[cid='" + T + "']").click()
    });
    jm("#county_box").delegate(".group_item", "click", function () {
        jm("#areaBox1 .street_content").remove();
        var S = jm(this).attr("cname");
        var U = jm(this).attr("cid");
        var W = jm("#areaBoxInput").attr("lastArea");
        var T = jm("#areaBoxInput").attr("lastAreaType");
        jm("#areaBox1 .J_areaHead .street").click();
        if (T != null && (T == "street" || T == "county")) {
            jm("#areaBoxInput").val(jm("#areaBoxInput").val().substring(0, jm("#areaBoxInput").val().indexOf("-", jm("#areaBoxInput").val().indexOf("-") + 1)))
        }
        jm("#areaBoxInput").val(jm("#areaBoxInput").val() + "-" + S);
        jm("#areaBoxInput").attr("lastArea", "-" + S);
        jm("#areaBoxInput").attr("lastAreaType", "county");
        jm("#areaBoxInput").attr("area3", U);
        jm("#areaBoxInput").attr("area4", "");
        var R = "";
        if (t == 2052 || t == 1028) {
            R = Q(site_cityUtil.getStreet(U))
        } else {
            R = Q(site_cityUtil.getStreetEn(U))
        }
        var V = jm(R).html();
        ...
        jm("#street_box").append(R);
        jm("#mallShipTemplate_county_box .group_item[cid='" + U + "']").click()
    });
    jm("#street_box").delegate(".group_item", "click", function () {
        var R = jm(this).attr("cname");
        var T = jm(this).attr("cid");
        ...
        var S = jm("#areaBoxInput").attr("lastAreaType");
        if (S != null && S == "street") {
            jm("#areaBoxInput").val(jm("#areaBoxInput").val().replace(U, ""))
        }
        jm("#areaBoxInput").val(jm("#areaBoxInput").val() + "-" + R);
        jm("#areaBoxInput").attr("lastArea", "-" + R);
        jm("#areaBoxInput").attr("lastAreaType", "street");
        jm("#areaBoxInput").attr("area4", T);
        jm("#areaBox1").hide();
        jm("#areaBoxClose").click();
        jm("#mallShipTemplate_street_box .group_item[cid='" + T + "']").click()
    });
    jm("#sec_box").delegate(".group_item", "click", function () {
        jm("#areaBox2 .thd_content").html("");
        var R = jm(this).attr("cname");
        ...
        var S = jm("#areaBoxInput").attr("lastAreaType");
        if (S != null && S != "" && jm("#areaBoxInput").val().indexOf("-") != -1) {
            jm("#areaBoxInput").val(jm("#areaBoxInput").val().substring(0, jm("#areaBoxInput").val().indexOf("-")))
        }
        jm("#areaBoxInput").val(jm("#areaBoxInput").val() + "-" + R);
        jm("#areaBoxInput").attr("lastArea", "-" + R);
        ...
        jm("#thd_box .thd_content").append(U);
        jm("#mallShipTemplate_sec_box .group_item[cid='" + T + "']").click()
    });
    jm("#thd_box").delegate(".group_item", "click", function () {
        var R = jm(this).attr("cname");
        var T = jm(this).attr("cid");
        ...
        jm("#areaBox2").hide();
        jm("#areaBoxClose").click();
        jm("#mallShipTemplate_thd_box .group_item[cid='" + T + "']").click()
    });
    jm("#addrInfo_street").change(function (R) {
            ...
            if (jm("#mallShipTemplate_province").length == 1 && d.addr_info != null) {
                ...
                if (!p) {
                    ...
                    if (d.addr_info.provinceCode == 990000) {
                        ...
                        jm("#mallShipTemplate_allArea").val("zh");
                        jm("#mallShipTemplate_allArea").change()
                    }
    ...
    jm("#addrInfo").delegate(".addrInfo .info_name", "click", function () {
        var X = jm(this).parent().attr("_item");
        var T = J[X];
        for (var U = 0; U < P.length; U++) {
            var R = P[U].fieldKey;
            if (R == "name") {
                jm("#info_name").text(T.name)
            }
            if (R == "phone") {
                jm("#info_phone").text(T.phone)
            } else {
                if (R == "mobile") {
                    jm("#info_phone").text(T.mobile)
                }
            }
            if (R == "addr") {
                var V = jm("#info_addr").attr("ismalltheme");
                jm("#info_addr").text((V ? LS.orderAddr + "：" : "") + T.addr)
            }
        }
        jm("#assignItemline").attr("_index", X);
        if (Fai.top._templateFrameId >= 2000 && Fai.top._templateFrameId < 3000) {
            if (T.isDefault == 1) {
        ...
        if (jm("#mallShipTemplate_province").length == 1 && T.addr_info != null) {
            var Z = T.addr_info["isCus"];
            if (!Z) {
                var S = "";
                var ab = "";
                var Y = "";
                var W = "";
                if (t == 2052 || t == 1028) {
                    S = site_cityUtil.getInfo(T.addr_info.streetCode).name;
                    ab = site_cityUtil.getInfo(T.addr_info.countyCode).name;
                    Y = site_cityUtil.getInfo(T.addr_info.cityCode).name;
                    W = site_cityUtil.getInfo(T.addr_info.provinceCode).name
                } else {
                    S = site_cityUtil.getInfoEn(T.addr_info.streetCode).name;
                    ab = site_cityUtil.getInfoEn(T.addr_info.countyCode).name;
                    Y = site_cityUtil.getInfoEn(T.addr_info.cityCode).name;
                    W = site_cityUtil.getInfoEn(T.addr_info.provinceCode).name
                }
                if (T.addr_info.provinceCode == 990000) {
                    jm("#mallShipTemplate_areaBoxInput").attr("isOs", 1);
                    jm("#mallShipTemplate_allArea").val("os");
                    jm("#mallShipTemplate_allArea").change()
                } else {
                ...
                jm("#mallShipTemplate_areaBoxInput").attr("area1", T.addr_info.provinceCode);
                jm("#mallShipTemplate_areaBoxInput").attr("area2", T.addr_info.cityCode);
                jm("#mallShipTemplate_areaBoxInput").attr("area3", T.addr_info.countyCode);
                jm("#mallShipTemplate_areaBoxInput").attr("area4", T.addr_info.streetCode);
                jm("#mallShipTemplate_areaBox1 .group_item[pid='" + T.addr_info.provinceCode + "']").click();
                jm("#mallShipTemplate_areaBox1 .group_item[cid='" + T.addr_info.cityCode + "']").click();
                jm("#mallShipTemplate_areaBox1 .group_item[cid='" + T.addr_info.countyCode + "']").click();
                jm("#mallShipTemplate_areaBox1 .group_item[cid='" + T.addr_info.streetCode + "']").click()
            } else {
                jm("#mallShipTemplate_allArea").val(T.addr_info.provinceCode);
                jm("#mallShipTemplate_allArea").change();
                jm("#mallShipTemplate_areaBox2 .group_item[cid='" + T.addr_info.cityCode + "']").click();
                jm("#mallShipTemplate_areaBox2 .group_item[cid='" + T.addr_info.countyCode + "']").click()
            }
            jm("#edit_addrDetal").val(T.addr_info["streetAddr"])
        }
        if (jm("#mallShipTemplate_province").length == 1 && T.addr_info == null) {
        ...
        for (var U = 0; U < P.length; U++) {
            ...
            var aa = T[R];
            jm(".orderSettle").find(".propItemValue").each(function () {
                if (jm(this).attr("_field") == R) {
                    jm(this).val(aa)
                }
                if ("mobile" == R) {
                    if ("mobileCt" in T) {
                        if (T.mobileCt != null && T.mobileCt != "") {
                            jm("#mobileCt").val(T.mobileCt)
                        }
                    }
                }
            })
    ...
    var D = J, C = "", y = "", q = D.length, B = false;
    var k = {};
    jm("#addrInfoList .orderAddAddrInfo").click(function () {
        B = true;
        jm("#editAddrInfo").find(".propItemValue").each(function () {
    ...
    jm("#addrInfo").delegate(".edit", "click", function () {
        ...
        if (Y != null) {
            ...
            if (!U) {
                ...
                var S = "";
                if (t == 2052 || t == 1028) {
                    X = site_cityUtil.getInfo(Y.streetCode).name;
                    V = site_cityUtil.getInfo(Y.countyCode).name;
                    T = site_cityUtil.getInfo(Y.cityCode).name;
                    S = site_cityUtil.getInfo(Y.provinceCode).name
                } else {
                    X = site_cityUtil.getInfoEn(Y.streetCode).name;
                    V = site_cityUtil.getInfoEn(Y.countyCode).name;
                    T = site_cityUtil.getInfoEn(Y.cityCode).name;
                    S = site_cityUtil.getInfoEn(Y.provinceCode).name
                }
                if (Y.provinceCode == 990000) {
                    jm("#areaBoxInput").attr("isOs", 1);
                    jm("#allArea").val("os");
                    jm("#allArea").change()
                } else {
                ...
                jm("#areaBoxInput").attr("area1", Y.provinceCode);
                jm("#areaBoxInput").attr("area2", Y.cityCode);
                jm("#areaBoxInput").attr("area3", Y.countyCode);
                jm("#areaBoxInput").attr("area4", Y.streetCode);
                jm("#areaBox1 .group_item[pid='" + Y.provinceCode + "']").click();
                jm("#areaBox1 .group_item[cid='" + Y.cityCode + "']").click();
                jm("#areaBox1 .group_item[cid='" + Y.countyCode + "']").click();
                jm("#areaBox1 .group_item[cid='" + Y.streetCode + "']").click()
            } else {
                jm("#allArea").val(Y.provinceCode);
                jm("#allArea").change();
                jm("#areaBox2 .group_item[cid='" + Y.cityCode + "']").click();
                jm("#areaBox2 .group_item[cid='" + Y.countyCode + "']").click()
            }
            jm("#addrInfo_street").val(Y.streetAddr)
        } else {
            jm("#addrInfo_street").val(R.addr)
        }
        var W = R.isDefault
    });
        ...
        jm.ajax({
            ...
            success: function (V) {
                ...
                if (W.success) {
                    ...
                    jm(S).find(".text").text(LS.mallDefault);
                    jm(S).parents(".addrInfo").find(".cutOut").css("display", "none");
                    var U = jm(S).parents(".addrInfo");
                    D[jm(U).attr("_item")]["isDefault"] = 1
                } else {
                    Mobi.ing(W.msg)
                }
            }
    ...
    jm("#addrInfo").delegate(".cutOut", "click", function () {
        var T = jm(this);
        y = T.parents(".selectedArea").parent().attr("_item");
        k.opera = "delAddr";
        k._item = y;
        var R = function (U, V) {
            jm.ajax({
                type: "post",
                url: "ajax/member_h.jsp?cmd=set&id=" + U,
                data: "info=" + jm.encodeUrl(jm.toJSON(k)),
                error: function () {
                    Mobi.ing(LS.systemError)
                },
                success: function (W) {
                    var Y = jm.parseJSON(W);
                    if (Y.success) {
                        jm("#mobiPrompt").remove();
                        jm("#mobiPrompt_Bg").remove();
                        var X = 0;
                        jm("#addrInfoList").find(".addrInfo").each(function () {
                            if (jm(this).attr("_item") == V) {
                                jm(this).remove()
                            } else {
                                jm(this).attr("_item", X);
                                X++
                            }
                        });
                        q--;
    ...
    jm(".orderSaveAddrInfo").click(function () {
        ...
        var ac = "";
        var Y = false;
        V.parent().find(".propItemValue").each(function () {
            ...
            if (ag == "mobile" && R.length > 0) {
                if (!Mobi.isNationMobile(R)) {
                    Mobi.ing(LS.mobileNumRegular);
                    this.focus();
                    R = "";
                    af = false
                }
                ai.mobileCt = jm(this).parent().find("#mobileCt").val()
            }
            if (ag == "mobile" && R.length <= 0) {
                ai.mobileCt = ""
            }
                    ...
                    if (an.success) {
                        ...
                        if (C == "editAddr") {
                            if (jm("#assignItemline").attr("_index") == y) {
                                var aq = ai;
                                jm("#info_name").text(aq.name);
                                jm("#info_phone").text(aq.phone);
                                jm("#assignItemline").attr("_index", y);
                                if (aq.addr == null) {
                                    jm("#info_addr").text("")
                                } else {
                                    jm("#info_addr").text(aq.addr)
                                }
                            }
                            var ak;
                            if (ah) {
                                jm("#addrInfoList").find(".addrInfo").each(function () {
                                    ...
                                    if (jm(this).attr("_item") == y) {
                                        jm(this).find(".name").text(ai.name);
                                        jm(this).find(".phone").text(am);
                                        jm(this).find("#addr").text(ai.addr);
                                        ak = jm(this)
                                    }
                                })
                            } else {
                            ...
                            if (C == "addAddr") {
                                ...
                                var ap = D.length;
                                var al = [];
                                al.push("<div class='addrInfo' _item=" + ap + ">");
                                al.push("<div class='" + (ah ? "" : "middle") + " info_name' style='width:100%;'>");
                                al.push("<div class='nameAndPhone'><span class='name'>" + ai.name + "</span><span class='phone'>" + am + "</span></div><div class='address'><span id='addr'>" + ai.addr + "</span></div>");
                                al.push("</div>");
                                al.push("<div class='selectedArea' style='width: 100%;float:left;'>");
                                al.push("<div class='left'>");
                                al.push("<div class='selectedDiv'><label for='input" + ap + "'><input type='radio' class='checkbox-comp' id='input" + ap + "' name='defaultLogo'><span class='text'>设为默认</span></label></div>");
                                al.push("</div>");
                                al.push("<div class='right'>");
                                al.push("<div class='edit' _index=" + ap + "><span>编辑</span></div><div class='cutOut'><span>删除</span></div>");
                                al.push("</div>");
                                al.push("</div>");
                                al.push("</div>");
                                jm("#addrInfo").append(al.join(""));
                                D.push(ai);
                                jm("#editAddrInfo .g_close").click();
                                jm(".addrInfo").each(function () {
...
Mobi.initModuleMallShipTemplate = function (A, b, C, n, t, p, c) {
    var h = C.vType || 1, v = C.sco || 0, e = C.openItemList;
    var s = LS.mallPleaseChoose, z = [], l, B, q, x, D, o, y;
    var f = true;
    site_cityUtil.initProvinces(t);
    ...
    jm("#mallShipTemplate_allArea").change(function () {
        ...
        if (jm("#mallShipTemplate_allArea").val() == "zh") {
            jm("#mallShipTemplate_areaBoxInput").attr("isCn", 1);
        ...
        if (jm("#mallShipTemplate_allArea").val() == "zh" || jm("#mallShipTemplate_allArea").val() == "os") {
            jm(".J_ssq").show();
            jm(".J_administrativeRegion").hide()
        } else {
            ...
            jm.each(e, function (J, L) {
                ...
                jm.each(L.regionList, function (T, W) {
                    ...
                    var S = 0, O = W.price, U = W.rha == null ? 1 : W.rha, V = W.ria == null ? 1 : W.ria,
                        Q = W.rip || 0;
                    var R = A;
                    if (U > 0) {
                        S = O;
    ...
    jm("#mallShipTemplate_areaBoxInput").unbind("click").bind("click", function () {
        if (jm("#mallShipTemplate_allArea").val() == "zh") {
            ...
            if (jm("#mallShipTemplate_allArea").val() == null || jm("#mallShipTemplate_allArea").val() == "os") {
            } else {
                E();
    ...
    jm("#mallShipTemplate_city_box").delegate(".group_item", "click", function () {
        Mobi.mallStlCalcTotal();
        if (jm("#mallShipTemplate_allArea").val() == "" || jm("#mallShipTemplate_allArea").val() == "zh" || jm("#mallShipTemplate_allArea").val() == "os") {
            f = true
        } else {
            f = false
        }
        ...
        jm.each(e, function (M, O) {
            if (v) {
                var N = false, L = C.scrl || [];
            ...
            jm.each(O.regionList, function (W, Z) {
                ...
                var V = 0, R = Z.price, X = Z.rha == null ? 1 : Z.rha, Y = Z.ria == null ? 1 : Z.ria, T = Z.rip || 0;
                var U = A;
                if (X > 0) {
                    V = R;
                    U -= X
    ...
    jm("#mallShipTemplate_thd_box").delegate(".group_item", "click", function () {
        ...
        jm.each(e, function (L, N) {
            if (v) {
                var M = false, K = C.scrl || [];
            ...
            jm.each(N.regionList, function (V, Y) {
                ...
                var U = 0, Q = Y.price, W = Y.rha == null ? 1 : Y.rha, X = Y.ria == null ? 1 : Y.ria, S = Y.rip || 0;
                var T = A;
                if (W > 0) {
                    U = Q;
                    T -= W
...
Mobi.changeShipType = function () {
    ...
    jm(".ShipItem").click(function () {
        var e = jm(this), c = parseFloat(jm("#shipPrice").attr("value")), b = parseFloat(jm("#totalValue").text()),
            f = parseFloat(e.find(".right").attr("value")), k = parseFloat(e.find(".right").attr("shipType")),
            d = e.find(".right").text(), h = e.find(".left").text();
        jm("#shipPrice").attr("value", f).text(f == 0 ? LS.freeShipping : a + f);
        jm("#shipValue").attr("shiptype", k).text(h + "  ");
...
Mobi.changeBankList = function () {
    jm(".bankListArea").click(function () {
        var c = jm(this), d = c.find(".bankItemValue").eq(2).text(), a = c.find(".bankItemValue").eq(0).text(),
...
Mobi.initUseCoupon = (function (k) {
    var e = b.prototype, l, m = {};

    function b(n) {
        this.selectCoupon = {};
        l = this;
        m.couponList = n;
        m.couponColorList = ["red", "orange", "yellow", "green", "blue", "pink", "purple"], d(n);
        c();
        h()
    }
    ...
    function d(n) {
        ...
        if (n != "undefined" && n.length != 0) {
            var q = n[0];
            if (q != "undefined") {
                Mobi.defaultCouponSelectId = q.cdId;
                var p = q.savePrice;
                var o = q.orderMinPrice;
                jm("#couponOffsetMoney").text(jm.format(LS.settlementCoupon, p, o));
                jm("#couponOffsetMoney").attr("_offsetmoney", p);
                Mobi.selectCoupon.saveMoney = p;
                Mobi.selectCoupon.id = q.cdId;
                Mobi.selectCoupon.orderMinPrice = q.orderMinPrice;
                Mobi.mallStlCalcTotal()
            } else {
                Mobi.selectCoupon = {}
            }
    ...
    function c() {
        Mobi.onTouchAndClickEvent(".coupon-warp", function () {
            var p = jm(".fk-select-layer"), o = Mobi.getRootFontSize(), n = jm(this)[0].offsetTop;
            l.selectCoupon.id = jm(this).attr("data_id");
            l.selectCoupon.saveMoney = jm(this).find(".couponPrice").text();
            p.css({top: n + "px"});
            p.show();
            Mobi.mallStlCalcTotal()
        });
        ...
        Mobi.onTouchAndClickEvent("#editCouponPanel .fk-coupon-opera .g_button", function (n) {
            if ("id" in l.selectCoupon) {
                var q = Fai.top._choiceCurrencyVal;
                var s = l.selectCoupon.saveMoney;
                var u = l.selectCoupon.orderMinPrice;
                if (jm("#editUseItgPanel").length > 0) {
                    var o = jm("#useItg"), r = parseInt(o.attr("_needitg")), t = parseInt(o.attr("_maxuse"));
                    var p = parseFloat(jm("#cartTotalPrice").attr("totalPrice"));
                    if (isNaN(p)) {
                        return
                    }
                    var v = Math.floor((p - s) * r);
                    if (v < t) {
                        jm(".useTips .maxUse").text(v)
                    } else {
                        jm(".useTips .maxUse").text(t)
                    }
                }
                jm("#couponOffsetMoney").attr("_offsetmoney", s);
                jm("#couponOffsetMoney").text(jm.format(LS.settlementCoupon, parseFloat(s).toFixed(2), u));
                Mobi.mallStlCalcTotal();
        ...
        Mobi.onTouchAndClickEvent("#editCouponPanel #validCode", function () {
            ...
            if ("id" in l.selectCoupon) {
                var o = Fai.top._choiceCurrencyVal;
                jm("#couponOffsetMoney").text("-" + o + l.selectCoupon.saveMoney);
                jm("#editCouponPanel .g_close").click()
            } else {
                Mobi.ing(LS.plsSelectCoupon)
            }
    ...
    function f() {
        var n = [];
        n.push("<div class='couponPanel' id='editCouponPanel' style='display:none;'>");
        n.push("<div class='ShipDetailsHeader webHeaderBg'>");
        n.push("<span class='g_close icon-gClose'></span><span class='title pageTitle'>" + LS.coupon);
        n.push("</span></div>");
        n.push("<div class='fk-coupon-panel couponListPanel'>");
        n.push("<div class='fk-rc' style='display:none'>");
        n.push('<input type="text" id="redeemCode" class="g_input fk-rc-input" placeholder="我有兑换码"/>');
        n.push("<div class='g_button' id='validCode'>验证</div>");
        n.push("</div>");
        n.push("<div class='coupon-empty' style='display:none;'>");
        n.push("<div class='icon-coupons1'></div>");
        var o = "暂无可使用优惠券";
        n.push("<div class='showMsg'>" + o + "</div>");
        n.push("</div>");
        n.push("<div class='show-coupon-list'>");
        n.push("<div style='padding: 0.5rem;'>" + LS.plsSelectUseCoupon + "</div>");
        jm.each(m.couponList, function (q, p) {
            n.push("<div class='coupon-warp' data_id='" + p.cdId + "' data_min='" + p.orderMinPrice + "'>");
            n.push("<div class='coupon-code'>" + LS.coupon.substring(2) + LS.serialNumber + "：" + p.redeemCode + "</div>");
            n.push("<div class='coupon-data'>");
            n.push("<div>" + LS.Event + LS.name + "：" + jm.encodeHtml(p.couponName) + "</div>");
            n.push("<div>" + LS.useConditionOrderOver + Fai.top._choiceCurrencyVal + p.orderMinPrice + "</div>");
            n.push("<div>" + LS.vilidaty + "：" + p.validity + "</div>");
            n.push("</div>");
            n.push("<div class='coupon' data_id='" + p.cdId + "'>");
            n.push("<div class='coupon-left coupon-" + m.couponColorList[p.bg] + "-left'></div>");
            n.push("<div class='coupon-content coupon-color-" + m.couponColorList[p.bg] + "'>");
            n.push("<div class='couponSavePrice'><span class='priceSign'>" + Fai.top._choiceCurrencyVal + "</span><span class='couponPrice'>" + p.savePrice + "</span></div>");
            n.push("</div>");
            n.push("<div class='coupon-right coupon-" + m.couponColorList[p.bg] + "-right'></div>");
            n.push("<div class='coupon-watermark'>券</div>");
            n.push("</div>");
            n.push("</div>")
        });
        n.push("<div class='fk-select-layer'><div></div><em><span class='faisco-icons-select'></span></em></div>");
        n.push("</div>");
        n.push("</div>");
        n.push("<div class='fk-coupon-opera'>");
        n.push("<div class='g_color g_bdColor  notUseBtn'><span>" + LS.doNotUsed + "<span class=''></div>");
        n.push("<div class='g_button'>" + LS.sureUse + "</div>");
        n.push("</div>");
        return n.join("")
    }
    ...
    function a() {
        var p = [];
        var n = [];
        jm.each(m.couponList, function (q, r) {
            n.push("<div class='couponUseListItem' onclick='Mobi.changeCheckButtonRight(" + r.cdId + ")'>");
            n.push("<span>" + jm.format(LS.settlementCoupon, r.savePrice, r.orderMinPrice) + "</span>");
            n.push("<span>");
            if (Mobi.defaultCouponSelectId == r.cdId) {
                n.push("<div class='faisco-icons-right couponCheckBox g_color' order_min_price='" + r.orderMinPrice + "' coupon_value='" + r.savePrice + "' id='selectBtn" + r.cdId + "'></div>")
            } else {
                n.push("<div class='faisco-icons-shape11 couponCheckBox' order_min_price='" + r.orderMinPrice + "' coupon_value='" + r.savePrice + "' id='selectBtn" + r.cdId + "' onclick='Mobi.changeCheckButtonRight(" + r.cdId + ")' ></div>")
            }
            n.push("</span>");
            n.push("</div>")
        });
        n.push("<div class='couponUseListItem' onclick='Mobi.changeCheckButtonRight(-1)' style='margin-bottom:3rem;'>");
        n.push("<span>" + LS.doNotUsed + "</span>");
        n.push("<span>");
        n.push("<div class='faisco-icons-shape11 couponCheckBox' id='selectBtn-1' order_min_price ='-1'  coupon_value='-1' onclick='Mobi.changeCheckButtonRight(-1)' ></div>");
        n.push("</span>");
        n.push("</div>");
        var o = "<div class='couponUseListPanel' style='display:none; ' id='couponUseListPanel'><div style='position: absolute;bottom: 0;width: 100%;'><div class='couponListTitle'>" + LS.coupon + "</div><div class='couponUseListContent' id='couponUseListContent'><div id='couponListItems' style='max-height:10rem; overflow: auto;'><div class='couponListContainer'>" + n.join("") + "</div></div></div></div></div>";
        return o
    }

    function h() {
        var n = {
            triggerId: "couponLine", pageHtml: a(), direction: "bottom", pageBg: true, callback: function () {
                jm(".couponListTitle,#couponUseListContent").bind("click mousedown touchstart", function (o) {
                    o.stopPropagation()
                });
                jm("#couponListItems").css("overflow", "auto");
                jm("#couponLine").bind("click", function (o) {
...
Mobi.editInfoSave = function (c) {
    ...
    b.find(".propItemValue").each(function () {
        var F = jm(this).val();
        var G = jm(this).attr("id");
        var E = jm(this).attr("_field");
        if (jm(this).attr("_required") == 1 && !F && !y) {
        ...
        if (F && F.length > 0) {
            ...
            if (E == "mobile" && !Mobi.isNationMobile(F)) {
            ...
            if (E == "mobile") {
                A.mobileCt = jm(this).parent().find("#mobileCt").val();
                if (F.length <= 0) {
                    A.mobileCt = ""
                }
                var D = {};
    ...
    if (jm(".assignItem_line").length < 1) {
        ...
        if (Fai.top._templateFrameId >= 2000 && Fai.top._templateFrameId < 3000) {
            ...
            jm.each(C, function (D) {
                if ((C[D])["field"] === "name") {
                    ...
                    if (((C[D])["field"] === "phone" && (C[D])["value"] != null && (C[D])["value"] != "") || ((C[D])["field"] === "mobile" && (C[D])["value"] != null && (C[D])["value"] != "")) {
                        if (e) {
                            return
                        }
                        e = true;
            ...
            jm.each(C, function (D) {
                if ((C[D])["field"] === "name") {
                    d += "<span class='item_value flex1 info_name' id='info_" + (C[D])["field"] + "'>" + (C[D])["value"] + "</span>"
                } else {
                    if (((C[D])["field"] === "phone" && (C[D])["value"] != null && (C[D])["value"] != "") || ((C[D])["field"] === "mobile" && (C[D])["value"] != null && (C[D])["value"] != "")) {
                        if (z) {
                            return
                        ...
                        z = true;
                        d += "<span class='item_value flex1 info_phone' id='info_phone'>" + (C[D])["value"] + "</span>"
                    } else {
                        if ((C[D])["field"] === "addr") {
                            B = (C[D])["value"];
                            p = (C[D])["field"]
            ...
            if (B != "" && p != "") {
                d += "<div class='item_value flex1' id='info_" + p + "'>" + B + "</div>"
            } else {
                if (r != "") {
                    d += "<div class='item_value flex1' id='info_addr'>" + r + "</div>"
                }
            }
            d += "</div>";
            d += "<div class='shipTopBg'></div>"
        ...
        if (A.name) {
            q.find("#info_name").text(A.name)
        }
        if (A.phone) {
            q.find("#info_phone").text(A.phone)
        } else {
            if (A.mobile) {
                q.find("#info_phone").text(A.mobile)
            }
        }
        if (A.addr) {
            q.find("#info_addr").text(A.addr)
        }
    }
    jm("#editCusInfo .g_close").click()
};
Mobi.mallSubmit = function (u, n, e, B, E) {
    if (!n && u === 0) {
        Mobi.ing("您目前处于管理状态，您的订单为示例数据。");
        return
    }
    var q = jm("#mstlBtn");
    var f = jm(".orderSettle"), D = {}, y = false, o = "";
    f.find(".propItemValue").each(function () {
        var F = jm(this), I = F.val(), J = F.attr("id");
        if (F.attr("_required") == 1 && !I && !y) {
            o = LS.mallStlSubmitInput + F.attr("_prop");
            Mobi.ing(o);
            jm("#linetitle1").click();
            jm("#" + J).trigger("focus");
            y = true;
        ...
        var H = F.attr("_field");
        if (I && I.length > 0) {
            if (H === "email" && !jm.isEmail(I)) {
                o = LS.mallStlSubmitInput2 + F.attr("_prop");
                Mobi.ing(o);
                jm("#linetitle1").click();
                jm("#" + J).trigger("focus");
                y = true;
            ...
            if (H == "mobile" && !Mobi.isNationMobile(I)) {
                o = LS.mobileNumRegular;
                Mobi.ing(o);
                jm("#" + J).focus();
                y = true;
                return false
        ...
        if (typeof H !== "undefined") {
            if (H !== "addrDetail" && H !== "addrInfo_street") {
                D[H] = I;
                if (H == "mobile") {
                    var G = jm("#mobileCt").val();
                    if (I.length <= 0) {
                        G = ""
                    }
                    D.mobileCt = G
    ...
    var t = jm("#areaBoxInput");
    if (D.addr == null && t.length == 1) {
        var r = "";
        if (Fai.top._lcid == 2052 || Fai.top.lcid == 1028) {
            r = t.val().replace(/-/g, "") + jm("#addrInfo_street").val()
        } else {
            r = t.val().replace(/-/g, " ") + " " + jm("#addrInfo_street").val()
        }
        D.addr = r
    ...
    if (Mobi.orderLvMessageOpen) {
        var w = jm("#orderLeveaMsgIn").val();
        if (w.length > Mobi.orderLvMessageMaxNum) {
            w = w.substring(0, Mobi.orderLvMessageMaxNum)
        }
        D.msg = w
    } else {
        D.msg = ""
    ...
    if (jm("#mallShipTemplate_province").length == 1 && b.length == 1) {
        var l = parseInt(b.attr("provinceCode"));
        var s = parseInt(b.attr("cityCode"));
        var k = parseInt(b.attr("countyCode"));
        var m = parseInt(b.attr("streetCode"));
        var x = (jm("#mallShipTemplate_areaBoxInput").attr("isCus") == 1);
        if (!l || isNaN(l)) {
            o = LS.mallStlSubmitAddrErr;
            jm("#linetitle1").click()
        } else {
            if ((!s || isNaN(s)) && !x) {
                o = LS.mallStlSubmitAddrErr;
        ...
        D.shipType = parseInt(jm("#shipValue").attr("shipType"))
    }
    if (o != "") {
        Mobi.ing(o);
        return
    }
    var v = jm("#onlineBankType");
    var c = 0;
    if (v.length == 1) {
        c = parseInt(v.attr("_paymode"));
        if (c < 3) {
            D.payMode = c
        }
    }
    if ((v.length == 1) && (c > 2)) {
        c = parseInt(v.attr("_paymode"));
        if (c != 9 && c != 8 && c != 7) {
            D.payBankType = parseInt(v.attr("_type"))
        }
        D.payMode = parseInt(v.attr("_paymode"))
    }
    if (isNaN(c)) {
    ...
    if (C.length > 0) {
        var d = C.val();
        if (jm.isInteger(d)) {
            var h = parseInt(C.attr("_maxUse"));
            var a = parseInt(C.attr("_currentitg"));
            var z = C.attr("_itegName");
            if (d > a) {
                Mobi.ing(jm.format(LS.integral_notOverCurrent, jm.encodeHtml(z), jm.encodeHtml(z)));
                C.focus();
                return
            }
            if (d > h) {
                Mobi.ing(jm.format(LS.integral_notOver, jm.encodeHtml(z), h));
                C.focus();
                return
            }
            if (d < 0) {
    ...
    if (Mobi.selectCoupon && "id" in Mobi.selectCoupon && Mobi.selectCoupon.id) {
        D.cdId = Number(Mobi.selectCoupon.id)
    }
    Mobi.ing(LS.mallStlSubmitting, -1);
    var A = jm("#onlineBankType").attr("_paymode");
    urlArg = "orderId=" + u;
    if (n) {
        if (window.self != window.top && /(iPhone|iPad|iPod|safari)/i.test(navigator.userAgent.toLowerCase())) {
            urlArg = "imme&immeData=" + jm.encodeUrl(jm.toJSON(E))
        } else {
            urlArg = "imme"
        }
    }
    ...
    if (!n && e.length > 0) {
        jm.ajax({
            type: "post",
            url: "ajax/order_h.jsp?cmd=delItem&orderId=" + u,
            data: "itemIds=[" + e + "]",
            error: function () {
                Mobi.ing(LS.mallCartUpdateError)
            },
            success: function (F) {
                var F = jm.parseJSON(F);
                if (F.success) {
                    Mobi.ajaxSettleOrder(urlArg, D, B, n, A, u)
                } else {
                    if (F.rt == -9) {
        ...
        success: function (h) {
            ...
            if (h.success) {
                jm.ajax({
                    ...
                    success: function (k) {
                        if (e == "10" || e == "11") {
                            var l = Fai.top._lcid ? "&lcid=" + Fai.top._lcid : "";
                            window.location.href = "/wxPay/mdetail.jsp?id=" + (b ? h.oid : a) + l + "#firstSubmit"
                        } else {
                            if (e == "1" || e == "2") {
...
Mobi.initPresentIpt = function () {
    ...
    if (b.length > 0) {
        ...
        var k = parseInt(b.attr("_needitg"));
        var e = parseInt(b.val());
        var m = b.attr("_itegName");
        var l = parseInt(b.attr("_maxuse"));
        var f = parseFloat(jm("#cartTotalPrice").attr("totalPrice"));
        if (isNaN(f)) {
            return false
        }
        ...
        if (e > l) {
            Mobi.ing(jm.format(LS.integral_maxUse, l, jm.encodeHtml(jm("#useItg").attr("_itegName"))));
            jm("#useItg").val(l);
            return false
        }
        if (e > parseInt(b.attr("_currentItg"))) {
            Mobi.ing(jm.format(LS.integral_notOverCurrent, jm.encodeHtml(m), jm.encodeHtml(m)));
            e = 0;
            b.focus();
            return false
        }
...
(function (c, b, h) {
    ...
    function e(n) {
        var m = window.location.href, o = "";
        if (m.indexOf("lcid") > 0) {
            var p = Mobi.getUrlParam(m, "lcid");
            if (p) {
                o += "&lcid=" + p
            }
        }
                ...
                if (!q.success) {
                    ...
                    if (q.rt == -3) {
                        ...
                        if (q.rt == -9) {
                            ...
                            if (q.rt == Mobi.MallAjaxErrno.outOfMallAmount) {
                                Mobi.ing(c.format(LS.mallAmountOverNameList, q.productsName))
                            } else {
                                if (q.rt == Mobi.MallAjaxErrno.OutOfAllowAmount) {
                                    Mobi.ing(c.format(LS.allowAmountOverNameList, q.productsName))
                                } else {
                                    if (q.rt == Mobi.MallAjaxErrno.payDomainError) {
                                        Mobi.ing(c.format(LS.mallPayDomainError))
                                    } else {
                                        if (q.rt == Mobi.MallAjaxErrno.notAdded) {
...
Mobi.callPay = function (d, a) {
    ...
    jm.ajax({
        ...
        success: function (f) {
            var k = jm.parseJSON(jm.decodeUrl(f));
            Mobi.closeLoading();
            if (k.success) {
                Mobi.callPayAPI(k)
            } else {
                ...
                if (!(h.match(/MicroMessenger/i) == "micromessenger")) {
                    ...
                    Mobi.ing(k.errMsg + "(请联系网站管理员)")
                }
            }
        }
    })
};
Mobi.callPayAPI = function (k) {
    var f = navigator.userAgent.toLowerCase();
    if (!(f.match(/MicroMessenger/i) == "micromessenger")) {
        if (k.result != "SUCCESS") {
            Mobi.ing((k.errMsg ? k.errMsg : "微信支付失败，请尝试在微信端进行支付"));
            return
        }
        var a = window.location.href, b = "";
        if (a.indexOf("lcid") > 0) {
            var l = Mobi.getUrlParam(a, "lcid");
            if (l) {
                b = Mobi.getLanCodeFromLcid(l);
                b = b ? b + "/" : ""
            }
        }
        var d = window.location.protocol + "//" + window.location.host + "/" + b;
        window.location.href = k.url + "&redirect_url=" + d;
        return
    }
    try {
        ...
        function c() {
            ...
            WeixinJSBridge.invoke("getBrandWCPayRequest", e, function (n) {
                if (n.err_msg != "get_brand_wcpay_request:cancel") {
                    WeixinJSBridge.log(n.err_msg)
                }
                if (n.err_msg != "get_brand_wcpay_request:ok") {
                    if (n.err_msg == "get_brand_wcpay_request:cancel") {
                    ...
                    setTimeout(function () {
                        window.location.href = "/wxPay/mdetail.jsp?id=" + jm("#wxpayBtn").attr("_orderid") + o
                    }, 3000)
                } else {
                    Mobi.showLoading();
                    setTimeout(function () {
                        var q = window.location.href, r = "";
                        if (q.indexOf("lcid") > 0) {
                            var s = Mobi.getUrlParam(q, "lcid");
                            if (s) {
                                r = Mobi.getLanCodeFromLcid(s);
                                r = r ? r + "/" : ""
                            }
                        }
                        window.location.href = "/" + r + "mdetail.jsp?id=" + jm("#wxpayBtn").attr("_orderid") + "&suc=true"
                    }, 1000)
                }
            })
        }
...
Mobi.getNewFlowInfo = function (c, a, d) {
    ...
    if (typeof d != "undefined" && d) {
        ...
        jm.ajax({
            type: "post", url: "ajax/flowInfo_h.jsp?cmd=flowMsg", data: "id=" + a, success: function (e) {
                var k = jm.parseJSON(e);
                flowMsgList = [];
                if (k.msgList == null || k.msgList.length === 0 || !k.success) {
                    ...
                    flowMsgList.push("<span class='flowBusName'>" + k.flowCorpName + "</span>");
                    flowMsgList.push("<span class='flowBusNumber'>" + k.flowBillNum + "</span>");
                    ...
                    if (h > 0) {
                        ...
                        flowMsgList.push("</div>");
                        flowMsgList.push("<div class='flowFlag icon-flowFlag'></div>");
                        flowMsgList.push("<div class='flowLastNews'><span>" + k.msgList[0].context + "</span><span class='icon-flowMoreArrow'></span></div>");
                        flowMsgList.push("<div><span class='flowMsgTime'>" + k.msgList[0].time + "</span>");
                        flowMsgList.push("</div>");
                        flowMsgList.push("</div>")
                    }
                }
...
Mobi.setFlowDivSwipeLis = function () {
    ...
    jm("#J-flowSwipeDiv").bind("mousedown", function (f) {
        ...
        jm("#J-flowSwipeDiv").bind("mousemove", function (h) {
        }).bind("mouseup", function (k) {
            jm("#J-flowSwipeDiv").unbind("mousemove").unbind("mouseup");
            c = k.clientX - jm("#J-flowSwipeDiv").offset().left;
            b = k.clientY - jm("#J-flowSwipeDiv").offset().top;
            Mobi.ing(b);
            var h = k;
            if (a == c && d == b) {
                Mobi.ing(k.offsetX + "," + k.offsetY);
                jm("#J-flowClickDiv").css("margin-left", (k.offsetX - 10) + "px");
                jm("#J-flowClickDiv").css("margin-top", (k.offsetY + 5) + "px");
...
Mobi.getAllFlowInfo = function (d, a) {
    var c = jm("#module" + d), e = jm("#flowDetailPanel" + a), b = jm("#g_web");
    if (e.length < 1) {
        jm.ajax({
            type: "post", url: "ajax/flowInfo_h.jsp?cmd=show", data: "id=" + a, success: function (f) {
                var h = jm.parseJSON(f);
    ...
    setTimeout(function () {
        jm.ajax({
            type: "post", url: "ajax/flowInfo_h.jsp?cmd=flowMsg", data: "id=" + a, success: function (h) {
                var m = jm.parseJSON(h), o = jm("#flowDetailPanel" + a);
                if (m.msgList == null || m.msgList.length === 0 || !m.success) {
                    if (m.success) {
                        o.find(".flowDetail .flowDiv .noflowInfo").eq(0).show()
                    } else {
                        o.find(".flowDetail .flowDiv .flowErr").eq(0).show();
                        if (m.msg != undefined) {
                            Mobi.ing(m.msg)
                        }
                    }
                } else {
                    var n = "", f = [], l = m.msgList.length;
                    ...
                    for (var k = 0; k < l; k++) {
                        ...
                        f.push("<div><span>" + m.msgList[k].context + "</span></div>");
                        f.push("<div><span " + (k == 0 ? "" : "class='flowTime'") + ">" + m.msgList[k].time + "</span>");
                        if (k == 0) {
...
Mobi.moreOrderProductList = function (d, b) {
    var e = jm("#orderProductList" + b), c = jm("#moreOrderProductList" + b), h = jm("#flowDetailPanel" + b);
...
Mobi.initFlowDetailHeight = function (c, a) {
    var d = jm("#orderProductList" + a), e = jm("#flowDetailPanel" + a);
    d.css("height", "");
    e.css("height", "");
...
Mobi.initOrderSureButton = function (b) {
    ...
    a.find(".J-orderSureRpt").unbind().bind("click", function () {
        var h = jm(this), e = h.parent().parent(), d = h.attr("_oid");
        var c = function (l, k) {
            jm.ajax({
                type: "post",
                url: "ajax/order_h.jsp",
                data: "cmd=setStatus&id=" + k + "&status=20",
                error: function () {
                    Mobi.ing(LS.systemError)
                },
                success: function (m) {
        ...
        var f = {
            content: LS.orderConfirmMsg, callback: function () {
                c(e, d)
            }
        };
        jm.ajax({
            type: "post", url: "ajax/order_h.jsp", data: "cmd=orderHasBeenSigned&id=" + d, error: function () {
                Mobi.ing(LS.systemError)
            }, success: function (k) {
                var l = jm.parseJSON(k);
                if (l.success) {
    ...
    a.find(".J-orderCancel").unbind().bind("click", function () {
        ...
        var c = function (l, k) {
            jm.ajax({
                type: "post",
                url: "ajax/order_h.jsp",
                data: "cmd=setStatus&id=" + k + "&status=25",
                error: function () {
                    Mobi.ing(LS.systemError)
                },
                success: function (m) {
        ...
        var f = {
            textClass: "confirm", content: LS.orderCancelMsg, callback: function () {
                c(e, d)
            }
        };
        Mobi.prompt(f)
...
Mobi.initOrderDeleteButton = function (b) {
    ...
    a.find(".J-orderDelete").unbind().bind("click", function () {
        var f = jm(this), d = f.attr("_oid");
        var c = function (h) {
            jm.ajax({
                type: "post", url: "ajax/order_h.jsp", data: "cmd=memberDeleteOrder&id=" + h, error: function () {
                    Mobi.ing(LS.systemError)
                }, success: function (k) {
                    var l = jm.parseJSON(k);
                    if (l.success) {
        ...
        var e = {
            textClass: "confirm", content: LS.orderDeleteMsg, callback: function () {
                c(d)
            }
        };
        jm.ajax({
            type: "post", url: "ajax/order_h.jsp", data: "cmd=orderHasDelete&id=" + d, error: function () {
                Mobi.ing(LS.systemError)
            }, success: function (h) {
                var k = jm.parseJSON(h);
                if (k.success) {
...
Mobi.showBanksDetails = function () {
    ...
    for (var d = 0; d < a.length; d++) {
        var f = a[d].acct, b = a[d].bank, c = a[d].name;
...
Mobi.initOrderPopUpPanel = function () {
    var a = {
        triggerId: "linetitle1", panelId: "editCusInfo", callback: function () {
    ...
    var b = {
        triggerId: "shipLine", pageHtml: Mobi.showShipDetails(), callback: function () {
            Mobi.showShipDetails()
        }, closeWebPage: "#modifyShipDetails .g_close"
    };
    Mobi.initWebPage(b);
    b = {
        triggerId: "shipTplLine", panelId: "modifyShipTemplate", callback: function () {
            Mobi.changeShipType();
    ...
    Mobi.initWebPage(b);
    b = {
        triggerId: "pay_line", pageHtml: Mobi.printOnlinePayType(Fai.top._payTypeList), callback: function () {
            c("pgListDiv", "pay_line")
        }, closeWebPage: "#pgListDiv .g_close"
    };
    Mobi.initWebPage(b);
    b = {
        triggerId: "banks", panelId: "modifyBankList", pageHtml: Mobi.showBanksDetails(), callback: function () {
            Mobi.changeBankList();
    ...
    Mobi.initWebPage(b);
    var b = {
        triggerId: "orderAddAddrInfo", panelId: "editAddrInfo", callback: function () {
            c("editAddrInfo", "orderAddAddrInfo")
        }, closeWebPage: "#editAddrInfo .g_close"
    };
    Mobi.initWebPage(b);
    b = {
        triggerId: "useItgLine", panelId: "editUseItgPanel", callback: function () {
    ...
    function c(e, k) {
        if (e == "editAddrInfo") {
            jm("#editAddrInfo").find("input,select,textarea").bind("blur", function () {
                document.querySelector("body").scrollTop = 0
            })
        }
        if (e == "editCusInfo") {
            if (/(iPhone|iPad|iPod|iOS)/i.test(navigator.userAgent)) {
                jm("#editCusInfo").find("input,select,textarea").bind("focus", function () {
        ...
        var d = Fai.top.document.querySelector("#webPagePanel" + k);
        window.ontouchmove = function (o) {
            if (f.scrollHeight == f.offsetHeight && jm(d).css("display") != "none") {
                var n = o.target;
                var m = (jm(n).parents(".areaBox").length > 0 || jm(n).parents(".areaBox2").length > 0);
                if (!m) {
                    o.preventDefault()
                }
            }
        ...
        requestAnimationFrame(function l() {
            ...
            var n = 0, m = f.scrollHeight - f.clientHeight;
            if ((m - n) == h) {
                h = 0.5
            }
            var o = f.scrollTop;
...
Mobi.changePayMode = function (b, a) {
    commentOption = {
        triggerId: "morePayMode", pageHtml: c(a), callback: function () {
        }, closeWebPage: "#pgListDiv .g_close"
    };
    ...
    function c(d) {
        ...
        jm.each(d, function (f) {
            ...
            e.push("<div class='pgBoxItem'><span class='icon-payMode payMode" + k.payMode + "'></span><a class='pgName payMode'  onclick='Mobi.changePayModeEvent(this);' _orderId='" + b + "'" + h + " _payMode='" + k.payMode + "' _name='" + k.desc + "'>" + k.desc + "</a></div>");
            e.push("</div>")
        });
        e.push("</div></div></div>");
        return e.join("")
...
Mobi.changePayModeEvent = function (e) {
    var l = jm(e).attr("_payMode"), d = jm(e).attr("_orderId"), c = {};
    if (!isNaN(l)) {
        l = parseInt(l)
    }
    c.payMode = l;
    var a = window.location.href, k = "", b = "";
    if (a.indexOf("lcid") > 0) {
    ...
    jm.ajax({
        type: "post",
        url: "ajax/order_h.jsp?cmd=setOrder" + k,
        ...
        success: function (m) {
            if (m.success) {
                ...
                if (n) {
                    var o;
                    if (l == 3) {
                        o = b + "tenpay.jsp?orderId=" + d
                    } else {
                        if (l == 4 || l == 5 || l == 6 || l == 8 || l == 12 || l == 13) {
                            o = b + "alipay.jsp?orderId=" + d
                        } else {
                            if (l == 7) {
                                o = b + "paypal.jsp?orderId=" + d
                            } else {
                                if (l == 9) {
                                    o = b + "cbpay.jsp?orderId=" + d
                                } else {
                                    if (l == 10 || l == 11) {
                                        o = "/wxPay/mdetail.jsp?id=" + d + k
                                    } else {
                                        document.location.reload();
                                        return
                                    }
                    ...
                    if (o.rt == -3) {
                        ...
                        if (o.rt == -9) {
                            ...
                            if (o.rt == Mobi.MallAjaxErrno.outOfMallAmount) {
                                Mobi.ing(jm.format(LS.mallAmountOverNameList, o.productsName))
                            } else {
                                if (o.rt == Mobi.MallAjaxErrno.OutOfAllowAmount) {
                                    Mobi.ing(jm.format(LS.allowAmountOverNameList, o.productsName))
                                } else {
...
Mobi.initCommentBtn = function (d, a) {
    var c = jm("#module" + d), b = jm("#g_web");
    c.find(".J-comment").unbind().bind("click", function () {
        document.body.style.overflow = "hidden";
        var l = jm(this), f = l.attr("_oid");
        if (window.sessionStorage) {
        ...
        var k = {oid: f, marginFlag: e};
        jm.ajax({
            type: "post", url: "ajax/order_h.jsp?cmd=getCtPanel", data: k, success: function (m) {
                var n = jm.parseJSON(m);
                if (n.success == false) {
                    Mobi.ing(n.msg);
                    return
                ...
                h.bind("scroll", function (o) {
                    o.stopPropagation();
                    o.cancelBubble = true
                });
                h.find(".loginHeader .g_close").eq(0).click(function () {
                    if (h.find(".J-ct-item").length == 0) {
                        l.removeClass("orderButton").addClass("comment-txt  orderButtonHas orderButton").text(LS.commentExist)
                    }
                    _hidePanel("pd-ct-panel" + f)
                });
                h.find(".J-ct-item").click(function () {
                    document.body.style.overflow = "hidden";
                    var s = jm(this), r = s.attr("_iid"), p = s.attr("_pid");
                    if (window.sessionStorage) {
                        window.sessionStorage._commClickItemId = r
                    }
    ...
    _initItemCommentPanel = function (p, x, h, s, u) {
        var t = h.attr("_iprice"), A = h.attr("_iname"), q = h.attr("_ipath"), B = h.attr("_maxlen"),
            r = h.attr("_minlen"), n = h.attr("_showflag"), f = h.attr("_comment"), y = h.attr("_pathList"),
            C = h.attr("_star");
        var D = "' class='ct-panel order-ext-panel'>";
        if (window.sessionStorage) {
            if (Mobi.checkWindowSeStgValue(window.sessionStorage._backFromProDetail)) {
                D = "' class='ct-panel order-ext-panel' style='margin-left:0;'>";
                window.sessionStorage._backFromProDetail = false
            }
        }
        if (typeof(n) != "undefined" && n != null) {
            ...
            var w = [];
            var v = "";
            if (typeof(y) != "undefined" && y != null && y.length > 0) {
                w.push("<div class='ct-s-content-m'>");
                w.push("<table>");
                w.push("<tr>");
                for (var o = 0; o < y.length; o++) {
                    w.push("<td class='s-img-f-tb'>");
            ...
            var l = [];
            if (a) {
                l.push("<div class='l-comm-star'>");
                for (var z = 0; z < 5; z++) {
                    if (z < C) {
                        l.push("<li class='faisco-icons-star3 select_more'></li>")
                    } else {
                        l.push("<li class='faisco-icons-star3 select_less'></li>")
                    }
                }
                l.push("</div>")
            }
            var e = ["<div id='pd-item-", p, "-", x, D, "<div class='loginHeader webHeaderBg'>", "<span class='g_close icon-gClose'></span>", "<span class='title  pageTitle' style='padding-right:0px;'>", LS.commentPub, "</span>", "<span class='homeIcon icon-homeIcon' onclick='window.location.href=\"index.jsp\"'></span>", "</div>", "<div class='l-comm-item'>", "<div class='d-click' onclick=Mobi.jumpToProductDetail('" + u + "',2)></div>", "<div class='i-block1 i-block1-w'>", "<img class='b-comm-img' src='", q, "' alt=''/>", "</div>", "<div class='i-block2'>", "<div class='pd-n pd-n-p' >", jm.encodeHtml(A), "</div>", "</div>", "</div>", "<div class='l-s-item'>", "<div class='tipImg'>", "</div>", "<div class='ct-s-content'>", f, "</div>", v, l.join(""), "</div>", "</div>",];
            e = jm(e.join(""));
            b.append(e);
            setTimeout(function () {
                e.css("margin-left", 0);
                ...
                if (typeof(G) != "undefined" && G != null) {
                    for (var H = 0; H < G.length; H++) {
                        ...
                        if (typeof(F) != "undefined" && F != null && F.length > 0) {
                            Mobi.bindCommImgShow(F, false, 0)
                        }
                    }
                }
            }, 100);
            e.bind("scroll", function (F) {
                F.stopPropagation();
                F.cancelBubble = true
            });
            e.find(".loginHeader .g_close").eq(0).click(function () {
                _hidePanel("pd-item-" + p + "-" + x)
            })
        } else {
            var m = 5;
            if (typeof(_commUploadImgParam) != "undefined" && _commUploadImgParam != null) {
                m = _commUploadImgParam.upImgMaxNum
            }
            var l = [];
            if (a) {
                l = ["<div class='l-star-list J-star-list'>", "<li class='faisco-icons-star3'></li>", "<li class='faisco-icons-star3'></li>", "<li class='faisco-icons-star3'></li>", "<li class='faisco-icons-star3'></li>", "<li class='faisco-icons-star3'></li>", "<li class='score-tip'></li>", "</div>"]
            }
            ...
            if (_commUploadImgParam.isIE == "true") {
                ...
                Mobi.mobiCommUploadImgSWF("comm-img-swfu-placeholder-" + _commUploadImgParam.countNumber, _commUploadImgParam.upImgMaxSize, _commUploadImgParam.imgType, _commUploadImgParam.upImgMaxNum, k)
            } else {
            ...
            if (/(iPhone|iPad|iPod|iOS)/i.test(navigator.userAgent)) {
                jm(".J-ct-area").bind("focus", function () {
                    jm("#pd-item-" + p + "-" + x).css("position", "absolute");
                    jm("body").attr("ontouchmove", "return false;")
                }).bind("blur", function () {
                    jm("#pd-item-" + p + "-" + x).css("position", "");
                    jm("body").removeAttr("ontouchmove")
                })
            }
            e.find(".J-ct-submit").click(function () {
                ...
                jm.ajax({
                    type: "post", url: "ajax/order_h.jsp?cmd=addPC", data: I, error: function () {
                        Mobi.ing(LS.systemError)
                    }, success: function (S) {
                        ...
                        if (U.success) {
                            ...
                            pdItem.append("<div class='orderButton' _star=" + M + " _iid=" + x + " _iprice='" + t + "' _ipath='" + q + "' _showFlag='check'  _iname='" + A + "' _pid='" + u + "'  _comment='" + jm.encodeHtml(N) + "' _pathList='" + JSON.stringify(U.imgsPathStr) + "'>" + LS.commentView + "</div>");
                            pdItem.find(".orderButton").click(function () {
                                var Z = jm(this), Y = Z.attr("_iid"), W = Z.attr("_pid");
...
Mobi.initcommUploadImgParam = function (c, d, k, l, f, h, m, b) {
    _commUploadImgParam = {
        upImgMaxSize: c,
        imgType: d,
        upImgMaxNum: k,
    ...
    var c = {
        ...
        upload_success_handler: function (l, k) {
            ...
            if (m.success) {
                ...
                Mobi.onCommFileUploadEvent("upload", m, f)
            } else {
                Mobi.ing(LS.mobiFormSubmitFileUploadFile + l.name + "   " + m.msg)
            }
        },
...
Mobi.mobiCommUploadImgHtml = function (h, c, d, f) {
    var a = d.split(",");
    var l = _commUploadImgParam.countNumber;
    var k = {
        siteFree: false,
        updateUrlViewRes: "",
        auto: true,
        ...
        buttonText: "",
        uploader: "http://" + f + '/ajax/commUpsiteimg_h.jsp?cmd="mobiUpload"',
        onUploadStart: function (n) {
            _uTime = new Date().getTime()
        },
        onUploadSuccess: function (o, q) {
            var p = jm.parseJSON(q);
            if (p.success) {
                var n = {status: "end", id: o.id, title: "上传成功。"};
                e(n);
                setTimeout(function () {
                    Mobi.ing(jm.format(LS.mobiFormSubmitFileUploadSucess, jm.encodeHtml(o.name)), true)
                }, 1800);
                Mobi.onCommFileUploadEvent("upload", p, l)
            } else {
                var n = {status: "end", id: o.id, title: p.msg};
                e(n);
                Mobi.ing(LS.mobiFormSubmitFileUploadFile + o.name + "   " + p.msg)
            }
        },
        onUploadError: function (n, o) {
        ...
        view_progress: function (n) {
            var n = Math.ceil(n);
            if (isNaN(n)) {
                return
            }
            if (n == 100) {
                Mobi.ing(LS.mobiFormSubmitFileUploadIng + n + "%", true)
            } else {
                Mobi.ing(LS.mobiFormSubmitFileUploadIng + n + "%", false)
            }
        }
    };
    ...
    function e(n) {
        ...
        if (n.status == "start") {
            ...
            jm("body").append(o.join(""))
        } else {
            if (n.status == "ing") {
                jm("#progressTitle" + n.id).text(n.title);
                jm("#progress" + n.id).css("width", Math.round(n.percent) + "%");
                jm("#progressNum" + n.id).html(Math.round(n.percent) + "%")
            } else {
                if (n.status == "end") {
                    jm("#progressTitle" + n.id).text(n.title);
                    jm("#progressBody_" + n.id).remove();
                    ...
                    if (n.status == "error") {
                        jm("#progress" + n.id).addClass("progressError")
                    }
                }
            }
        }
    ...
    upload = jm("#" + h).uploadify(k);
    var m = "file_upload_" + _commUploadImgParam.countNumber;
    var b = "select_btn_" + _commUploadImgParam.countNumber;
    jm("#file_upload_1-button").attr("id", m);
    jm("#select_btn_1").attr("id", b);
    _commUploadImgParam.countNumber++
};
Mobi.onCommFileUploadEvent = function (m, h, d) {
    if (m == "upload") {
        var c = h.id;
        var l = h.name;
        var f = h.size;
        ...
        var a = h.width;
        var k = h.height;
        Mobi.mListCommImgTableCtrl(e, l, c, f, b, d)
    }
};
Mobi.mListCommImgTableCtrl = function (n, a, b, k, d, h) {
    var l = $("#msg_add_img_tb_" + h).eq(0);
    var m = l.find(".comm-find-tb").length;
    var e = l.find(".comm-find-tb").eq(m - 1);
    var c = e.attr("maxNum");
    if (parseInt(m - 1) >= c) {
        return
    }
    ...
    f.push(" <tr>");
    f.push("    <td valign='middle'   align='center' class='comm-show-td-bd'>");
    f.push("      <img src='" + n + "'  alt=''  _name='" + a + "' _id='" + b + "' _file_size='" + k + "' _file_id='" + d + "' class='comm-up-set'>");
    f.push("     </td>");
    f.push(" </tr>");
    f.push("</table>");
    f.push("<div class='comm-up-div'>");
...
Mobi.calculate = function (k, f, l) {
    var n = 0, d = 0, b = 0;
    try {
        d = k.toString().split(".")[1].length
    } catch (c) {
        d = 0
    }
    try {
    ...
    switch (l) {
        case 0:
            var m = Math.pow(10, Math.max(d, b));
            n = (k * m + f * m) / m;
            break;
        case 1:
            var a;
            var m = Math.pow(10, Math.max(d, b));
            a = (d >= b) ? d : b;
            n = ((k * m - f * m) / m).toFixed(a);
            break;
        case 2:
            n = h(k, f);
            break;
        case 3:
            n = h((Number(k.toString().replace(".", "")) / Number(f.toString().replace(".", ""))), Math.pow(10, b - d));
            break
    }
    return n;
...
Mobi.mallProductDetailFixedBar = function () {
    if (Fai.top._templateFrameId >= 2000 && Fai.top._templateFrameId < 3000) {
        ...
        var c = Fai.top._onlineServiceJson.phone, f = Fai.top._onlineServiceJson.qq,
            b = Fai.top._onlineServiceJson.baiduBridge;
        var e = c && c.phoneInfo && c.phoneInfo.length > 0, d = f && f.qqInfo && f.qqInfo.length > 0, a = b > 0;
...
Mobi.initRefundDetail = function (b, h, d, f) {
    ...
    jm("#submitRemark").click(function () {
        ...
        jm.ajax({
            ...
            data: "orderId=" + b + "&speaker=1&itemId=" + h + "&remark=" + jm.encodeUrl(k),
            error: function () {
                e = false;
                Mobi.ing("系统繁忙，请稍后重试。")
            },
            success: function (u) {
                ...
                if (u.success) {
                    Mobi.ing(LS.submitSuccess);
                    var t = new Date(u.remarkTime);
                    var r = t.getFullYear(), q = t.getMonth() + 1, s = t.getDate(), o = t.getHours(),
                        n = t.getMinutes(), m = t.getSeconds();
                    var l = r + "-" + q + "-" + s + " " + o + ":" + n + ":" + m;
                    var p = "";
                    p += "<div class='refundItem memberContent'>";
                    p += "<div class='icon-arrow'></div>";
                    p += "<div class='remarkTitle'>";
                    p += "<div class='item1'>" + d + "</div>";
                    p += "<div class='item2'>" + l + "</div>";
                    p += "</div>";
                    p += "<div class='remarkStatus'>" + jm.encodeHtml(k) + "</div>";
                    p += "</div>";
                    jm("#remarkList").prepend(p);
                    jm("#editRemark").hide();
                    jm("#remarkListContainer").show();
    ...
    var c = {
        textClass: "confirm", content: LS.refundCancelTips, callback: function () {
            jm.ajax({
                type: "post",
    ...
    jm("#refundFlowSub").click(function () {
        ...
        var t = jm.trim(jm("#refundPhone").val());
        if (!t) {
        ...
        var o = jm.trim(jm("#flowDetail").val());
        if (o.length > 200) {
            Mobi.ing(LS.refundFlowDetailTooLong);
            return
        }
        e = true;
        var r = {company: u, flowId: l, phone: t, refundArea: o};
        var p = jm(".J_picDiv");
        if (p.length > 0) {
            var w = [];
            var n = jm(".J_picDiv");
            for (var q = 0; q < n.length; q++) {
                var k = jm(n[q]);
                var s = k.attr("_fileId");
                if (!s) {
                    continue
                }
                var m = {ii: s};
                var v = k.attr("_tmpFileId");
                if (v) {
                    m["in"] = k.attr("_fileName");
                    m.tfi = v;
                    m.is = k.attr("_fileSize")
                }
                w.push(m)
            }
            if (w.length > 0) {
        ...
        jm.ajax({
            ...
            data: "flowInfo=" + jm.encodeUrl(jm.toJSON(r)),
            error: function () {
                e = false;
                Mobi.ing("系统繁忙，请稍后重试。")
            },
...
Mobi.initRefundPicUpload = function (d, c, e, b, k, a) {
...
Mobi.mobiRefundUpload = function (d, b, f, a) {
    ...
    var c = {
        ...
        onUploadSuccess: function (l, n) {
            ...
            if (m.success) {
                var k = {status: "end", id: l.id, title: "上传成功。"};
                h(k);
                setTimeout(function () {
                    Mobi.ing(jm.format(LS.mobiFormSubmitFileUploadSucess, jm.encodeHtml(l.name)), true)
                }, 1800);
                Mobi.refundPicUploadCallBack(m)
            } else {
                var k = {status: "end", id: l.id, title: m.msg};
                h(k);
                Mobi.ing(LS.mobiFormSubmitFileUploadFile + l.name + "   " + m.msg)
            }
        },
...
Mobi.refundPicUploadCallBack = function (b) {
    ...
    var a = b.fileId;
    var d = "";
    d += "<div class='picDiv J_picDiv' _tmpFileId='" + c + "' _fileName='" + k + "' _fileSize='" + h + "' _fileId='" + a + "'>";
...
Mobi.refundDetailSubmit = function (a, d, c) {
    ...
    jm("#refundDetailSub").click(function () {
        ...
        var u = parseFloat(jm("#refundPrice").attr("_max"));
        if (u < q) {
            Mobi.ing(LS.refundPriceTooMuchErr);
            return
        }
        var s = jm("#refundPhone").val();
        if (jm.trim(s).length == 0) {
            Mobi.ing(LS.refundNeedPhone);
            return
        }
        var k = jm("#refundReason").val();
        if (jm.trim(k).length == 0) {
            Mobi.ing(LS.refundEnterReason);
            return
        }
        var x = jm("#refundType").val();
        var n = {};
        n.refundType = parseInt(x);
        n.refundPrice = q;
        n.refundPhone = s;
        n.refundReason = k;
        ...
        if (m.length > 0) {
            ...
            for (var o = 0; o < l.length; o++) {
                var e = jm(l[o]);
                var r = e.attr("_fileId");
                if (!r) {
                    continue
                }
                var h = {ii: r};
                var v = e.attr("_tmpFileId");
                if (v) {
        ...
        jm.ajax({
            ...
            data: "refundInfo=" + jm.encodeUrl(jm.toJSON(n)),
            error: function () {
                b = false;
                Mobi.ing("系统繁忙，请稍后重试。")
            },
            success: function (y) {
                var y = jm.parseJSON(y);
                if (y.success) {
                    location.reload()
                } else {
                    Mobi.ing(y.msg, true);
...
Mobi.changeCheckButtonRight = function (a) {
    jm(".faisco-icons-right").each(function (d, e) {
        jm(e).removeClass().addClass("faisco-icons-shape11").addClass("couponCheckBox")
    });
    if (jm("#selectBtn" + a).hasClass("faisco-icons-right")) {
        jm("#selectBtn" + a).removeClass().addClass("faisco-icons-shape11").addClass("couponCheckBox")
    } else {
        jm("#selectBtn" + a).removeClass().addClass("faisco-icons-right").addClass("couponCheckBox").addClass("g_color");
        var c = jm("#selectBtn" + a).attr("coupon_value");
        var b = jm("#selectBtn" + a).attr("order_min_price");
        if (c != undefined && c != -1) {
            jm("#couponOffsetMoney").text(jm.format(LS.settlementCoupon, c, b));
            jm("#couponOffsetMoney").attr("_offsetmoney", c);
            Mobi.selectCoupon.saveMoney = c;
            Mobi.selectCoupon.id = a;
...
Mobi.newsCommentAddCom = function () {
    ...
    var c = {validateCode: f, newsId: b, creator: e, comment: k};
    Mobi.ing(LS.siteFormSubmitIng);
    jm.ajax({
        type: "POST", url: h, data: c, error: function () {
            Mobi.ing(LS.systemError);
            jm("#captchaChange").click()
        }, success: function (l) {
            ...
            switch (n.msg) {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    var m = jm.encodeUrl(window.location.href);
                    window.location.href = "login.jsp?returnUrl=" + m + "&errno=11";
                    break;
                case 7:
                    Mobi.ing(LS.commentClosed);
                    break;
...
Mobi.showBg = function () {
    ...
    e.onclick = function () {
        var m = document.getElementById("shareParentDiv");
        Mobi.mobiShowScroll();
        m.parentNode.removeChild(m)
    }
};
Mobi.initNewsEvent = function (c, p, m, o) {
    if (!c) {
        return
    }
    var e = document.getElementById("productDetailHeader" + c), b = document.getElementById("newsDetailShare"),
        d = e.querySelector(".icon-gClose"), f;
    if (o === 2) {
        f = "newsDetailV3Share"
    } else {
        f = "newsDetailShare"
    ...
    Mobi.scrollFadeIn("productDetailHeader" + c, "newsFigure" + c, p);
    var l = "ajax/newsComment_h.jsp?cmd=submitNewComment";
    var q = {
        triggerId: "postComment", panelId: "userCommentPanel", callback: function () {
            Mobi.postUserComment(l)
        }, closeWebPage: "#userCommentPanel .userCommentGoBack"
    };
    Mobi.initWebPage(q);
    var k = jm("#newsDetailPanel");
    var a = k.find("video");
    var n = a.length;
    if (n > 0) {
...
Mobi.getCommentsInfo = function (c, e, d, b) {
    ...
    jm.ajax({
        type: "post", url: "ajax/other_h.jsp?cmd=" + c, data: a, error: function () {
            ...
            var k = jm.parseJSON(h);
            if (k.success) {
                jm("#newsDetailPanel").append(k.html)
            }
            Mobi.closeLoading();
            Mobi.hidePlaceholder();
            if (c !== "newsV3") {
...
Mobi.getNewsCommentAjaxPagenation = function (d, c, b) {
    ...
    jm.ajax({
        type: "post", url: "ajax/other_h.jsp?cmd=" + b, data: a, error: function () {
            Mobi.ing("error")
        }, success: function (e) {
            var k = jm.parseJSON(e);
            if (!k.html) {
...
Mobi.initModuleCardGraphicNewsList = function (u) {
    var h = u.moduleId, d = jm("#newsList" + h), C = d.width(), m = u.picNum, M = 0, B, G, K, L, J = 0, y, c, s, b, r,
        f, w, o, N = jm(window), x, v, E, D, n, F = jm("body");

    function q(Q) {
        var Q = Q || window.event;
        w = Q.pageX;
        N.off("mousemove.newsListSlide").on("mousemove.newsListSlide", t);
        N.off("mouseup.newsListSlide").on("mouseup.newsListSlide", A);
        Q.preventDefault()
    }
    ...
    function t(R) {
        ...
        o = R.pageX;
        var U = o - w, T = parseInt(e.css("left") || 0) + U, Q = s - c, S = parseInt(d.offset().left);
        if (T > 0) {
            T = 0
        } else {
            if (T < Q) {
        ...
        if (d.find(".J_newsListSlideCover").length == 0) {
            k.append("<div class='J_newsListSlideCover' style='position:absolute;left:0;width:" + y + "px;height:" + M + "px;z-index:2;'></div>")
        } else {
        ...
        if (parseInt(C) == 640) {
            if (o <= S || o >= (s + S)) {
                N.off("mousemove.newsListSlide");
                N.off("mouseup.newsListSlide");
                w = null;
                o = null;
    ...
    function z(Q) {
        var Q = Q || window.event, R = Q.changedTouches.length > 0 ? Q.changedTouches[0] : Q.touches[0];
        return {pageX: R.pageX, pageY: R.pageY}
    }

    function I(T, V, S, U) {
        var R = Math.abs(T - S), Q = Math.abs(V - U);
        if (R === 0 && Q === 0) {
            return
        }
        if (R === 0 && Q > 0) {
    ...
    function l(Q) {
        ...
        E = x = R.pageX;
        D = v = R.pageY;
        e.off("touchmove.newlist").on("touchmove.newlist", P);
        e.off("touchend.newlist").on("touchend.newlist", p)
    }
    ...
    function P(Q) {
        ...
        D = R.pageY;
        if (n === undefined) {
            if (x !== undefined && v !== undefined && x !== undefined) {
                n = I(x, v, E, D)
            }
        }
        if (n !== undefined) {
    ...
    var k = jm(d).find(".J_newsListPanel"), e = jm(d).find(".J_newsListSlidePanel"),
        H = jm(d).find(".J_cardGraphicNewsStyle"), a = jm(d).find(".J_mixNewsStyleTitleContainer5");
    for (var O = 0; r = H.length, O < r; O++) {
        B = jm(H[O]);
        G = parseInt(B.height());
        K = parseInt(B.width());
        y = r * K;
        b = parseInt(H.find(".lineBody").eq(0).css("padding-left").replace("px", ""));
        c = y + b;
        if (r == 1) {
            e.css({right: "0", margin: "0 auto", width: c + "px"});
            k.css("height", G + "px");
            return
        }
        if (G > M) {
        ...
        L = parseInt(B.find(".J_mixNewsStyleTitleContainer5").height());
        if (L > J) {
            J = L
        }
    }
    k.css("height", M + "px");
    H.css("height", M + "px");
    e.css("height", M + "px").css("width", c + "px");
    a.css("height", J + "px");
    s = k.width();
    if (s < y) {
        if (Mobi.isPC()) {
            e.off("mousedown.newsListSlide").on("mousedown.newsListSlide", q)
        } else {
            f = new iScroll("J_newsListPanel" + h, {onBeforeScrollStart: null});
            F.off("touchmove.newlist" + h).on("touchmove.newlist" + h, function (Q) {
                if (n === false) {
                    Q.preventDefault()
                }
            });
            H.off("touchmove.newlist").on("touchmove.newlist", function (Q) {
                if (n === true) {
                    Q.stopPropagation()
                }
            });
            e.off("touchstart.newlist").on("touchstart.newlist", l)
        }
    }
};
Mobi.initModuletimeAxisNewsList = function (t) {
    var b = t.moduleId;
    var c = jm("#newsList" + b);
    var s = t.picNum;
    if (c.length == 0) {
    ...
    var q = c.find(".J_newsTitlePic");
    var m;
    var a = parseInt(q.width());
    var e = parseInt(q.height());
    var d = Math.ceil(0.04 * a) + " 0";
    var f = a + " 0";
    var l = a + " " + e;
    var h = Math.ceil(0.04 * a) + " " + e;
    var p = Math.ceil(0.04 * a) + " " + Math.ceil(0.38 * e);
    var n = Math.ceil(0.01 * a) + " " + Math.ceil(0.33 * e);
    var r = Math.ceil(0.04 * a) + " " + Math.ceil(0.27 * e);
    var o = d + "," + f + "," + l + "," + h + "," + p + "," + n + "," + r;
    for (var k = 0; m = q.length, k < m; k++) {
        jm(q[k]).find("polygon").attr("points", o);
        jm(q[k]).find("svg").attr("width", a).attr("height", e);
        jm(q[k]).find("image").attr("width", a).attr("height", e)
    }
};
...
Mobi.vote = function (e, h, c, d) {
    ...
    var k = (jm("#voteCodePanel" + e + h).css("display") == "none") ? false : true;
            ...
            if (m.success) {
                ...
                if (c > 0) {
                    if (jm.getCookie("vote" + e) === "" || jm.getCookie("vote" + e) === "null") {
                        var o = new Date();
                        o.setHours(o.getHours() + c);
                        jm.setCookie("vote" + e, c, {expires: o})
                    }
                } else {
                    if (c == 0) {
                        jm.setCookie("vote" + e, null)
                    } else {
                        jm.setCookie("vote" + e, -1, {expires: 30})
                    }
                }
            } else {
                if (m.login) {
    ...
    if (c == 0) {
        ...
        if (c == -1) {
            if (jm.getCookie("vote" + f) === "null") {
                jm.setCookie("vote" + f, -1, {expires: 30})
            }
        } else {
...
Mobi.showVoteResult = function (c, a) {
    ...
    jm.ajax({
        type: "post", url: "ajax/vote_h.jsp?cmd=voteResult", data: "id=" + c + "&list=" + b, error: function () {
            Mobi.ing(LS.systemError)
        }, success: function (d) {
            var e = jm.parseJSON(d);
            var f = e.msg;
...
Mobi.popupSearch = function (b) {
    ...
    if (b.searchProduct) {
        if (jm.getCookie("productSearchHistory")) {
            k = JSON.parse(jm.getCookie("productSearchHistory"))
        }
    } else {
        if (jm.getCookie("searchHistory")) {
            k = JSON.parse(jm.getCookie("searchHistory"))
        }
    }
    ...
    jm("#searchWindow").on("keypress", "#searchInput", function (l) {
        if (l.which === 13) {
            f = jm.trim(jm("#searchInput").val());
            Mobi.searchInMobi(f, b);
            return false
...
Mobi.searchInMobi = function (e, d) {
    ...
    k = k.slice(0, 10);
    if (d.searchProduct) {
        jm.setCookie("productSearchHistory", jm.toJSON(k), 7)
    } else {
        jm.setCookie("searchHistory", jm.toJSON(k), 7)
    }
};
...
Mobi.logoSizeCompressByMargin = function () {
    ...
    var p = jm("#pageLogo"), m = jm("#webHeader");
    if (m.css("display") == "none") {
        return
    }
    p.height(0);
    var b = parseFloat(p.css("margin-top").replace("px", "")), k = parseFloat(p.css("margin-bottom").replace("px", "")),
        c = parseFloat(p.css("margin-left").replace("px", "")), o = parseFloat(p.css("margin-right").replace("px", "")),
        l = parseFloat(p.height()), a = parseInt(p.attr("sid")), n = parseInt(p.attr("pw")), e = parseInt(p.attr("ph")),
        d = parseFloat(m.height()), f = 0, h;
    f = Math.floor(d - b - k);
    p.height(f + "px");
    if (a != 0) {
        p.width(parseInt(p.height()) + "px")
    } else {
        h = parseInt(p.height()) * n / e;
        h = (h > m.width()) ? (m.width() - c - o) : h;
        p.width(h + "px")
    }
...
Mobi.titlePositionRefreshByLogo = function () {
    ...
    var m = jm("#pageLogo"), k = jm("#header"), f = jm("#pageTitle"), c = jm("#webHeader");
    if (c.css("display") == "none") {
        return
    }
    m.css({position: "", "float": "", left: "", right: ""});
    var a = "right";
    ...
    k.css("padding", "");
    f.css("max-width", "");
    var l = parseInt(k.width());
    logoWidth = parseInt(m.width()), logoMarginLeft = parseInt(m.css("margin-left").replace("px", "")), logoMarginRight = parseInt(m.css("margin-right").replace("px", "")), headerPaddingLeft = parseInt(k.css("padding-left").replace("px", "")), headerPaddingRight = parseInt(k.css("padding-right").replace("px", "")), titlePaddingLeft = parseInt(f.css("padding-left").replace("px", "")), titlePaddingRight = parseInt(f.css("padding-right").replace("px", ""));
    if (m.css("display") != "none") {
        f.css("max-width", (l - logoWidth - logoMarginLeft - logoMarginRight - titlePaddingLeft - titlePaddingRight - 10) + "px");
        if (k.css("text-align") == "center" && (m.hasClass("left") || m.hasClass("right"))) {
            m.css({position: "absolute", "float": "none"});
            k.css("padding", 0);
            if (m.hasClass("left")) {
                if (headerPaddingLeft > 0) {
                    m.css("left", headerPaddingLeft + "px")
                } else {
                    m.css("left", 0)
                }
                if (jm("#pageTitle").text() != "" && f.offset().left < (m.offset().left + logoWidth)) {
                    k.css("padding", "0 0 0 " + (headerPaddingLeft + logoMarginLeft + logoMarginRight + logoWidth) + "px");
                    k.css("text-align", "left")
                }
            } else {
                if (m.hasClass("right")) {
                    if (headerPaddingRight > 0) {
                        m.css("right", headerPaddingRight + "px")
                    } else {
                        m.css("right", 0)
                    }
                    if (jm("#pageTitle").text() != "" && (f.offset().left + parseInt(f.width())) > m.offset().left) {
                        k.css("padding", "0 " + (headerPaddingRight + logoMarginLeft + logoMarginRight + logoWidth) + "px 0 0");
                        k.css("text-align", "right")
                    }
                }
            }
        } else {
            if (k.css("text-align") == "center") {
                k.css("padding", 0);
                if (headerPaddingLeft > 0) {
                    var d = ((m.offset().left) <= (k.offset().left + headerPaddingLeft));
                    var h = (f.offset().left) <= (k.offset().left + headerPaddingLeft);
                    ...
                    if (headerPaddingRight > 0) {
                        if ((m.offset().left + logoWidth) >= (k.offset().left + l) || (f.offset().left + parseInt(f.width())) >= (k.offset().left + l)) {
                            k.css("padding", "");
                            k.css("text-align", "right")
                        }
                    }
        ...
        if ((m.height() <= f.offset().top) && f.text() == "") {
        ...
        f.css("max-width", (l - titlePaddingLeft - titlePaddingRight) + "px");
        if (k.css("text-align") == "center") {
            k.css("padding", 0);
            if (headerPaddingLeft > 0 && (f.offset().left <= (k.offset().left + headerPaddingLeft))) {
                k.css("padding", "")
            } else {
                if (headerPaddingRight > 0 && (parseInt(f.width()) >= (k.offset().left + l - headerPaddingRight))) {
                    k.css("padding-right", "1.5rem")
                }
            }
        }
    }
...
Mobi.changeTempCountSiteBgHeight = function () {
    ...
    var a = jm("#headerBg"), e = jm("#headerWhiteBg"), h = jm("#navButton"), c = jm("#webHeader"),
        m = parseFloat(c.height()), n = parseFloat(c.css("padding-top")), b = parseFloat(c.css("padding-bottom")),
        d = parseFloat(c.css("border-top-width")), f = parseFloat(c.css("border-bottom-width")), k = m + n + b + d + f,
        l = k.toString() + "px";
    a.css("height", (k / _htmlFontSize) + "rem");
    if (b > 0) {
        a.css("padding-bottom", (b / _htmlFontSize) + "rem")
    }
    e.css("height", (k / _htmlFontSize) + "rem");
    Mobi.countSiteTitleBgHeiht = l;
...
Mobi.changeSiteTitleBg = function (b, f, d, e, l) {
    ...
    Mobi.showSiteTitleBgGloable.linkCoverPreViewPath = l;
    var a = jm("#headerBg");
    var c = jm("#webHeader");
    var k = jm("#headerWhiteBg");
    ...
    k.css("height", (Mobi.countSiteTitleBgHeiht / _htmlFontSize) + "rem")
};
...
Mobi.videoPoster = function (c, b) {
    ...
    a[0].addEventListener("loadedmetadata", function () {
        var d = a.height(), h = a.width(), e = d / _htmlFontSize, f = h / _htmlFontSize;
...
Mobi.initBgm = function (d) {
    var b = jm("#bgmAudio"), e = Mobi.getPreviewWindow();
    b.attr("src", d);
...
Mobi.scrollBgmPosition = function () {
    var e = jm("#bgMusic .bgm_icon"), f = jm("#webMultilingualArea"), d = jm("#webHeaderBox"),
        k = jm(".loginHeader.webHeaderBg"), a = parseInt(d.height());
    var h = 0, b = 10, c = document.documentElement.scrollTop || document.body.scrollTop;
    if (e.hasClass("bgm_rightUp") || e.hasClass("bgm_leftUp")) {
        ...
        if (!h) {
            if (k.length > 0) {
                h = k.offset().top + parseInt(k.height()) - c + 10
            }
            h = h > 0 ? h : 10;
            e.css("top", h + "px");
            return
...
Mobi.recordLastPlayerTime = function (b, d) {
    var a = Mobi.getPreviewObject(b), c = parseFloat(a ? a.currentTime : defaultTime);
    sessionStorage[d] = c
};
...
Mobi.checkBrowser = (function () {
    ...
    return function (h) {
        ...
        for (var k = 0, f = props.length; k < f; k++) {
            if (d.style[props[k]] !== undefined) {
                a[h] = true;
                return a[h]
            }
        }
...
Mobi.initSwipe = function (a, n, f) {
    ...
    var d = s.querySelectorAll(".bannerImageDiv.customBanner"), u = s.querySelectorAll(".bannerImageDiv"), v = d.length,
        h = u.length, k = s.offsetWidth, c = "", o = 0, p, w, x;
    for (var t = 0; t < v; t++) {
        p = parseInt(d[t].getAttribute("vwidth"));
    ...
    if (h === 0) {
        s.querySelector(".defaultBanner").style.height = Mobi.preciseDecimal(k * 300 / 640, 2) + "px"
    } else {
        c = h - v > 0 ? (k * o < k * 300 / 640 ? Mobi.preciseDecimal(k * 300 / 640, 2) : Mobi.preciseDecimal(k * o, 2)) : Mobi.preciseDecimal(k * o, 2);
        s.style.height = c + "px"
    }
    if (!f) {
        if (!Mobi.checkBrowser() || Fai.top._bannerData.et == 1) {
            jm._swipehandle = q("#" + a).swipehandle(s, {
                auto: 3000,
                continuous: true,
                bulletsClick: true,
            ...
            var l = s.getBoundingClientRect().width, b = s.children[0], r = b.children;
            var m = r.length;
            while (m--) {
                r[m].style.width = l + "px"
            }
        }
...
Mobi.bannerAnimate = {};
(function (n, N, o) {
    var f = false, T = 1, k = 0, X = -1, G = -1, u = false, P = true, D, h = 0, Q = {duration: 3000}, W = {}, E = 0,
        c = 0, R, U = n("#bannerSwipe"), H = U.find(".bannerSwipeContainer"), w = H.find(".billboard_item"),
        h = w.length;
    N.init = function (aa) {
        var Z = aa;
    ...
    function F(Z) {
        ...
        h = w.length;
        var aa = n("#bullets"), ab = aa.find("li");
        ab.removeClass("on");
        ab.eq(k).addClass("on")
    }

    function I(ap) {
        var ao = T, ab = ap.w, an = ap.h, am = ap.b, al = am.length, aq = 0, ak, aj, ae, ac;
        switch (ao) {
            case 9:
            case 10:
                aq = 4;
        ...
        for (ak = 0; ak < al; ak++) {
            ...
            ac = 1;
            if (aq == 0) {
                ad.push("<div id='bannerItem" + ai + "' class='billboardAnim billboard_item " + (aq != 0 ? "billboard_item" + ak : "") + "  billboardItem_" + ao + "' >");
                ...
                if (aq == 4) {
                    ad.push("<div class='billboard_item billboardItem_" + ao + " billboardItem_" + ao + "_" + (ak + 1) + "'>");
                    for (ac = 1; ac < aq; ac++) {
    ...
    function t() {
        var Z = n("#bannerBullet"), aa = Z.find("li");
    ...
    function x(aa) {
        var Z = n("#bullets"), ab = Z.find("li");
        ab.removeClass("on");
        ab.eq(aa).addClass("on")
    }

    function p(ab, ac) {
        var aa = w.eq(k), Z = w.eq(ab);
        Z.css("display", "block");
    ...
    function K(Z) {
        ...
        H[0].addEventListener("touchmove", m, false);
...
Mobi.initMallCoupon = function (c) {
    ...
    b.find(".coupon1_old, .coupon2_old, .coupon3_old,.couponItem").bind("click", function () {
        if (couponClickLock) {
            Mobi.clickCoupon(this)
        }
    });
    Mobi.reDrawCouponBorder(b)
};
Mobi.reDrawCouponBorder = function (a) {
    var b = jm(".formMiddle").css("background-color");
    if (b == "undefined") {
        b = "white"
    }
    jm.each(a.find(".canvasStyle,.canvasStyle2,.canvasStyle3"), function (l, n) {
        if (l != "length") {
            var m = parseFloat(jm(n).css("height").replace("px", ""));
            var e = parseFloat(jm(n).css("width").replace("px", ""));
            jm(n).attr("width", e * 2);
            jm(n).attr("height", m * 2);
            ...
            var c = m / 34;
            o.beginPath();
            o.arc(0, m / 2, 3 * c, -Math.PI / 2, Math.PI / 2, false);
            o.fill();
            o.closePath();
            o.moveTo(e, m / 2);
            o.arc(e, m / 2, 3 * c, Math.PI / 2, Math.PI * 3 / 2, false);
            o.fill();
            o.closePath();
            o.translate(-0.5, -0.5);
            for (i = 0; i < 7; i++) {
                for (j = 0; j <= 1; j++) {
                    ...
                    o.moveTo(k, m / 2);
                    if (i >= 3) {
                        o.arc(k, m - (3 * c + (i - 3) * 4 * c), c, d, f, false);
                        o.fill();
                        o.closePath()
                    } else {
                        o.arc(k, 3 * c + i * 4 * c, c, d, f, false);
                        o.fill();
                        o.closePath()
                    }
                }
...
(function (b, e, a, d) {
    a.init = function (y, o, q) {
        var v = 5, h = e.getPreviewObject("module" + y), x = h.querySelectorAll(o + y + "")[0],
            m = h.querySelectorAll(".J_marqueeContainer" + y)[0], C;
        if (typeof h != "object" || typeof x != "object" || typeof m != "object") {
            return
        }
        var l = {s: true, d: "up", sp: "normal", mm: true, i: true};
        b.extend(l, q);
        if (l.sp == "normal") {
            if (l.d == "up" || l.d == "down") {
                v = ((5 * x.offsetWidth) / h.offsetWidth) * (x.offsetHeight / x.offsetWidth)
            } else {
                v = (5 * x.offsetWidth) / h.offsetWidth
            }
        } else {
            if (l.sp == "slow") {
                if (l.d == "up" || l.d == "down") {
                    v = ((10 * x.offsetWidth) / h.offsetWidth) * (x.offsetHeight / x.offsetWidth)
                } else {
                    v = (10 * x.offsetWidth) / h.offsetWidth
                }
            } else {
                if (l.d == "up" || l.d == "down") {
                    v = ((2.5 * x.offsetWidth) / h.offsetWidth) * (x.offsetHeight / x.offsetWidth)
                } else {
                    v = (2.5 * x.offsetWidth) / h.offsetWidth
                }
            }
        }
        b.extend(l, {sp: v});
        var z = x.className,
            s = e.createElementByHtml("<div class='J_contentPanelCopy" + y + " f-contentPanel " + z + "'></div>"),
            t = x.parentNode, u = b(x).offset(), p = "infinite", A = "", k = 1, w = navigator.userAgent, n, B;
        var f = b(x).find("img"), r;
        if (f && f.length > 0) {
        ...
        b(m).css({width: u.width + "px", height: u.height + "px"});
        if (l.d == "up") {
            n = "buttomToTop"
        } else {
            if (l.d == "down") {
                ...
                if (l.d == "left" || l.d == "right") {
                    n = (l.d == "left") ? "rightToLeft" : "leftToRight";
                    b(s).css({
                        width: u.width + "px",
                        height: u.height + "px",
                        position: "absolute",
        ...
        if (!l.mm) {
            b(t).one("webkitAnimationStart mozAnimationStart MSAnimationStart oanimationstart animationstart", function () {
                b(t).removeClass("fk-marqueeMoveInStyle")
            })
        }
        if (!l.mm && l.i) {
            A = "_moveIn";
            ...
            if (l.mm && !l.i) {
                ...
                if (l.mm && l.i) {
                    ...
                    if (!l.mm && !l.i) {
                        A = "_moveIn_discontinuous"
                    }
                }
            }
        }
        B = n + A + " " + (l.sp / k) + "s linear " + p;
        if (Fai.top.Fai.isIE10 && l.mm && l.i && (l.d == "down" || l.d == "right")) {
            setTimeout(function () {
                c(b(t), "animation", B)
            }, 0)
        } else {
        ...
        if (!l.mm && l.i) {
            b(t).one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", function () {
                B = n + " " + l.sp + "s linear infinite";
                c(b(t), "animation", B)
            })
        } else {
            if (l.mm && !l.i) {
                b(t).one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", function () {
                    B = n + "_moveIn_discontinuous " + l.sp + "s linear infinite";
                    c(b(t), "animation", B)
                })
            }
        }
        if (!(/(iPhone|iPad|iPod|Android)/i.test(w))) {
            b(h).on("mouseover", function () {
                c(b(t), "animation-play-state", "paused")
            }).on("mouseout", function () {
                c(b(t), "animation-play-state", "running")
            })
        } else {
    ...
    function c(l, f, k) {
        var m = ["", "-webkit-", "-moz-", "-ms-"], h = m.length;
        while (h) {
            h--;
            l.css(m[h] + f, k)
        }
    }
})(jm, Mobi, Mobi.richMarquee || (Mobi.richMarquee = {utils: {}, event: {}, dom: {}, data: {}}));
Mobi.shanghuaLoading = {};
(function (x, u, p) {
    var h = new Array(), e, B, q = 0, m = 0, A = 0, s = 0, a = "", r = "", k = "", c, b, z, n = 0;
    u.init = function (H, I, G) {
        B = H;
        e = x("#module" + B);
        c = I;
        n = parseInt(G) || 0;
    ...
    function F(H) {
        var G = {page: m, orderStatus: n};
        x.ajax({
            type: "post", url: "ajax/order_h.jsp?cmd=getMInfo&moduleId=" + H, data: G, error: function () {
                Mobi.ing(LS.systemError)
            }, success: function (I) {
                var L = x.parseJSON(I);
                if (L.success) {
                    ...
                    s = L.totalSize;
                    k = Math.ceil(s / 100);
                    r = "<div class='pagenationSelectDiv'><select class='pageSelect' onchange='Mobi.shanghuaLoading.jump(this.options[this.selectedIndex].value)'>";
                    for (var K = 0; K < k; K++) {
                        var J = K + 1 + "/" + k;
                        r += "<option class='pageOptions' value=" + K + ">" + J + "</option>"
                    }
                    r += "</select></div>";
                    A = h[m].length;
                    if (h[m].length != 0) {
                        x.each(h[m], function (M, N) {
                            if (M == 10) {
                                return false
                            }
                            q = M;
                            e.find(".orderList").append(N)
                        });
                        q++
                    }
                    y();
                    f();
                    x("#webFooter").css("height", 0)
                } else {
                    e.find(".orderList").append(L.data)
                }
    ...
    function w(G) {
        x.ajax({
            type: "post",
            url: "ajax/order_h.jsp?cmd=getMInfo&moduleId=" + B,
            data: "page=" + m,
            error: function () {
                Mobi.ing(LS.systemError)
            },
            success: function (H) {
                ...
                if (I.success) {
                    ...
                    e.find(".orderList").append(I.data)
                }
                if (G > m) {
                    m++;
                    w(G)
                    ...
                    var J = e.find(".orderList_line").length;
                    if (J <= 10 && J == A) {
                        e.find(".orderList").append("<div class='pagenation'><div class='pagePrev icon-pagePrev icon-cnListP'></div>" + r + "</div>");
                        e.find(".pageSelect").val(m);
    ...
    function y() {
        if (s > 10) {
            ...
            e.find(".orderList").append("<div class='pagenation'>" + r + "</div>");
            e.find(".pageSelect").val(m)
        }
        window.onscroll = function () {
            if ((m == 0 && e.find(".orderList_line").length >= A) || (m * 100 + e.find(".orderList_line").length >= m * 100 + A)) {
                e.find(".getMInfo").remove();
                return
            }
            b = document.documentElement.scrollTop || window.pageYOffset || document.body.scrollTop;
            z = e.find(".getMInfo").offset().top;
            if (z - b <= 740) {
                e.find(".getMInfo").remove();
                E();
                f()
    ...
    function E() {
        ...
        var H = e.find(".orderList_line").length;
        if (H == 100 && H < s && m == 0) {
            e.find(".orderList").append("<div class='pagenation'><div class='pageNext icon-pageNext icon-cnListN'></div>" + r + "</div>");
            e.find(".pageSelect").val(m);
    ...
    function D() {
        ...
        if (h.length > m) {
            ...
            x.ajax({
                type: "post", url: "ajax/order_h.jsp?cmd=getMInfo", data: "page=" + m, error: function () {
                    Mobi.ing(LS.systemError)
                }, success: function (H) {
                    var I = x.parseJSON(H);
                    if (I.success) {
    ...
    function t() {
        e.find(".orderList").append("<div class='pagenation'><div class='pagePrev icon-pagePrev icon-cnListP'></div>" + r + "<div class='pageNext icon-pageNext icon-cnListN'></div></div>");
        e.find(".pageSelect").val(m);
        e.find(".pagePrev").unbind().bind("click", function () {
            m--;
            C()
    ...
    function f() {
        Mobi.initOrderDeleteButton(B);
        Mobi.initPayOrderImmediately(B);
        Mobi.initOrderCancelButton(B);
        Mobi.initOrderSureButton(B);
        Mobi.initFlowButton(B);
        Mobi.initCommentBtn(B, c);
        o()
    }

    function o() {
        e.find(".payButton").unbind().bind("click", function () {
            var I = x(this).attr("_href");
            var K = x(this).attr("_orderId");
            var G;
            ...
            if (H) {
                if (!J) {
                    ...
                    var L = x(this).attr("_appId");
                    Mobi.getWxpayUrl(L, G)
                }
            }
        })
    }
                    ...
                    if (J.rt == -3) {
                        ...
                        if (J.rt == -9) {
                            ...
                            if (J.rt == Mobi.MallAjaxErrno.outOfMallAmount) {
                                Mobi.ing(x.format(LS.mallAmountOverNameList, J.productsName))
                            } else {
                                if (J.rt == Mobi.MallAjaxErrno.OutOfAllowAmount) {
                                    Mobi.ing(x.format(LS.allowAmountOverNameList, J.productsName))
                                } else {
                                    if (J.rt == Mobi.MallAjaxErrno.payDomainError) {
                                        Mobi.ing(x.format(LS.mallPayDomainError))
                                    } else {
                                        if (J.rt == Mobi.MallAjaxErrno.notAdded) {
                                            Mobi.ing(x.format(LS.mallProductNotAdded))
                                        } else {
                                            Mobi.ing(LS.mallStlSubmitError)
                                        }
                                    }
...
Mobi.initFixAreaEvent = function () {
    ...
    b.off("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend").on("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", function (c) {
        a++;
        if (a > 1) {
            return
        }
...
Mobi.initTabModuleStyle = function (B, H) {
    var b = jm("#module" + B), D = b.find(".J_formTabButtonWrap"), p = D.find(".J_formTabButtonList"),
        t = p.find(".J_formTabButton"), s = b.find(".J_formTabContent"),
        q = /(iPhone|iPad|iPod|Android)/i.test(navigator.userAgent), a = D.offset(), n = 0, x = 0, u = 0, w = 0, C, o,
        h, r, v, m, z, F, e, y;
    ...
    if (Fai.top.Mobi.getPreviewDocument().URL.length > 0) {
        var l = Fai.top.Mobi.getPreviewDocument().location.search, d = l.indexOf("pageno"), k, f, A, G, k, E, c;
        if (d > -1) {
            f = l.substring(0, d);
    ...
    if (u <= h) {
        p.css("width", "100%");
        D.find(".J_preBtn").remove();
        D.find(".J_nextBtn").remove();
        return
    }
    if (D.find(".J_preBtn").length > 0 || q) {
        return
    }
    ...
    D.find(".J_nextBtn").on("click", function () {
        ...
        e = F.left - n;
        e = e + r.width < r.right ? e : (r.width - (p[0].offsetLeft + p.width()));
        p.css("left", e + "px");
        preBtn.addClass("disable");
        z.addClass("disable");
        setTimeout(function () {
...
Mobi.getHideDivOffset = function (e) {
    var d = {position: "absolute", visibility: "hidden", display: "block"}, a, c, b = {};
    if (!e) {
        return
    }
    for (c in d) {
    ...
    a = {offsetHeight: e.offsetHeight || 0, offsetWidth: e.offsetWidth || 0};
    for (c in d) {
        e.style[c] = b[c]
    }
    return a
...
Mobi.inTabMaqueeHelper = {
    setInTabMarquee: function (c) {
        var f = c.moduleId, h = c.funcName, b = c.args || [], a = c.runTime || 1;
        if (typeof h != "string") {
            return
        }
        var d = Fai.top.inTabMaqueeHelper, e = (d[f] instanceof Array) ? d[f] : (d[f] = []);
        e.push({funcName: h, args: b, runTime: a, hasRunTime: 0})
...
(function (b, a, c) {
    a.initTabCallBack = function (e) {
        ...
        f.each(function (k, l) {
            ...
            if (parseInt(h.attr("styleid")) == 41) {
                setTimeout(function () {
                    var m = h.find(".form img"), p = m.length, o = 0;
                    for (var n = 0; n < m.length; n++) {
                        var q = new Image();
                        q.src = m.eq(n).attr("src");
                        q.onload = function () {
                            o++;
                            if (o == p) {
    ...
    a.autoMoveTabPos = function (l, e, t) {
        var p = l.offset(), k = parseInt(l.width()), m = p.left, s = m + k,
            q = /(iPhone|iPad|iPod|Android)/i.test(navigator.userAgent), d, r, h, o;
        if (q) {
            d = t.left;
            r = t.right
        } else {
            var f = e.find(".J_nextBtn"), n = e.find(".J_preBtn");
            r = f.offset().left;
            d = n.offset().left
        }
        if (s >= r) {
            ...
            if (m <= d) {
                if (q) {
                    o = e[0].scrollLeft >= k ? k : e[0].scrollLeft;
                    h = setInterval(function () {
                        if (o > 0) {
                            o -= 2;
                            e[0].scrollLeft -= 2
...
Mobi.initSimpleTextContent = function (b, o) {
    var c = jm("#module" + b), h = c.find(".fkEditor"), d = c.find(".simpleText"), m = parseInt(c.css("top") || 0),
        e = parseInt(c.css("left") || 0), f = 20.5, a = c.width().replace("rem", ""), n = 0, k = "", l = "";
    k = Fai.top._manageMode ? h : d;
    if (o != 1) {
        if (c.is(":visible")) {
            c.css("height", "auto");
            ...
            if (Fai.top._manageMode) {
                n = parseInt(h.attr("_autowidth") || 1);
                n && (a = parseInt(h.attr("_width") || 180) / f)
            } else {
                parseInt(c.attr("_autowidth") || 1) && (a = 180 / f)
            }
            c.find(".fk-editor").css({height: "auto", width: a + "rem"});
        ...
        !Fai.top._manageMode && c.css("overflow", "visible") && c.find(".formMiddle").css("overflow", "visible")
    }
    checkNode.traverseTagStyle(k)
};
var checkNode = {
    ...
    checkCurrentTagStyle: function (h) {
        var f = this.getPropertyValue(), a = "", e = [], d = "", c = "", k = "", b = 0;
        a = h.attr("style");
        if (!a) {
            return
        }
        ...
        for (b = 0; b < e.length; b++) {
            ...
            if (this.checkInArray(f, c)) {
                if (k != undefined) {
                    h.css(c, this.returnChangeUnit(k))
                }
            }
        }
    },
...
Mobi.simpletext = {checkNode: checkNode};
...
Mobi.initTemplate2 = function (f) {
    var e = Mobi.getJQMobi(), a = f.layout, h = f.moduleStyle, d = f.designType, c = Mobi.getPreviewObject("navbar"),
...
Mobi.changeMorePosition = function (d) {
    var e = document.querySelectorAll("#webModuleContainer>.form"), a = e.length;
    if (d === 1) {
        for (var b = 0; b < a; b++) {
            var k = e[b], h = k.id || "", c = k.querySelector(".formBannerMore" + h.replace("module", ""));
            if (!c) {
                continue
            }
            k.appendChild(c)
        ...
        for (var b = 0; b < a; b++) {
            var k = e[b], f = k.querySelector(".formBannerTitle>.titleCenter"), h = k.id || "",
                c = k.querySelector(".formBannerMore" + h.replace("module", ""));
            f.appendChild(c)
        }
    }
};
Mobi.scrollHeaderTop = function () {
    ...
    function a() {
        if (document.getElementsByClassName("J_registerHeader").length) {
            var d = document.getElementById("g_body"), c = document.getElementsByClassName("J_registerHeader")[0],
                f = false;
            var h = c.offsetTop, b = c.clientHeight;
            var e = d.scrollTop;
            if ((e > h || e < h) && !f) {
...
Mobi.scrollNavFix = function () {
    var e = document.getElementById("navbar"), f = document.getElementById("g_body"), c = e.clientHeight, b = false,
        h = e.offsetTop, d = f.scrollTop;
    if (e.parentNode == document.getElementById("webBannerBox")) {
        h += 180
    }
    document.addEventListener("touchstart", function (k) {
        a()
    }, false);
    document.addEventListener("touchmove", function (k) {
        a()
    }, false);
    document.addEventListener("touchend", function (k) {
        a()
    }, false);
    document.addEventListener("touchcancel", function (k) {
        a()
    }, false);
    document.addEventListener("scroll", function () {
        a()
    ...
    function a() {
        var l = f.scrollTop, k = document.getElementById("webContainerBox").offsetTop - l;
        if (l > d) {
            if (k < 0) {
...
Mobi.initFooterHeight = function () {
    ...
    var e = 0, a = b.clientHeight, c = document.documentElement.clientHeight, f = jm("#g_web>div");
...
Mobi.autoSetNavBarHeight = function (a) {
    var h = Mobi.getPreviewObject("webHeader").offsetHeight,
        e = Mobi.getPreviewObject("webTips") ? Mobi.getPreviewObject("webTips").offsetHeight : 0, c = 0,
...
Mobi.fixImageHeight = function (b, d) {
    ...
    var a = c.querySelectorAll("img"), f = 1, l = 0, k = a.length;
    for (var e = 0; e < k; e++) {
        (function (n) {
            var o = new Image();
            o.src = a[n].src;
            ...
            if (f % 2 === 0 || n === a.length - 1) {
                if (l > 0 && l < 160) {
                    if (f % 2 === 1 && n === a.length - 1) {
                        a[n].parentNode.style.height = (l / _htmlFontSize) + "rem"
                    }
                    if (f % 2 === 0) {
                        for (var m = 0; m < 2; m++) {
                            a[n + m - 1].parentNode.style.height = (l / _htmlFontSize) + "rem"
                        }
                    }
                }
                l = 0
    ...
    function h() {
        var o = 0, n = 0, p = jm("#" + b).find(".photoListImg"), m = jm("#" + b).find(".imgClass_160");
        p.each(function () {
            n = parseInt(jm(this).height());
            if (n > o) {
                o = n
            }
        });
        if (o != 0) {
            m.css("height", (o / _htmlFontSize) + "rem")
        }
    }
};
Mobi.fixImageHeightPhoList = function (b, e) {
    ...
    var a = c.querySelectorAll("img"), k = 1, o = 0, n = a.length;
    var q = jm("#" + b).find(".imgName");
    var l = jm("#" + b).find(".imageMiddle");
    var p = 0;
    for (var f = 0; f < n; f++) {
        (function (s) {
            var t = new Image();
            t.src = jm(a[s]).attr("src");
            t.onload = function () {
                if (t.height > o) {
                    o = t.height
                }
                ...
                if (e == 2 && p == n) {
                    for (var y = 0; y < n; y++) {
                        ...
                        var v = u / w;
                        if (v <= z) {
                            jm(a[y]).css("width", z * w + "px");
                            jm(a[y]).css("height", w + "px");
                            jm(a[y]).css("maxWidth", "initial");
                            jm(d[y]).css("marginLeft", ((u - z * w) / 2) + "px");
                            jm(h[y]).css({position: "relative", overflow: "hidden"});
                            jm(l[y]).css("display", "none")
                        } else {
                            jm(a[y]).css("height", u / z + "px");
                            jm(a[y]).css("width", u + "px");
                            jm(a[y]).css("marginTop", ((w - u / z) / 2) + "px");
                            jm(d[y]).css("overflow", "hidden");
                            jm(l[y]).css("display", "none")
                        }
                    }
                }
            ...
            if (k % 2 === 0 || s === a.length - 1) {
                if (o > 0 && o < 160) {
                    if (k % 2 === 1 && s === a.length - 1) {
                        a[s].parentNode.style.height = (o / _htmlFontSize) + "rem"
                    }
                    if (k % 2 === 0) {
                        for (var r = 0; r < 2; r++) {
                            a[s + r - 1].parentNode.style.height = (o / _htmlFontSize) + "rem"
                        }
                    }
                }
                o = 0
    ...
    function m() {
        var t = 0, s = 0, u = jm("#" + b).find(".photoListImg"), r = jm("#" + b).find(".imgClass_160");
        u.each(function () {
            s = Math.ceil(parseFloat(jm(this).height()));
            if (s > t) {
                t = s
            }
        });
        if (e == 2) {
            ...
            if (t != 0) {
                r.css("height", (t / _htmlFontSize) + "rem")
            }
        }
        p++
    }
...
Mobi.defImageHeightType2 = function (b, e) {
    ...
    var d = jm("#" + b).find(".imgClass_160");
    var a = c.querySelectorAll("img"), l = 1, q = 0, o = a.length;
    var m = c.querySelectorAll(".imageMiddle");
    var s = c.querySelectorAll(".imgName");
    var f, p, t;
    var r = 0;
    for (var k = 0; k < o; k++) {
        (function (v) {
            var w = new Image();
            w.src = jm(a[v]).attr("src");
            w.onload = function () {
                if (w.height > q) {
                    q = w.height
                }
                ...
                if (e == 2 && r == o) {
                    for (var B = 0; B < o; B++) {
                        ...
                        var y = x / z;
                        if (y <= C) {
                            jm(a[B]).css("width", C * z + "px");
                            jm(a[B]).css("height", z + "px");
                            jm(a[B]).css("maxWidth", "initial");
                            jm(a[B]).css("marginLeft", ((x - C * z) / 2) + "px");
                            jm(h[B]).css({position: "relative", overflow: "hidden"});
                            jm(m[B]).css("display", "none")
                        } else {
                            jm(a[B]).css("height", x / C + "px");
                            jm(a[B]).css("width", x + "px");
                            jm(a[B]).css("marginTop", ((z - x / C) / 2) + "px");
                            jm(m[B]).css("display", "none")
                        }
                    }
                }
                if (r == o) {
                    t = b.replace("module", "");
                    f = jm("#" + b).find(".J_marqueeContainer" + t);
                    if (f.length > 0) {
                        p = jm("#" + b).find("#photoSlideList" + t).offset().height;
                        f.css("height", p + "px");
                        f.find(".J_contentPanelCopy" + t).css("height", p + "px")
                    }
                }
            };
            if (w.height != 0) {
            ...
            if (l % 2 === 0 || v === a.length - 1) {
                if (q > 0 && q < 160) {
                    if (l % 2 === 1 && v === a.length - 1) {
                        a[v].parentNode.style.height = (q / _htmlFontSize) + "rem"
                    }
                    if (l % 2 === 0) {
                        for (var u = 0; u < 2; u++) {
                            a[v + u - 1].parentNode.style.height = (q / _htmlFontSize) + "rem"
                        }
                    }
                }
                q = 0
    ...
    function n() {
        var w = 0, v = 0, x = jm("#" + b).find(".photoListImg"), u = jm("#" + b).find(".imgClass_160");
        x.each(function () {
            v = parseInt(jm(this).height());
            if (v > w) {
                w = v
            }
        });
        if (e == 2) {
            ...
            if (w != 0) {
                u.css("height", (w / _htmlFontSize) + "rem")
            }
        }
        r++
    }
...
Mobi.fixGwebHieght = function () {
    var a = Mobi.getPreviewWindow().innerHeight, c = Mobi.getPreviewObject("g_web"), b = c.offsetHeight;
    if (a > b) {
        c.style.height = a + "px"
    }
};
...
Mobi.initMobiPageWithLogDog = function () {
    ...
    function a() {
        var o = 200100, d = Fai.top.devicePixelRatio, b = Fai.top.screen, k, n = "fkLogDog-screenResolution", f, m, p,
            h;
        ...
        p = Fai.top._manageMode ? f : m;
        k = (b.width * d) * (b.height * d);
        p = c(p);
        h = p[k] || p.other;
...
Mobi.bindBodyScrollTypeWritingEvent = function () {
    function d(e, h) {
        ...
        var f = function (k) {
            if (k.target != e && k.target.tagName != "INPUT" && k.target.tagName != "TEXTAREA") {
                setTimeout(function () {
                    e.blur();
...
Mobi.getWXShareData = function (e, a) {
    ...
    var b = {};
    jm.ajax({
        url: c, type: "post", cache: false, data: d.join(""), async: false, success: function (f) {
            var h = jm.parseJSON(f);
            if (h.success) {
...
Mobi.statisticalMobiVisitors = function (m) {
    if (!m) {
        return
    }
    var e = {colId: -1, pdId: -1, ndId: -1};
    var a = jm.extend({}, e, m);
    ...
    var b = "", l = navigator.userAgent;
    if (!l.match(/AppleWebKit.*Mobile.*/) && !l.match(/ipad/i)) {
        b = "pc"
    } else {
        if (l.match(/ipad/i)) {
            b = "ipad"
        } else {
            if (l.match(/android/i)) {
                b = "android"
            } else {
                if (l.match(/iphone/i)) {
                    b = "iphone"
    ...
    if (Fai.top._manageMode) {
        ...
        k = Fai.top.Fai.getScreenType(Fai.top.Fai.Screen().width, Fai.top.Fai.Screen().height)
    } else {
        d = Mobi.getBrowserType();
        k = Mobi.getScreenType(Mobi.Screen().width, Mobi.Screen().height);
    ...
    jm.ajax({
        type: "post", url: "ajax/mobistatistics_h.jsp?cmd=visited", data: f.join(""), success: function (n) {
        }
    })
};
Mobi.mobiStatVisitTime = function () {
    window.onbeforeunload = function (c) {
        ...
        d.push("unloadTime=" + a);
        jm.ajax({
            url: b, type: "post", cache: false, data: d.join(""), success: function (e) {
            }
        })
    }
};
Mobi.report = function (a) {
    setTimeout(function () {
        if (window.performance) {
            ...
            var l = d.domainLookupStart - d.fetchStart;
            ...
            var k = d.loadEventEnd - d.navigationStart;
            var m = [];
            m.push("&dt=" + b);
            m.push("&ct=" + e);
            m.push("&rt=" + f);
            m.push("&wt=" + q);
            m.push("&pt=" + r);
            m.push("&bt=" + Mobi.getBrowserType());
            var c = "ajax/mobistatistics_h.jsp?cmd=report";
            jm.ajax({
                url: c, type: "post", cache: false, data: m.join(""), success: function (s) {
                }
            })
        }
    }, 500)
...
//     jm.ajax({type: "get", url: "/ajax/log_h.jsp?cmd=dog&dogId=" + jm.encodeUrl(b) + "&dogSrc=" + jm.encodeUrl(a)})
// };
...
Mobi.setCtrlStyleCssList = function (c, b, l, r) {
    var h = jm;
    var a = h("#" + c);
    var m = new Array();
    if (a.length == 1) {
    ...
    for (var f = m.length - 1; f >= 0; --f) {
        ...
        for (var e = 0; e < l.length; ++e) {
            var p = l[e].cls;
            var o = l[e].key;
            var d = new RegExp("#" + b + " +" + Mobi.fixRegSpecialCharacter(p) + " *{ *" + o + "s*:[^;]*;", "gi");
            if (b == "" || b == "undefined") {
                d = new RegExp(Mobi.fixRegSpecialCharacter(p) + " *{ *" + o + "s*:[^;]*;", "gi")
            }
            if (q.length == 0 || /^\s$/.test(q) || d.test(q)) {
                m.splice(f, 1);
                break
            }
        }
    ...
    for (var e = 0; e < l.length; ++e) {
        if (b == "" || b == "undefined") {
            m.push(l[e].cls + "{" + l[e].key + ":" + l[e].value + ";}")
        } else {
            m.push("#" + b + " " + l[e].cls + "{" + l[e].key + ":" + l[e].value + ";}")
        }
    }
    if (r && r.rev) {
        m.reverse()
    }
    h("head").append('<style type="text/css" id="' + c + '">' + m.join("\n") + "</style>")
};
Mobi.removeCtrlStyleCssList = function (c, b, l) {
    var f = jm;
    var a = f("#" + c);
    var m = new Array();
    if (a.length == 1) {
    ...
    f("head").append('<style type="text/css" id="' + c + '">' + m.join("\n") + "</style>")
};
...
Mobi.bindTouchEvent = function (p, v, d) {
    var r = jm(p), u = Fai.top.navigator.userAgent, l = /(iPhone|iPad|iPod|iOS|Android)/i.test(u),
        n = /(MQQBrowser)/i.test(u), e = /(iPhone|iPad|iPod|iOS)/i.test(u), f = Mobi.isWechat(), m = _htmlFontSize,
        x = _htmlFontSize, q = false, b, o, k, t, a, c;
    if (n) {
        x = 8
    }
    if (e) {
    ...
    b = {stopPropagation: true, callBack: "", args: []};
    v = jm.extend({}, b, v);
    d = jm.extend({}, b, d);
    r.each(function (y, z) {
        jm(z).on(a, function (A) {
            o = w(o);
            k = h(A);
            o.mouseDownX = k.pageX;
            o.mouseDownY = k.pageY;
            if (!v) {
                return
            }
            s(this, v, A);
            if (v.stopPropagation && !l) {
                A.stopPropagation();
                A.preventDefault()
            }
        }).on(c, function (A) {
            ...
            o.mouseUpX = k.pageX;
            o.mouseUpY = k.pageY;
            if (!(o.mouseDownX == o.mouseUpX && o.mouseDownY == o.mouseUpY)) {
                o.touchMove = true
            }
            if (o.mouseDownX > (o.mouseUpX + m)) {
                o.toLeft = true
            } else {
                if ((o.mouseDownX + m) < o.mouseUpX) {
                    o.toRight = true
                }
            }
            if (o.mouseUpY - o.mouseDownY > x) {
                o.toBottom = true
            } else {
                if (o.mouseDownY - o.mouseUpY > x) {
                    o.toTop = true
                }
            }
            s(this, d, A);
        ...
        if (l) {
            jm(z).on("touchmove", function () {
                k = h(event);
                q = Math.abs(k.pageY - o.mouseDownY) >= x;
                if (d.stopPropagation && !q && !(e && f)) {
    ...
    function s(C, A, B) {
        ...
        for (z = 0; z < A.args.length; z++) {
            y.push(A.args[z])
        }
        y.push(o);
        y.push(B);
        A.callBack.apply(C, y)
    }

    function h(y) {
        var z = y || window.event;
        if ("ontouchstart" in window) {
            z = !!y.changedTouches && y.changedTouches.length > 0 ? y.changedTouches[0] : y.touches[0]
        }
        return {pageX: z.pageX, pageY: z.pageY}
    }
};
Mobi.loadImgAlone = function (k, b) {
    var c = jm("#module" + k), d = jm(window).width(), h = jm(window).height(), a, e = -1, f = true;
    if (c.hasClass("formStyle3")) {
        ...
        switch (e) {
            case 1:
            case 31:
                lazyLoadProductList_2(h, k, 1);
                break;
            case 3:
                lazyLoadProductList_2(h, k, 2);
                break;
            case 7:
                lazyLoadProductList_7(d, k);
                break;
            case 8:
                lazyLoadProductList_8(h, k);
                break;
            case 9:
                lazyLoadProductList_9(d, k);
                break;
            default:
        }
    } else {
        if (c.hasClass("formStyle31")) {
            lazyloadCubeNavigation(h, k)
        } else {
            if (c.hasClass("formStyle41")) {
                e = b;
                if (e == 3) {
                    lazyloadMultiPhotoList_3(h, k)
                }
            } else {
...
function lazyLoadProductList_2(d, c, a) {
    ...
    b.lazyload({threshold: d, load: null})
}
...
function lazyLoadProductList_7(a, c) {
    ...
    b.lazyload({threshold: a, w_threshold: 0, otherEvent: "slidePic", load_in_viewport: true, load: null})
}
...
function lazyLoadProductList_8(c, b) {
    ...
    a.lazyload({threshold: c, failure_limit: 2, loadingClass: "loading-for-lazyload", load: null})
}
...
function lazyLoadProductList_9(a, c) {
    ...
    b.lazyload({threshold: a, w_threshold: a, otherEvent: "horizonScroll", load_in_viewport: true, load: null})
}
...
function lazyloadCubeNavigation(c, b) {
    ...
    a.lazyload({threshold: parseInt(c / 2), loadingClass: "", load: null})
}
...
function lazyloadMultiPhotoList_3(c, b) {
    ...
    a.lazyload({threshold: c, w_threshold: 0, load: null})
}

Mobi.ajaxLoadModuleDom = function (d, b, e) {
    var a = window.location.href, c = "";
    if (a.indexOf("lcid") > 0) {
    ...
    //         var k = jm.parseJSON(k);
    //         if (k.success) {
    //             var o = jm.parseJSON(k.rtInfo);
    //             if (o.topBar) {
    //                 var p = Mobi.getPreviewWindow().jm(".multilingual");
    //                 p.children().remove();
    //                 p.append(o.topBar.dom);
    //                 jm.fkEval.call(window, o.topBar.scripts);
    //                 Mobi.initLocater()
    //             }
    //             if (o.moduleDomList && o.moduleDomList.length > 0) {
    //                 for (var l = 0; l < o.moduleDomList.length; l++) {
    //                     var n = o.moduleDomList[l];
    //                     var m = n.moduleId;
    //                     var q = n.dom;
    //                     var h = n.scripts;
    //                     loadWholeModuleDom(m, q, h)
    //                 }
    //                 Mobi.initFooterHeight()
    //             }
    //         }
...
Mobi.bindInteractive = function (e) {
    var d = Mobi.getPreviewWindow(), c = d.Mobi, b = d.jm("#module" + e, d.document), a = c.photoGroup;
