                                                                        ...
                                                                        <div id="navCenterContent" class="navCenterContent">
                                                                            <div style="width: 960px;" id="navCenter" class="navCenter">
                                                                                ...
                                                                                <div class="itemContainer">
                                                                                    ...
                                                                                    <div class="itemSep"></div>
                                                                                    <div title="" id="nav110" class="item itemCol110 itemIndex6" colid="110" onclick='window.open("http://Cooperation/web", "_self")' _jump="window.open(&quot;http://Cooperation/web&quot;, &quot;_self&quot;)">
                                                                                        <div class="itemCenter">
                                                                                            <a hidefocus="true" style="outline: medium none;" href="http://Cooperation/web" onclick="return false;">
                                                                                            ...
                                                                                            <tr>
                                                                                                ...
                                                                                                <td class="formMiddleCenter formMiddleCenter12 " valign="top">
                                                                                                    <div id="content"><?php if ($sf_user->hasFlash('notice')): ?>
                                                                                                        ...
                                                                                                        <div class="flash_error"><?php echo $sf_user->getFlash('error') ?></div><?php endif ?>
                                                                                                        <div id="notice_history">Recent viewed notices:
                                                                                                            <ul>
                                                                                                            <?php foreach ($sf_user->getnoticeHistory() as $notice): ?>
                                                                                                                <li><?php echo link_to($notice->getPosition(), 'notice_show_user', $notice) ?></li>
                                                                                                            <?php endforeach ?>
                                                                                                            </ul>
                                                                                                        </div>
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        ...
                                                                                        <td class="footerItemContainer-secondTd" style="vertical-align: middle;">
                                                                                            <div class="footerItemContent">
                                                                                                <div class="footerItemTop">
                                                                                                    <a title="" class="footerItemTopLink" href="http://contract.cooperation.com" child="0">联系我们
                                                                                                        <span class="fk-footerTriangle"></span></a>
                                                                                                    <div class="fk-footerTrianglePlaceholder"></div>
                                                                                                </div>
                                                                                                <div class="footerItemMiddle">
